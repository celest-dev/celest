...
mixin $CloudAuthDatabaseAccessorsMixin
  ...
  i2.CloudAuthUsers get cloudAuthUsers => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i2.CloudAuthUsers>('cloud_auth_users');
  i4.CedarTypes get cedarTypes => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i4.CedarTypes>('cedar_types');
  i4.CedarEntities get cedarEntities => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i4.CedarEntities>('cedar_entities');
  i4.CedarRelationships get cedarRelationships => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i4.CedarRelationships>('cedar_relationships');
  i2.CloudAuthUserEmails get cloudAuthUserEmails => i3.ReadDatabaseContainer(
    attachedDatabase,
  ...
  i2.CloudAuthUsersView get cloudAuthUsersView => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i2.CloudAuthUsersView>('cloud_auth_users_view');
  i5.CloudAuthProjects get cloudAuthProjects => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i5.CloudAuthProjects>('cloud_auth_projects');
  i5.CloudAuthApis get cloudAuthApis => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i5.CloudAuthApis>('cloud_auth_apis');
  i5.CloudAuthFunctions get cloudAuthFunctions => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i5.CloudAuthFunctions>('cloud_auth_functions');
  i6.CloudAuthMeta get cloudAuthMeta => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i6.CloudAuthMeta>('cloud_auth_meta');
  i7.CloudAuthCryptoKeys get cloudAuthCryptoKeys => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i7.CloudAuthCryptoKeys>('cloud_auth_crypto_keys');
  i7.CloudAuthSessions get cloudAuthSessions => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i7.CloudAuthSessions>('cloud_auth_sessions');
  i7.CloudAuthOtpCodes get cloudAuthOtpCodes => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i7.CloudAuthOtpCodes>('cloud_auth_otp_codes');
  i7.CloudAuthCorks get cloudAuthCorks => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i7.CloudAuthCorks>('cloud_auth_corks');
  i4.CedarPolicies get cedarPolicies => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i4.CedarPolicies>('cedar_policies');
  i4.CedarPolicyTemplates get cedarPolicyTemplates => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i4.CedarPolicyTemplates>('cedar_policy_templates');
  i4.CedarPolicyTemplateLinks get cedarPolicyTemplateLinks =>
      i3.ReadDatabaseContainer(
        attachedDatabase,
      ).resultSet<i4.CedarPolicyTemplateLinks>('cedar_policy_template_links');
  i4.CedarAuthorizationLogs get cedarAuthorizationLogs =>
      i3.ReadDatabaseContainer(
        attachedDatabase,
      ).resultSet<i4.CedarAuthorizationLogs>('cedar_authorization_logs');
  i4.CedarDrift get cedarDrift => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).accessor<i4.CedarDrift>(i4.CedarDrift.new);
  i7.CloudAuthCoreDrift get cloudAuthCoreDrift => i3.ReadDatabaseContainer(
    attachedDatabase,
  ).accessor<i7.CloudAuthCoreDrift>(i7.CloudAuthCoreDrift.new);
  i6.CloudAuthMetaDrift get cloudAuthMetaDrift => i3.ReadDatabaseContainer(
    attachedDatabase,
  ...
  i2.CloudAuthUsersDrift get cloudAuthUsersDrift => i3.ReadDatabaseContainer(
    attachedDatabase,
