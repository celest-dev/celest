...
typedef $CloudAuthUsersCreateCompanionBuilder =
    i2.CloudAuthUsersCompanion Function({
...
typedef $CloudAuthUsersUpdateCompanionBuilder =
    i2.CloudAuthUsersCompanion Function({
...
class $CloudAuthUsersTableManager
    extends
        i0.RootTableManager<
...
typedef $CloudAuthUsersProcessedTableManager =
...
class $CloudAuthUserEmailsTableManager
    extends
        i0.RootTableManager<
          i0.GeneratedDatabase,
...
typedef $CloudAuthUserEmailsProcessedTableManager =
    i0.ProcessedTableManager<
      i0.GeneratedDatabase,
      i2.CloudAuthUserEmails,
      i1.Email,
...
class $CloudAuthUserPhoneNumbersTableManager
    extends
        i0.RootTableManager<
          i0.GeneratedDatabase,
  ...
  $CloudAuthUserPhoneNumbersTableManager(
    i0.GeneratedDatabase db,
    i2.CloudAuthUserPhoneNumbers table,
  ) : super(
        i0.TableManagerState(
          db: db,
          table: table,
...
class CloudAuthUsersViewData extends i0.DataClass {
  ...
  factory CloudAuthUsersViewData.fromJson(
    ...
    return CloudAuthUsersViewData(
      ...
      phoneNumbers: serializer.fromJson<List<i1.PhoneNumber>>(
        json['phone_numbers'],
      ),
...
class CloudAuthUsersView
  ...
  i2.CloudAuthUsersViewData map(
    ...
    return i2.CloudAuthUsersViewData(
      ...
      emails: i2.CloudAuthUsersView.$converteremails.fromSql(
        attachedDatabase.typeMapping.read(
          i0.DriftSqlType.string,
      ...
      roles: i2.CloudAuthUsersView.$converterroles.fromSql(
        attachedDatabase.typeMapping.read(
          i0.DriftSqlType.string,
  ...
  emails = i0.GeneratedColumn<String>(
    'emails',
    aliasedName,
    false,
    type: i0.DriftSqlType.string,
  ).withConverter<List<i1.Email>>(i2.CloudAuthUsersView.$converteremails);
  ...
  roles = i0.GeneratedColumn<String>(
    'roles',
    aliasedName,
    false,
    type: i0.DriftSqlType.string,
  ).withConverter<List<i4.EntityUid>>(i2.CloudAuthUsersView.$converterroles);
  @override
...
class CloudAuthUsersDrift extends i7.ModularAccessor {
  ...
  i0.Selectable<i1.User> getUser({required String userId}) {
    return customSelect(
      ...
      (i0.QueryRow row) => i1.User(
        ...
        emails: i2.CloudAuthUsersView.$converteremails.fromSql(
          row.read<String>('emails'),
        ),
        phoneNumbers: i2.CloudAuthUsersView.$converterphoneNumbers.fromSql(
          row.read<String>('phone_numbers'),
        ),
        roles: i2.CloudAuthUsersView.$converterroles.fromSql(
          row.read<String>('roles'),
        ),
      ),
    );
  }
  ...
  i0.Selectable<ListUsersResult> listUsers({
    ...
    return customSelect(
      ...
      (i0.QueryRow row) async => ListUsersResult(
        rowNum: row.read<int>('row_num'),
        cloudAuthUsersView: await cloudAuthUsersView.mapFromRow(
          row,
  ...
  i8.Future<List<i1.Email>> upsertUserEmail({
    ...
    ).then((rows) => Future.wait(rows.map(cloudAuthUserEmails.mapFromRow)));
  }
  ...
  i0.Selectable<i1.User> lookupUserByEmail({required String email}) {
    return customSelect(
      ...
      variables: [i0.Variable<String>(email)],
      readsFrom: {
        cloudAuthUsers,
        cloudAuthUserEmails,
        cloudAuthUserPhoneNumbers,
  ...
  i0.Selectable<i1.PhoneNumber> getUserPhoneNumbers({required String userId}) {
    return customSelect(
      ...
      variables: [i0.Variable<String>(userId)],
      readsFrom: {cloudAuthUserPhoneNumbers},
  ...
  i0.Selectable<i1.User> lookupUserByPhone({required String phoneNumber}) {
    return customSelect(
      ...
      variables: [i0.Variable<String>(phoneNumber)],
      readsFrom: {
        cloudAuthUsers,
        cloudAuthUserPhoneNumbers,
        cloudAuthUserEmails,
  ...
  i2.CloudAuthUsers get cloudAuthUsers => i7.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i2.CloudAuthUsers>('cloud_auth_users');
  i2.CloudAuthUsersView get cloudAuthUsersView => i7.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i2.CloudAuthUsersView>('cloud_auth_users_view');
  i2.CloudAuthUserEmails get cloudAuthUserEmails => i7.ReadDatabaseContainer(
    attachedDatabase,
  ...
  i9.CedarRelationships get cedarRelationships => i7.ReadDatabaseContainer(
    attachedDatabase,
...
class ListUsersResult {
  ...
  ListUsersResult({required this.rowNum, required this.cloudAuthUsersView});
}

typedef ListUsers$orderBy =
    i0.OrderBy Function(i2.CloudAuthUsersView cloud_auth_users_view);
