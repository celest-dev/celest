...
typedef $CedarTypesCreateCompanionBuilder =
    i1.CedarTypesCompanion Function({required String fqn, i0.Value<int> rowid});
typedef $CedarTypesUpdateCompanionBuilder =
    i1.CedarTypesCompanion Function({
      i0.Value<String> fqn,
      i0.Value<int> rowid,
    });

final class $CedarTypesReferences
    extends
  ...
  _cedarEntitiesRefsTable(i0.GeneratedDatabase db) => i0
      .MultiTypedResultKey.fromTable(
    i6.ReadDatabaseContainer(db).resultSet<i1.CedarEntities>('cedar_entities'),
    aliasName: i0.$_aliasNameGenerator(
      i6.ReadDatabaseContainer(db).resultSet<i1.CedarTypes>('cedar_types').fqn,
      i6.ReadDatabaseContainer(
        db,
      ).resultSet<i1.CedarEntities>('cedar_entities').entityType,
    ),
  );
    ...
    : super(
        i0.TableManagerState(
          ...
          updateCompanionCallback:
              ...
              }) => i1.CedarTypesCompanion(fqn: fqn, rowid: rowid),
          createCompanionCallback:
              ({
                required String fqn,
                i0.Value<int> rowid = const i0.Value.absent(),
              }) => i1.CedarTypesCompanion.insert(fqn: fqn, rowid: rowid),
          withReferenceMapper:
              (p0) =>
                  p0
                      .map(
                        (e) => (
                          e.readTable(table),
                          i1.$CedarTypesReferences(db, table, e),
                        ),
                      )
                      .toList(),
...
typedef $CedarTypesProcessedTableManager =
    i0.ProcessedTableManager<
      ...
      i0.PrefetchHooks Function({bool cedarEntitiesRefs})
    >;
typedef $CedarEntitiesCreateCompanionBuilder =
    i1.CedarEntitiesCompanion Function({
      required String entityType,
      required String entityId,
      i0.Value<Map<String, i2.CedarValue>> attributeJson,
    });
typedef $CedarEntitiesUpdateCompanionBuilder =
    i1.CedarEntitiesCompanion Function({
...
final class $CedarEntitiesReferences
    extends
        i0.BaseReferences<
          i0.GeneratedDatabase,
          i1.CedarEntities,
      ...
      i6.ReadDatabaseContainer(db)
          ...
          .createAlias(
            i0.$_aliasNameGenerator(
              ...
              i6.ReadDatabaseContainer(
                db,
              ).resultSet<i1.CedarTypes>('cedar_types').fqn,
            ),
          );
...
class $CedarEntitiesTableManager
    extends
        i0.RootTableManager<
          i0.GeneratedDatabase,
          i1.CedarEntities,
                ...
                if (entityType) {
                  state =
                      state.withJoin(
                            ...
                            referencedTable: i1.$CedarEntitiesReferences
                                ._entityTypeTable(db),
                            referencedColumn:
                                i1.$CedarEntitiesReferences
                                    ._entityTypeTable(db)
                                    .fqn,
                          )
                          as T;
...
typedef $CedarEntitiesProcessedTableManager =
    i0.ProcessedTableManager<
      i0.GeneratedDatabase,
      i1.CedarEntities,
      i1.CedarEntity,
...
class $CedarRelationshipsTableManager
    extends
        i0.RootTableManager<
          i0.GeneratedDatabase,
...
typedef $CedarRelationshipsProcessedTableManager =
    i0.ProcessedTableManager<
      i0.GeneratedDatabase,
      i1.CedarRelationships,
      i1.CedarRelationship,
      ...
      i0.PrefetchHooks Function()
    >;
typedef $CedarPoliciesCreateCompanionBuilder =
    i1.CedarPoliciesCompanion Function({
      required String id,
...
typedef $CedarPoliciesUpdateCompanionBuilder =
    i1.CedarPoliciesCompanion Function({
      i0.Value<String> id,
...
class $CedarPoliciesTableManager
    extends
        i0.RootTableManager<
          i0.GeneratedDatabase,
          i1.CedarPolicies,
...
typedef $CedarPoliciesProcessedTableManager =
    i0.ProcessedTableManager<
      i0.GeneratedDatabase,
      i1.CedarPolicies,
      i1.CedarPolicy,
...
class $CedarPolicyTemplatesTableManager
    extends
        i0.RootTableManager<
          i0.GeneratedDatabase,
...
typedef $CedarPolicyTemplatesProcessedTableManager =
    i0.ProcessedTableManager<
      i0.GeneratedDatabase,
      i1.CedarPolicyTemplates,
      i1.CedarPolicyTemplate,
...
class $CedarPolicyTemplateLinksTableManager
    extends
        i0.RootTableManager<
          i0.GeneratedDatabase,
  ...
  $CedarPolicyTemplateLinksTableManager(
    i0.GeneratedDatabase db,
    i1.CedarPolicyTemplateLinks table,
  ) : super(
        i0.TableManagerState(
          db: db,
          table: table,
...
class $CedarAuthorizationLogsTableManager
    extends
        i0.RootTableManager<
          i0.GeneratedDatabase,
  ...
  $CedarAuthorizationLogsTableManager(
    i0.GeneratedDatabase db,
    i1.CedarAuthorizationLogs table,
  ) : super(
        i0.TableManagerState(
          db: db,
          table: table,
...
typedef $CedarAuthorizationLogsProcessedTableManager =
    i0.ProcessedTableManager<
      i0.GeneratedDatabase,
      i1.CedarAuthorizationLogs,
      i1.CedarAuthorizationLog,
...
class CedarType extends i0.DataClass implements i0.Insertable<i1.CedarType> {
  ...
  factory CedarType.fromJson(
    Map<String, dynamic> json, {
    i0.ValueSerializer? serializer,
  }) {
    serializer ??= i0.driftRuntimeOptions.defaultSerializer;
    return CedarType(fqn: serializer.fromJson<String>(json['fqn']));
  }
  @override
  ...
  i1.CedarType copyWith({String? fqn}) => i1.CedarType(fqn: fqn ?? this.fqn);
  CedarType copyWithCompanion(i1.CedarTypesCompanion data) {
    return CedarType(fqn: data.fqn.present ? data.fqn.value : this.fqn);
  }
...
class CedarEntities extends i0.Table
  ...
  late final i0.GeneratedColumnWithTypeConverter<i3.EntityUid, String>
  entityJson = i0.GeneratedColumn<String>(
    'entity_json',
    aliasedName,
    false,
...
class CedarEntity extends i0.DataClass
  ...
  factory CedarEntity.fromJson(
    ...
    return CedarEntity(
      ...
      attributeJson: serializer.fromJson<Map<String, i2.CedarValue>>(
        json['attribute_json'],
      ),
  ...
  Map<String, dynamic> toJson({i0.ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'attribute_json': serializer.toJson<Map<String, i2.CedarValue>>(
        attributeJson,
      ),
...
class CedarRelationships extends i0.Table
  ...
  late final i0.GeneratedColumnWithTypeConverter<i3.EntityUid, String>
  parentJson = i0.GeneratedColumn<String>(
    'parent_json',
    aliasedName,
    false,
    generatedAs: i0.GeneratedAs(
...
class CedarRelationship extends i0.DataClass
  ...
  factory CedarRelationship.fromJson(
    Map<String, dynamic> json, {
    i0.ValueSerializer? serializer,
  }) {
    serializer ??= i0.driftRuntimeOptions.defaultSerializer;
...
class CedarPolicies extends i0.Table
  ...
  i1.CedarPolicy map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return i1.CedarPolicy(
      ...
      policy: i1.CedarPolicies.$converterpolicy.fromSql(
        attachedDatabase.typeMapping.read(
          i0.DriftSqlType.string,
  ...
  Map<String, i0.Expression> toColumns(bool nullToAbsent) {
    ...
    map['policy_id'] = i0.Variable<String>(policyId);
    {
      map['policy'] = i0.Variable<String>(
        i1.CedarPolicies.$converterpolicy.toSql(policy),
      );
    }
...
class CedarPolicyTemplate extends i0.DataClass
  ...
  factory CedarPolicyTemplate.fromJson(
    Map<String, dynamic> json, {
    i0.ValueSerializer? serializer,
  }) {
    serializer ??= i0.driftRuntimeOptions.defaultSerializer;
...
class CedarPolicyTemplateLinks extends i0.Table
  ...
  Set<i0.GeneratedColumn> get $primaryKey => {id};
  @override
  i1.CedarPolicyTemplateLink map(
...
class CedarPolicyTemplateLink extends i0.DataClass
  ...
  factory CedarPolicyTemplateLink.fromJson(
    Map<String, dynamic> json, {
    i0.ValueSerializer? serializer,
  }) {
    serializer ??= i0.driftRuntimeOptions.defaultSerializer;
...
class CedarAuthorizationLogs extends i0.Table
  ...
  errorsJson = i0.GeneratedColumn<String>(
    'errors_json',
    aliasedName,
    false,
    type: i0.DriftSqlType.string,
...
class CedarAuthorizationLog extends i0.DataClass
  ...
  factory CedarAuthorizationLog.fromJson(
    Map<String, dynamic> json, {
    i0.ValueSerializer? serializer,
  }) {
    serializer ??= i0.driftRuntimeOptions.defaultSerializer;
    return CedarAuthorizationLog(
      ...
      resourceType: serializer.fromJson<String?>(json['resource_type']),
      resourceId: serializer.fromJson<String?>(json['resource_id']),
      contextJson: serializer.fromJson<Map<String, i2.CedarValue>>(
        json['context_json'],
      ),
      decision: serializer.fromJson<bool>(json['decision']),
      reasonsJson: serializer.fromJson<List<String>>(json['reasons_json']),
      errorsJson: serializer.fromJson<i5.AuthorizationErrors>(
        json['errors_json'],
      ),
    );
  }
  ...
  Map<String, dynamic> toJson({i0.ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'resource_type': serializer.toJson<String?>(resourceType),
      'resource_id': serializer.toJson<String?>(resourceId),
      'context_json': serializer.toJson<Map<String, i2.CedarValue>>(
        contextJson,
      ),
...
class CedarAuthorizationLogsCompanion
  ...
  Map<String, i0.Expression> toColumns(bool nullToAbsent) {
    ...
    if (contextJson.present) {
      map['context_json'] = i0.Variable<String>(
        i1.CedarAuthorizationLogs.$convertercontextJson.toSql(
          contextJson.value,
        ),
      );
    }
    ...
    if (reasonsJson.present) {
      map['reasons_json'] = i0.Variable<String>(
        i1.CedarAuthorizationLogs.$converterreasonsJson.toSql(
          reasonsJson.value,
        ),
      );
    }
    if (errorsJson.present) {
      map['errors_json'] = i0.Variable<String>(
        i1.CedarAuthorizationLogs.$convertererrorsJson.toSql(errorsJson.value),
      );
    }
    return map;
  }
...
class CedarDrift extends i6.ModularAccessor {
  ...
  i0.Selectable<List<i3.Entity>> getEntityClosure({
    ...
    return customSelect(
      ...
      variables: [i0.Variable<String>(type), i0.Variable<String>(id)],
      readsFrom: {cedarRelationships, cedarEntities},
    ).map(
      (i0.QueryRow row) => const i2.CedarEntityClosureConverter().fromSql(
        row.read<String>('_c0'),
      ),
    );
  }
  ...
  i0.Selectable<DebugDumpCedarResult> debugDumpCedar() {
    return customSelect(
      ...
      variables: [],
      readsFrom: {cedarEntities, cedarRelationships},
    ).map(
      (i0.QueryRow row) => DebugDumpCedarResult(
  ...
  i0.Selectable<ListEffectivePoliciesResult> listEffectivePolicies() {
    return customSelect(
      ...
      (i0.QueryRow row) => ListEffectivePoliciesResult(
        id: row.read<String>('id'),
        policyId: row.read<String>('policy_id'),
        policy: i1.CedarPolicyTemplates.$convertertemplate.fromSql(
          row.read<String>('policy'),
        ),
  ...
  i7.Future<List<i1.CedarPolicyTemplateLink>> deletePolicyTemplateLink({
    ...
    return customWriteReturning(
      ...
      (rows) => Future.wait(rows.map(cedarPolicyTemplateLinks.mapFromRow)),
    );
  }
  ...
  i1.CedarRelationships get cedarRelationships => i6.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i1.CedarRelationships>('cedar_relationships');
  i1.CedarEntities get cedarEntities => i6.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i1.CedarEntities>('cedar_entities');
  i1.CedarPolicies get cedarPolicies => i6.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i1.CedarPolicies>('cedar_policies');
  i1.CedarPolicyTemplates get cedarPolicyTemplates => i6.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i1.CedarPolicyTemplates>('cedar_policy_templates');
  i1.CedarPolicyTemplateLinks get cedarPolicyTemplateLinks =>
      i6.ReadDatabaseContainer(
        attachedDatabase,
      ).resultSet<i1.CedarPolicyTemplateLinks>('cedar_policy_template_links');
  i1.CedarAuthorizationLogs get cedarAuthorizationLogs =>
      i6.ReadDatabaseContainer(
        attachedDatabase,
      ).resultSet<i1.CedarAuthorizationLogs>('cedar_authorization_logs');
  i1.CedarTypes get cedarTypes => i6.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i1.CedarTypes>('cedar_types');
}
