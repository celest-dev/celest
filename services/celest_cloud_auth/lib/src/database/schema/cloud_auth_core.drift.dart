...
class $CloudAuthCryptoKeysTableManager
    extends
        i0.RootTableManager<
...
typedef $CloudAuthCryptoKeysProcessedTableManager =
    i0.ProcessedTableManager<
      ...
      i0.PrefetchHooks Function()
    >;
typedef $CloudAuthSessionsCreateCompanionBuilder =
    i3.CloudAuthSessionsCompanion Function({
      i0.Value<int> rowid,
...
typedef $CloudAuthSessionsUpdateCompanionBuilder =
    i3.CloudAuthSessionsCompanion Function({
      i0.Value<int> rowid,
...
class $CloudAuthSessionsTableManager
    extends
        i0.RootTableManager<
          i0.GeneratedDatabase,
...
typedef $CloudAuthSessionsProcessedTableManager =
    i0.ProcessedTableManager<
      i0.GeneratedDatabase,
      i3.CloudAuthSessions,
      i4.Session,
      ...
      i0.PrefetchHooks Function()
    >;
typedef $CloudAuthOtpCodesCreateCompanionBuilder =
    i3.CloudAuthOtpCodesCompanion Function({
      i0.Value<int> rowid,
      required String sessionId,
...
typedef $CloudAuthOtpCodesUpdateCompanionBuilder =
    i3.CloudAuthOtpCodesCompanion Function({
      i0.Value<int> rowid,
      i0.Value<String> sessionId,
      i0.Value<int> resendAttempt,
...
class $CloudAuthOtpCodesTableManager
    extends
        i0.RootTableManager<
          i0.GeneratedDatabase,
...
typedef $CloudAuthOtpCodesProcessedTableManager =
    i0.ProcessedTableManager<
      i0.GeneratedDatabase,
      i3.CloudAuthOtpCodes,
      i3.CloudAuthOtpCode,
      ...
      i0.PrefetchHooks Function()
    >;
typedef $CloudAuthCorksCreateCompanionBuilder =
    i3.CloudAuthCorksCompanion Function({
...
typedef $CloudAuthCorksUpdateCompanionBuilder =
    i3.CloudAuthCorksCompanion Function({
...
class $CloudAuthCorksTableManager
    extends
        i0.RootTableManager<
          i0.GeneratedDatabase,
          i3.CloudAuthCorks,
...
typedef $CloudAuthCorksProcessedTableManager =
    i0.ProcessedTableManager<
      i0.GeneratedDatabase,
      i3.CloudAuthCorks,
      i3.CloudAuthCork,
...
class CloudAuthCryptoKeysCompanion extends i0.UpdateCompanion<i1.CryptoKey> {
  ...
  Map<String, i0.Expression> toColumns(bool nullToAbsent) {
    ...
    if (externalCryptoKeyId.present) {
      map['external_crypto_key_id'] = i0.Variable<String>(
...
class CloudAuthSessions extends i0.Table
  ...
  state = i0.GeneratedColumn<i2.Uint8List>(
    'state',
    aliasedName,
    true,
    type: i0.DriftSqlType.blob,
    requiredDuringInsert: false,
    $customConstraints: '',
  ).withConverter<i4.SessionState?>(i3.CloudAuthSessions.$converterstaten);
  ...
  i4.Session map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return i4.Session(
      ...
      state: i3.CloudAuthSessions.$converterstaten.fromSql(
        attachedDatabase.typeMapping.read(
          i0.DriftSqlType.blob,
  ...
  $converterclientInfon = i0.NullAwareTypeConverter.wrap($converterclientInfo);
  ...
  static i0.TypeConverter<i4.SessionState?, i2.Uint8List?> $converterstaten = i0
      .NullAwareTypeConverter.wrap($converterstate);
  @override
  List<String> get customConstraints => const [
...
class CloudAuthSessionsCompanion extends i0.UpdateCompanion<i4.Session> {
  ...
  Map<String, i0.Expression> toColumns(bool nullToAbsent) {
    ...
    if (authenticationFactor.present) {
      map['authentication_factor'] = i0.Variable<i2.Uint8List>(
        i3.CloudAuthSessions.$converterauthenticationFactor.toSql(
    ...
    if (createTime.present) {
      map['create_time'] = i0.Variable<DateTime>(
        createTime.value,
        const i5.TimestampType(),
      );
    }
    if (updateTime.present) {
      map['update_time'] = i0.Variable<DateTime>(
        updateTime.value,
        const i5.TimestampType(),
      );
    }
    if (expireTime.present) {
      map['expire_time'] = i0.Variable<DateTime>(
        expireTime.value,
        const i5.TimestampType(),
      );
    }
...
class CloudAuthOtpCode extends i0.DataClass
  ...
  factory CloudAuthOtpCode.fromJson(
...
class CloudAuthCork extends i0.DataClass
  ...
  Map<String, i0.Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || lastUseTime != null) {
      map['last_use_time'] = i0.Variable<DateTime>(
        lastUseTime,
        const i5.TimestampType(),
      );
    }
  ...
  factory CloudAuthCork.fromJson(
    Map<String, dynamic> json, {
    i0.ValueSerializer? serializer,
  }) {
    serializer ??= i0.driftRuntimeOptions.defaultSerializer;
...
i0.Index get cloudAuthCorksBearerIdx => i0.Index(
...
i0.Index get cloudAuthCorksIssuerIdx => i0.Index(
...
class CloudAuthCoreDrift extends i7.ModularAccessor {
  ...
  i8.Future<List<i1.CryptoKey>> createCryptoKey({
    ...
    ).then((rows) => Future.wait(rows.map(cloudAuthCryptoKeys.mapFromRow)));
  }
  ...
  i0.Selectable<i1.CryptoKey> getExternalCryptoKey({
    ...
    return customSelect(
      ...
      variables: [i0.Variable<String>(externalCryptoKeyId)],
      readsFrom: {cloudAuthCryptoKeys},
    ).asyncMap(cloudAuthCryptoKeys.mapFromRow);
  }
  ...
  i0.Selectable<i3.CloudAuthCork> getCork({required i2.Uint8List corkId}) {
    return customSelect(
      'SELECT * FROM cloud_auth_corks WHERE cork_id = ?1',
      variables: [i0.Variable<i2.Uint8List>(corkId)],
      readsFrom: {cloudAuthCorks},
  ...
  i0.Selectable<i3.CloudAuthOtpCode> getOtpCode({required String sessionId}) {
    return customSelect(
      ...
      variables: [i0.Variable<String>(sessionId)],
      readsFrom: {cloudAuthOtpCodes},
    ).asyncMap(cloudAuthOtpCodes.mapFromRow);
  }

  i3.CloudAuthCryptoKeys get cloudAuthCryptoKeys => i7.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i3.CloudAuthCryptoKeys>('cloud_auth_crypto_keys');
  i3.CloudAuthSessions get cloudAuthSessions => i7.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i3.CloudAuthSessions>('cloud_auth_sessions');
  i3.CloudAuthCorks get cloudAuthCorks => i7.ReadDatabaseContainer(
    attachedDatabase,
  ).resultSet<i3.CloudAuthCorks>('cloud_auth_corks');
  i3.CloudAuthOtpCodes get cloudAuthOtpCodes => i7.ReadDatabaseContainer(
    attachedDatabase,
