...
class TestData extends DataClass implements Insertable<TestData> {
  final String userId;
  const TestData({required this.userId});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['user_id'] = Variable<String>(userId);
  ...
  factory TestData.fromJson(
    ...
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return TestData(userId: serializer.fromJson<String>(json['userId']));
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  TestData copyWith({String? userId}) =>
      TestData(userId: userId ?? this.userId);
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TestData && other.userId == this.userId);
}
...
class TestCompanion extends UpdateCompanion<TestData> {
  ...
  TestCompanion copyWith({Value<String>? userId, Value<int>? rowid}) {
