...
class UserEmailsData extends DataClass implements Insertable<UserEmailsData> {
  ...
  factory UserEmailsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class UserPhoneNumbersData extends DataClass
  ...
  factory UserPhoneNumbersData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class CelestProjectsData extends DataClass
  ...
  factory CelestProjectsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class CelestApisData extends DataClass implements Insertable<CelestApisData> {
  ...
  factory CelestApisData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class CelestFunctionsData extends DataClass
  ...
  factory CelestFunctionsData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class CelestCloudAuthMeta extends Table
    with TableInfo<CelestCloudAuthMeta, CelestCloudAuthMetaData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class CelestCloudAuthMetaData extends DataClass
    implements Insertable<CelestCloudAuthMetaData> {
  ...
  factory CelestCloudAuthMetaData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  CelestCloudAuthMetaData copyWith({int? schemaVersion}) =>
      CelestCloudAuthMetaData(
        schemaVersion: schemaVersion ?? this.schemaVersion,
      );
  CelestCloudAuthMetaData copyWithCompanion(CelestCloudAuthMetaCompanion data) {
    return CelestCloudAuthMetaData(
      schemaVersion:
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is CelestCloudAuthMetaData &&
          other.schemaVersion == this.schemaVersion);
}

class CelestCloudAuthMetaCompanion
    extends UpdateCompanion<CelestCloudAuthMetaData> {
  ...
  static Insertable<CelestCloudAuthMetaData> custom({
  ...
  CelestCloudAuthMetaCompanion copyWith({Value<int>? schemaVersion}) {
    return CelestCloudAuthMetaCompanion(
      schemaVersion: schemaVersion ?? this.schemaVersion,
    );
  }
...
class CryptoKeysData extends DataClass implements Insertable<CryptoKeysData> {
  ...
  factory CryptoKeysData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
...
class DatabaseAtV3 extends GeneratedDatabase {
  ...
  late final Index celestApisProjectIdx = Index(
    'celest_apis_project_idx',
  ...
  late final Index celestFunctionsApiIdx = Index(
    'celest_functions_api_idx',
  ...
  late final CelestCloudAuthMeta celestCloudAuthMeta = CelestCloudAuthMeta(
    this,
  );
  ...
  late final Index sessionsUserIdx = Index(
    'sessions_user_idx',
    'CREATE INDEX IF NOT EXISTS sessions_user_idx ON sessions (user_id)',
  );
  late final Index sessionsCryptoKeyIdx = Index(
    'sessions_crypto_key_idx',
