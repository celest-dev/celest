...
void main() {
  ...
  group('Authorizer', () {
    ...
    group('api auth', () {
      ...
      const adminFunctionAdmin =
          EntityUid.of('Celest::Function', 'admin/adminAdmin');
      const adminFunctionAuthenticated =
          EntityUid.of('Celest::Function', 'admin/adminAuthenticated');
      const adminFunctionPublic =
          EntityUid.of('Celest::Function', 'admin/adminPublic');

      const authenticatedFunction =
          EntityUid.of('Celest::Function', 'authenticated/authenticated');
      const authenticatedFunctionAdmin =
          EntityUid.of('Celest::Function', 'authenticated/authenticatedAdmin');
      const authenticatedFunctionAuthenticated = EntityUid.of(
        'Celest::Function',
        'authenticated/authenticatedAuthenticated',
      );
      const authenticatedFunctionPublic =
          EntityUid.of('Celest::Function', 'authenticated/authenticatedPublic');

      const publicFunction = EntityUid.of('Celest::Function', 'public/public');
      const publicFunctionAdmin =
          EntityUid.of('Celest::Function', 'public/publicAdmin');
      const publicFunctionAuthenticated =
          EntityUid.of('Celest::Function', 'public/publicAuthenticated');
      const publicFunctionPublic =
          EntityUid.of('Celest::Function', 'public/publicPublic');
                ...
                policySet: PolicySet(
                  ...
                  templateLinks: const [
                    TemplateLink(
                      ...
                      newId: 'admin-admin',
                      values: {
                        SlotId.resource: adminFunctionAdmin,
                      },
                    ),
                  ],
                ),
                ...
                policySet: PolicySet(
                  ...
                  templateLinks: const [
                    TemplateLink(
                      ...
                      values: {
                        SlotId.resource: adminFunctionAuthenticated,
                      },
                    ),
                  ],
                ),
                ...
                policySet: PolicySet(
                  templateLinks: const [
                    TemplateLink(
                      ...
                      newId: 'admin-public',
                      values: {
                        SlotId.resource: adminFunctionPublic,
                      },
                    ),
                  ],
                ),
          ...
          'authenticated': ResolvedApi(
            ...
            policySet: PolicySet(
              ...
              templateLinks: const [
                TemplateLink(
                  ...
                  values: {
                    SlotId.resource: apiAuthenticated,
                  },
                ),
              ],
            ),
            functions: {
                ...
                policySet: PolicySet(
                  ...
                  templateLinks: const [
                    TemplateLink(
                      ...
                      values: {
                        SlotId.resource: authenticatedFunctionAdmin,
                      },
                    ),
                  ],
                ),
              ...
              'authenticatedAuthenticated': ResolvedCloudFunction(
                ...
                httpConfig: ResolvedHttpConfig(
                  route:
                      ResolvedHttpRoute(path: '/authenticated/authenticated'),
                ),
                policySet: PolicySet(
                  policies: {
                ...
                policySet: PolicySet(
                  templateLinks: const [
                    TemplateLink(
                      ...
                      values: {
                        SlotId.resource: authenticatedFunctionPublic,
                      },
                    ),
                  ],
                ),
                ...
                policySet: PolicySet(
                  ...
                  templateLinks: const [
                    TemplateLink(
                      ...
                      newId: 'public-admin',
                      values: {
                        SlotId.resource: publicFunctionAdmin,
                      },
                    ),
                  ],
                ),
                ...
                policySet: PolicySet(
                  ...
                  templateLinks: const [
                    TemplateLink(
                      ...
                      values: {
                        SlotId.resource: publicFunctionAuthenticated,
                      },
                    ),
                  ],
                ),
                ...
                policySet: PolicySet(
                  templateLinks: const [
                    TemplateLink(
                      ...
                      newId: 'public-public',
                      values: {
                        SlotId.resource: publicFunctionPublic,
                      },
                    ),
                  ],
                ),
