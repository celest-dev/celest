...
void main() {
  ...
  final hasAccessToken = Platform.environment.containsKey('FLY_API_TOKEN');
...
''';
    ...
    final bytes =
        await fileSystem.file('$tmpDir/celest.aot.dill').readAsBytes();
    ...
    await context.fly.apps.delete(appName: state.flyAppName!);
