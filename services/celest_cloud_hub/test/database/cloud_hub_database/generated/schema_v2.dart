...
class ProjectEnvironmentStates extends Table
  ...
  late final GeneratedColumn<String> flyVolumeId = GeneratedColumn<String>(
    'fly_volume_id',
    aliasedName,
    true,
    type: DriftSqlType.string,
...
class ProjectEnvironmentStatesData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || flyVolumeId != null) {
      map['fly_volume_id'] = Variable<String>(flyVolumeId);
    }
    return map;
  }
  ...
  factory ProjectEnvironmentStatesData.fromJson(
    ...
    return ProjectEnvironmentStatesData(
      ...
      flyVolumeId: serializer.fromJson<String?>(json['flyVolumeId']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'flyVolumeId': serializer.toJson<String?>(flyVolumeId),
    };
  }
  ...
  ProjectEnvironmentStatesData copyWith({
    ...
    Value<String?> flyVolumeId = const Value.absent(),
...
class ProjectEnvironmentStatesCompanion
  ...
  final Value<String?> flyVolumeId;
  const ProjectEnvironmentStatesCompanion({
    ...
    this.flyVolumeId = const Value.absent(),
  });
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (flyVolumeId.present) {
      map['fly_volume_id'] = Variable<String>(flyVolumeId.value);
    }
    return map;
  }
