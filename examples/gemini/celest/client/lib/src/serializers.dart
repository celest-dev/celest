...
import 'package:google_generative_ai/src/error.dart'
    as _$google_generative_ai_error;
...
void initSerializers({_$celest.Serializers? serializers}) {
  return runZoned(
    () {
      ...
      _$celest.Serializers.instance.put(_$celest.Serializer.define<
          _$google_generative_ai_error.GenerativeAIException,
          Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
          return _$google_generative_ai_error.GenerativeAIException(
              ($serialized[r'message'] as String));
        },
      ));
      _$celest.Serializers.instance.put(_$celest.Serializer.define<
          _$google_generative_ai_error.InvalidApiKey, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
          return _$google_generative_ai_error.InvalidApiKey(
              ($serialized[r'message'] as String));
        },
      ));
      _$celest.Serializers.instance.put(_$celest.Serializer.define<
          _$google_generative_ai_error.ServerException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
          return _$google_generative_ai_error.ServerException(
              ($serialized[r'message'] as String));
        },
      ));
      _$celest.Serializers.instance.put(_$celest.Serializer.define<
        ...
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
          return _$google_generative_ai_error.UnsupportedUserLocation();
        },
      ));
      _$celest.Serializers.instance.put(_$celest.Serializer.define<
