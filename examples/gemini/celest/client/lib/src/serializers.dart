...
void initSerializers({_$celest.Serializers? serializers}) {
  return _$async.runZoned(
    () {
      ...
      _$celest.Serializers.instance.put(_$celest.Serializer.define<
          _$error.GenerativeAIException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
          return _$error.GenerativeAIException(
              ($serialized[r'message'] as String));
        },
      ));
      _$celest.Serializers.instance.put(_$celest.Serializer.define<
          _$error.InvalidApiKey, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
      ...
      _$celest.Serializers.instance.put(_$celest.Serializer.define<
          _$error.ServerException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
      ...
      _$celest.Serializers.instance.put(_$celest.Serializer.define<
          _$error.UnsupportedUserLocation, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
      ...
      _$celest.Serializers.instance.put(_$celest.Serializer.define<
          _$exception.ClientException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
          r'message': $value.message,
