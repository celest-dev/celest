...
class CelestFunctionsGemini {
  Never _throwError({
    ...
    switch (errorType) {
      ...
      case 'google_generative_ai.GenerativeAIException':
        Error.throwWithStackTrace(
          _$celest.Serializers.instance
              .deserialize<_$error.GenerativeAIException>(errorValue),
          stackTrace,
        );
      case 'google_generative_ai.InvalidApiKey':
        Error.throwWithStackTrace(
          _$celest.Serializers.instance
              .deserialize<_$error.InvalidApiKey>(errorValue),
          stackTrace,
        );
      case 'google_generative_ai.UnsupportedUserLocation':
        Error.throwWithStackTrace(
          _$celest.Serializers.instance
              .deserialize<_$error.UnsupportedUserLocation>(errorValue),
          stackTrace,
        );
      case 'google_generative_ai.ServerException':
        Error.throwWithStackTrace(
          _$celest.Serializers.instance
              .deserialize<_$error.ServerException>(errorValue),
          stackTrace,
        );
      case 'http.ClientException':
        Error.throwWithStackTrace(
          _$celest.Serializers.instance
              .deserialize<_$exception.ClientException>(errorValue),
          stackTrace,
        );
      default:
        Error.throwWithStackTrace(
