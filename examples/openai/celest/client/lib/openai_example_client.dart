...
import 'package:openai_example_client/src/functions.dart';
import 'package:openai_example_client/src/serializers.dart';

export 'package:celest_backend/models.dart' show ModelParameters;
...
enum CelestEnvironment {
  ...
  Uri get baseUri => switch (this) {
        local => _$celest.kIsWeb || !Platform.isAndroid
            ? Uri.parse('http://localhost:55830')
            : Uri.parse('http://10.0.2.2:55830'),
      };
}
