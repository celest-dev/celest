...
class ExampleTest {
  ...
  Future<PostTestResponse> postTest({Request? body}) async {
...
final class ExampleClient {
  ...
  ExampleTest get test => ExampleTest(
        baseUri: _baseUri,
...
/// Response type for [ExampleTest.postTest].
typedef PostTestResponse = Response;
