...
final class OpenApiPetstoreClient {
  ...
  Future<GetResponse> get() async {
    ...
    switch ($response.statusCode) {
      ...
      case 200:
        return _decodeJson<Household>($response);
      default:
...
sealed class Household_pets_item {
  const Household_pets_item();
}

final class Household_pets extends _i4.DelegatingList<Household_pets_item> {
  Household_pets(super.base);
}

final class Household {
  Household({required this.pets});

  final Household_pets pets;
}

/// Response type for [OpenApiPetstoreClient.get].
typedef GetResponse = Household;
