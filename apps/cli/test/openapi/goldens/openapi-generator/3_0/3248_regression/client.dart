...
class InfoApi {
  ...
  /// summary
  /// description
  Future<GetExampleApiResponse> getExampleApi({
...
extension type const Format(String _) implements String {
  static const Format json = Format('json');

  static const Format csv = Format('csv');
}
extension type const format(String _) implements String {
  static const format json = format('json');
