...
final class Adult_children extends _i4.DelegatingList<Child> {
  Adult_children(super.base);
}
...
final class Adult {
  ...
  final Integer$? duplicatedOptional;

  final Integer$ duplicatedRequired;

  final DateTime personRequired;

  final Adult_children? children;

  final Boolean$? adultRequired;
}

class MapOnly extends _i4.DelegatingMap<String, String> {
  MapOnly(super.base);
}

final class MapOnlyWithProperties {
  MapOnlyWithProperties({this.firstName});
