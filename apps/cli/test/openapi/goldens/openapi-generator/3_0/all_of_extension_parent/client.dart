...
final class AnotherChild {
  AnotherChild({this.age});
...
final class AnotherPerson {
  ...
  final String$? mumOrDad;
}

final class AnotherParent {
  AnotherParent({
    this.isParent,
    this.mumOrDad,
  });
...
final class AllOfWithProperties {
  AllOfWithProperties({
    this.isParent,
    this.mumOrDad,
  });
...
final class AllOfWithSingleItem {
  AllOfWithSingleItem({
    this.isParent,
    this.mumOrDad,
  });
