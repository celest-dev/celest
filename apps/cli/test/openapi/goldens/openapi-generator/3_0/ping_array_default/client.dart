...
final class AnArrayOfString_arrayWithADefaultValue
    extends _i4.DelegatingList<String$> {
  AnArrayOfString_arrayWithADefaultValue(super.base);
}

final class AnArrayOfString {
  AnArrayOfString({this.arrayWithADefaultValue});

  final AnArrayOfString_arrayWithADefaultValue? arrayWithADefaultValue;
}
