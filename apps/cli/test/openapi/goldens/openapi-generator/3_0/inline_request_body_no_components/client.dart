...
class ExampleTest1 {
  ...
  Future<Test1Response> test1({Test1Request? body}) async {
    final $uri = Uri.parse('$_baseUri/test1');
...
final class ExampleClient {
  ...
  ExampleTest1 get test1 => ExampleTest1(
        baseUri: _baseUri,
...
final class Test1Request {
  Test1Request({this.name});
...
/// Response type for [ExampleTest1.test1].
typedef Test1Response = Empty$;
