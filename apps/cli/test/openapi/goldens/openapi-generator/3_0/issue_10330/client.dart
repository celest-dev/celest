...
final class ObjectWithComposedProperties {
  ...
  final Any$? composedObject;

  final Any$? composedNumber;

  final Any$? composedInteger;

  final Any$? composedString;

  final Any$? composedBool;

  final Any$? composedArray;

  final Any$? composedNone;

  final Any$? composedAnyType;
}

typedef ComposedObject = Any$;
typedef ComposedNumber = Any$;
typedef ComposedInteger = Any$;
typedef ComposedString = Any$;
typedef ComposedBool = Any$;
typedef ComposedArray = Any$;
typedef ComposedNone = Any$;
typedef ComposedAnyType = Any$;
