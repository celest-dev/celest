...
class SampleApIsStuff {
  ...
  Future<Api01Response> api01({String? param1}) async {
    ...
    switch ($response.statusCode) {
      /// OK
      case 200:
        return _decodeJson<API01_ListOfStuff>($response);
      default:
...
final class API01_ListOfStuff extends _i4.DelegatingList<API01_AbstractStuff> {
  API01_ListOfStuff(super.base);
}

/// Response type for [SampleApIsStuff.api01].
typedef Api01Response = API01_ListOfStuff;
