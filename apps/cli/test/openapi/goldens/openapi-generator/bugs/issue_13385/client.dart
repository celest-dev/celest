...
class ArrayNullableTestApiArrayNullable {
  ArrayNullableTestApiArrayNullable({
  ...
  Future<DummyResponse> dummy() async {
    final $uri = Uri.parse('$_baseUri/arrayNullable');
...
final class ArrayNullableTestApiClient {
  ...
  ArrayNullableTestApiArrayNullable get arrayNullable =>
      ArrayNullableTestApiArrayNullable(
        baseUri: _baseUri,
...
/// Response type for [ArrayNullableTestApiArrayNullable.dummy].
