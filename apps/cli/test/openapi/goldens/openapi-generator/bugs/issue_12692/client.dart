...
class SwaggerPetstorePets {
  ...
  Future<ListPetsResponse> listPets() async {
    ...
    switch ($response.statusCode) {
      /// description
      case 200:
        return _decodeJson<ListPetsResponse>($response);
      default:
...
final class Cat {
  Cat({required this.type});

  final String$ type;
}

final class ListPetsResponse extends _i4.DelegatingList<Pet> {
  ListPetsResponse(super.base);
}
