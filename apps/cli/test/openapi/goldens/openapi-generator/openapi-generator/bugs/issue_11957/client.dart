...
class SearchApiDefaultList {
  ...
  Future<DefaultListResponse> defaultList({
    int? p,
    required List<OrderBy_item> orderBy,
  }) async {
...
class SearchApiDefaultSet {
  ...
  Future<DefaultSetResponse> defaultSet({
    int? p,
    required Set<OrderBy_item> orderBy,
  }) async {
    final $queryParameters = <String, String>{};
    if (p != null) {
      $queryParameters['p'] = p.toString();
...
extension type const OrderBy_item(String _) implements String {
  static const OrderBy_item createdAtAsc = OrderBy_item('createdAt:ASC');

  static const OrderBy_item createdAtDesc = OrderBy_item('createdAt:DESC');

  static const OrderBy_item updatedAtAsc = OrderBy_item('updatedAt:ASC');

  static const OrderBy_item updatedAtDesc = OrderBy_item('updatedAt:DESC');
}
