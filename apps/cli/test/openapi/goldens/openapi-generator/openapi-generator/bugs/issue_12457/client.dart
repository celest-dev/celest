...
class OpenApiPetstoreRequest {
  ...
  Future<WildcardSubTypeForContentTypeResponse> wildcardSubTypeForContentType(
      {String? body}) async {
    final $uri = Uri.parse('$_baseUri/request');
...
final class OpenApiPetstoreClient {
  ...
  OpenApiPetstoreRequest get request => OpenApiPetstoreRequest(
        baseUri: _baseUri,
...
/// Response type for [OpenApiPetstoreRequest.wildcardSubTypeForContentType].
typedef WildcardSubTypeForContentTypeResponse = String$;
