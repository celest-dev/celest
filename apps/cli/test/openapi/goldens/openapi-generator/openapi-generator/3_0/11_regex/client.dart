...
class TestTest {
  ...
  Future<GetTestResponse> getTest({required String uuid}) async {
...
typedef Uuid = String;
typedef StringWithRegexWithThreeFlags = String;

final class Empty$ {
  const Empty$._();
}

/// Response type for [TestTest.getTest].
typedef GetTestResponse = Empty$;
