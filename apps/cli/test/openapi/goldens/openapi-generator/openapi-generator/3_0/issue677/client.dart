...
class MyTitleIssue677 {
  ...
  Future<PostIssue677Response> postIssue677({List<String>? body}) async {
    final $uri = Uri.parse('$_baseUri/issue677');
...
final class MyTitleClient {
  ...
  MyTitleIssue677 get issue677 => MyTitleIssue677(
        baseUri: _baseUri,
...
/// Response type for [MyTitleIssue677.postIssue677].
typedef PostIssue677Response = Empty$;
