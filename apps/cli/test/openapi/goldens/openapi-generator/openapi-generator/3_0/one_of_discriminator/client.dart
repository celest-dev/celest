...
final class FruitInlineDisc__$OpenApiStructTypeSchema {
  FruitInlineDisc__$OpenApiStructTypeSchema({
    required this.seeds,
...
final class FruitInlineInlineDisc__$OpenApiDisjointUnionTypeSchema__$OpenApiStructTypeSchema {
  FruitInlineInlineDisc__$OpenApiDisjointUnionTypeSchema__$OpenApiStructTypeSchema(
      {required this.fruitType});

  final String fruitType;
}

sealed class FruitInlineInlineDisc__$OpenApiDisjointUnionTypeSchema {
  const FruitInlineInlineDisc__$OpenApiDisjointUnionTypeSchema();
}
...
typedef DiscMissingNoProperties = Object;
