...
final class FruityClient {
  ...
  Future<TestResponse> test({Object? body}) async {
    final $uri = Uri.parse('$_baseUri/');
    final $request = _i1.Request(
      'PUT',
      $uri,
...
class Apples extends _i4.DelegatingMap<String, apple> {
  Apples(super.base);
}
...
final class Grapes extends _i4.DelegatingList<grape> {
  Grapes(super.base);
}
...
typedef GetResponse = fruit;

final class Empty$ {
  const Empty$._();
}

/// Response type for [FruityClient.test].
