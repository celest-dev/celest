...
extension type const Type(String _) implements String {
  static const Type earth = Type('Earth');

  static const Type pegasi = Type('Pegasi');

  static const Type unicorn = Type('Unicorn');
}
