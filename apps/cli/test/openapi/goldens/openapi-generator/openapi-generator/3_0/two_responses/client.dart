...
extension type TestServers(Uri _) implements Uri {
  ...
  static final TestServers server0 = TestServers(Uri.parse(r'http://test/'));
}
...
class TestTest {
  ...
  Future<GetTestResponse> getTest() async {
    ...
    switch ($response.statusCode) {
      /// Success
      case 200:
        return _decodeJson<GetTestResponse>($response);
...
final class GetTestResponse {
  GetTestResponse({this.test});
