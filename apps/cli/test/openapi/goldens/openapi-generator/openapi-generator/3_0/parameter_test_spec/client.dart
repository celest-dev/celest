...
class TestParametersPathDefault {
  ...
  Future<FindPetsByStatusResponse> findPetsByStatus({
    ...
    String? queryDefault,
    required QueryDefaultEnum queryDefaultEnum,
...
extension type const QueryDefaultEnum(String _) implements String {
  static const QueryDefaultEnum a = QueryDefaultEnum('A');

  static const QueryDefaultEnum b = QueryDefaultEnum('B');

  static const QueryDefaultEnum c = QueryDefaultEnum('C');
}
extension type const HeaderDefaultEnum(String _) implements String {
  static const HeaderDefaultEnum a = HeaderDefaultEnum('A');

  static const HeaderDefaultEnum b = HeaderDefaultEnum('B');

  static const HeaderDefaultEnum c = HeaderDefaultEnum('C');
}
extension type const CookieDefaultEnum(String _) implements String {
  static const CookieDefaultEnum a = CookieDefaultEnum('A');

  static const CookieDefaultEnum b = CookieDefaultEnum('B');

  static const CookieDefaultEnum c = CookieDefaultEnum('C');
}
