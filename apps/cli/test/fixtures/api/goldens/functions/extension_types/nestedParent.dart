...
final class NestedParentTarget extends _i1.CloudFunctionTarget {
  @override
  ...
  void init() {
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i4.NestedParent, String>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return _i4.NestedParent.fromJson($serialized);
      },
    ));
