...
import 'package:_common/src/models/available_stock.dart' as _i9;
...
final class AvailableStocksTarget extends _i1.CloudFunctionTarget {
  ...
  void init() {
    ...
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i8.AvailableStock, Map<String, Object?>>(
      serialize: ($value) => {
      ...
      deserialize: ($serialized) {
        return (_i9.AvailableStock(
          ($serialized[r'ticker'] as String),
          name: ($serialized[r'name'] as String),
          currentPrice: ($serialized[r'currentPrice'] as num).toDouble(),
        ) as _i8.AvailableStock);
      },
    ));
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i8.AvailableStocks, Map<String, Object?>>(
      serialize: ($value) => {
        r'list': _i3.Serializers.instance
            .serialize<_i10.IList<_i9.AvailableStock>>($value.list)
      },
      deserialize: ($serialized) {
        return (_i4.AvailableStocks(($serialized[r'list'] as Iterable<Object?>)
            .map((el) =>
                _i3.Serializers.instance.deserialize<_i9.AvailableStock>(el))
            .toList()) as _i8.AvailableStocks);
      },
    ));
    ...
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i10.IList<_i9.AvailableStock>, dynamic>(
      serialize: ($value) => $value.toJson((value) =>
          _i3.Serializers.instance.serialize<_i9.AvailableStock>(value)),
      deserialize: ($serialized) {
        return _i10.IList<_i9.AvailableStock>.fromJson(
          $serialized,
          (value) =>
              _i3.Serializers.instance.deserialize<_i9.AvailableStock>(value),
        );
      },
    ));
  }
