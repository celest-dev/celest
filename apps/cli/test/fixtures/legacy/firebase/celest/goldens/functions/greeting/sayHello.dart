...
import 'package:celest_backend/src/functions/greeting.dart' as _i2;
...
final class SayHelloTarget extends _i1.CloudFunctionHttpTarget {
    ...
    try {
      final response = await _i2.sayHello(
          person: _i3.Serializers.instance
              .deserialize<_i2.Person>(request[r'person']));
      ...
      final error = {
        ...
        'details': _i3.Serializers.instance.serialize<_i5.AsyncError>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
    } on _i2.BadNameException catch (e) {
      const statusCode = 400;
      print('$statusCode $e');
      final error = {
        'code': 'firebase_test.v1.BadNameException',
        'details': _i3.Serializers.instance.serialize<_i2.BadNameException>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
      ...
      final error = {
        ...
        'details': _i3.Serializers.instance.serialize<_i5.TimeoutException>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
  ...
  void init() {
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i5.AsyncError, Map<String, Object?>>(
      serialize: ($value) => {
        r'error': $value.error,
        r'stackTrace':
    ...
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i5.TimeoutException, Map<String, Object?>>(
      serialize: ($value) => {
    ...
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i2.BadNameException, Map<String, Object?>>(
      serialize: ($value) => {r'message': $value.message},
      deserialize: ($serialized) {
        return _i2.BadNameException(($serialized[r'message'] as String));
      },
    ));
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i2.Person, Map<String, Object?>>(
      serialize: ($value) => {r'name': $value.name},
      deserialize: ($serialized) {
        return _i2.Person(name: ($serialized[r'name'] as String));
      },
    ));
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i4.AbortedException, Map<String, Object?>>(
      serialize: ($value) => {
        r'message': $value.message,
    ...
    _i3.Serializers.instance.put(
        _i3.Serializer.define<_i4.AlreadyExistsException, Map<String, Object?>>(
      serialize: ($value) => {
        r'message': $value.message,
        r'details': _i3.Serializers.instance.serialize<_i8.JsonValue?>(
          $value.details,
    ...
    _i3.Serializers.instance.put(
        _i3.Serializer.define<_i4.BadRequestException, Map<String, Object?>>(
      serialize: ($value) => {
        r'message': $value.message,
        r'details': _i3.Serializers.instance.serialize<_i8.JsonValue?>(
          $value.details,
    ...
    _i3.Serializers.instance.put(
        _i3.Serializer.define<_i4.CancelledException, Map<String, Object?>>(
      serialize: ($value) => {
        r'message': $value.message,
        r'details': _i3.Serializers.instance.serialize<_i8.JsonValue?>(
          $value.details,
    ...
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i4.CloudException, Map<String, Object?>>(
      serialize: ($value) => {
        r'message': $value.message,
        r'details': _i3.Serializers.instance.serialize<_i8.JsonValue?>(
          $value.details,
    ...
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i4.DataLossError, Map<String, Object?>>(
      serialize: ($value) => {
        r'message': $value.message,
        r'details': _i3.Serializers.instance.serialize<_i8.JsonValue?>(
          $value.details,
    ...
    _i3.Serializers.instance.put(
        _i3.Serializer.define<_i4.DeadlineExceededError, Map<String, Object?>>(
      serialize: ($value) => {
        r'message': $value.message,
        r'details': _i3.Serializers.instance.serialize<_i8.JsonValue?>(
          $value.details,
    ...
    _i3.Serializers.instance.put(
        _i3.Serializer.define<_i4.InternalServerError, Map<String, Object?>>(
      serialize: ($value) => {
        r'message': $value.message,
        r'details': _i3.Serializers.instance.serialize<_i8.JsonValue?>(
          $value.details,
    ...
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i4.NotFoundException, Map<String, Object?>>(
      serialize: ($value) => {
        r'message': $value.message,
        r'details': _i3.Serializers.instance.serialize<_i8.JsonValue?>(
          $value.details,
    ...
    _i3.Serializers.instance.put(
        _i3.Serializer.define<_i4.OutOfRangeException, Map<String, Object?>>(
      serialize: ($value) => {
        r'message': $value.message,
        r'details': _i3.Serializers.instance.serialize<_i8.JsonValue?>(
          $value.details,
    ...
    _i3.Serializers.instance.put(
        _i3.Serializer.define<_i4.UnauthorizedException, Map<String, Object?>>(
      serialize: ($value) => {
        r'message': $value.message,
        r'details': _i3.Serializers.instance.serialize<_i8.JsonValue?>(
          $value.details,
    ...
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i4.UnavailableError, Map<String, Object?>>(
      serialize: ($value) => {
        r'message': $value.message,
        r'details': _i3.Serializers.instance.serialize<_i8.JsonValue?>(
          $value.details,
    ...
    _i3.Serializers.instance.put(
        _i3.Serializer.define<_i4.UnimplementedError, Map<String, Object?>?>(
      serialize: ($value) => {
        r'message': $value.message,
        r'details': _i3.Serializers.instance.serialize<_i8.JsonValue?>(
          $value.details,
    ...
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i4.UnknownError, Map<String, Object?>>(
      serialize: ($value) => {
        r'message': $value.message,
        r'details': _i3.Serializers.instance.serialize<_i8.JsonValue?>(
          $value.details,
