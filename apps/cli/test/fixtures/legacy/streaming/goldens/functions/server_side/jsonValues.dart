...
final class JsonValuesTarget extends _i1.CloudEventSourceTarget {
  ...
  Stream<Object?> handle(
    ...
    try {
      await for (final response in _i2.jsonValues()) {
        yield _i3.Serializers.instance.serialize<_i4.JsonValue>(
          response,
      ...
      final error = _i3.Serializers.instance.serialize<_i5.AbortedException>(e);
      yield {
        '@error': meta,
      ...
      final error =
          _i3.Serializers.instance.serialize<_i5.AlreadyExistsException>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<AssertionError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<_i7.AsyncError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error =
          _i3.Serializers.instance.serialize<_i5.CancelledException>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<_i5.DataLossError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error =
          _i3.Serializers.instance.serialize<_i5.DeadlineExceededError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<IndexError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error =
          _i3.Serializers.instance.serialize<IntegerDivisionByZeroException>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error =
          _i3.Serializers.instance.serialize<_i8.JsonUnsupportedObjectError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<OutOfMemoryError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error =
          _i3.Serializers.instance.serialize<_i5.OutOfRangeException>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error =
          _i3.Serializers.instance.serialize<_i5.PermissionDeniedException>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<RangeError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<ArgumentError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error =
          _i3.Serializers.instance.serialize<_i5.ResourceExhaustedException>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error =
          _i3.Serializers.instance.serialize<_i9.SerializationException>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<FormatException>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<StackOverflowError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<StateError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<_i7.TimeoutException>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<TypeError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<_i5.UnavailableError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error =
          _i3.Serializers.instance.serialize<_i5.UnimplementedError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<UnimplementedError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<_i5.UnknownError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<_i5.CloudException>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<UnsupportedError>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
      ...
      final error = _i3.Serializers.instance.serialize<Error>(e);
      yield {
        '@error': meta,
        ...error is Map<String, Object?> ? error : {'@': error},
      };
  ...
  void init() {
    ...
    _i3.Serializers.instance
      ...
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
        if (_i3.Serializers.instance.serialize<_i4.JsonValue?>(
          $value.details,
          const _i3.TypeToken<_i4.JsonValue?>('JsonValue'),
        )
            case final details?)
...
Future<void> start() async {
  await _i1.serve(targets: {'/': JsonValuesTarget()});
}
