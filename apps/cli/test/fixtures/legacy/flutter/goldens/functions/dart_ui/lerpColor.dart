...
final class LerpColorTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.lerpColor(
        _i4.Serializers.instance.deserialize<_i5.Color>(request[r'a']),
        _i4.Serializers.instance.deserialize<_i5.Color>(request[r'b']),
        (request[r't'] as num).toDouble(),
      );
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.Color>(response)),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': LerpColorTarget()});
}
