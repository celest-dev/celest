...
final class LerpColorTarget extends _i1.CloudFunctionTarget {
  ...
  Future<_i1.CelestResponse> handle(
    ...
    try {
      final response = await _i2.lerpColor(
        _i3.Serializers.instance.deserialize<_i4.Color>(request[r'a']),
        _i3.Serializers.instance.deserialize<_i4.Color>(request[r'b']),
  ...
  void init() {
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i4.Color, Map<String, Object?>>(
      serialize: ($value) => {r'value': $value.value},
      deserialize: ($serialized) {
        return _i4.Color(($serialized[r'value'] as num).toInt());
      },
    ));
