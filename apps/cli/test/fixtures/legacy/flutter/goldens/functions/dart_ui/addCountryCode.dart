...
import 'package:celest_backend/models/_overrides.dart' as _i7;
import 'package:celest_core/src/exception/cloud_exception.dart' as _i6;
import 'package:celest_core/src/exception/serialization_exception.dart' as _i5;

import '../../../functions/dart_ui.dart' as _i2;

final class AddCountryCodeTarget extends _i1.CloudFunctionTarget {
  @override
  ...
  void init() {
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i7.LocaleOverride, List<dynamic>>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return _i7.LocaleOverride.fromJson($serialized);
      },
    ));
