...
import 'package:celest_backend/src/functions/nonthrowing.dart' as _i2;
...
final class CallsThrowsBaseExceptionTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i1.CelestResponse> handle(
    ...
    try {
      ...
      final error = {
        ...
        'details': _i4.Serializers.instance.serialize<_i6.CustomError>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
    } on _i6.BaseError catch (e) {
      const statusCode = 500;
      print('$statusCode $e');
      final error = {
        'code': 'exceptions.v1.BaseError',
        'details': _i4.Serializers.instance.serialize<_i6.BaseError>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
      ...
      final error = {
        ...
        'details': _i4.Serializers.instance.serialize<_i6.CustomException>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
    } on _i6.BaseException catch (e) {
      const statusCode = 400;
      print('$statusCode $e');
      final error = {
        'code': 'exceptions.v1.BaseException',
        'details': _i4.Serializers.instance.serialize<_i6.BaseException>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i6.BaseError, Map<String, Object?>>(
      serialize: ($value) => {r'fault': $value.fault},
      deserialize: ($serialized) {
        return _i6.BaseError(($serialized[r'fault'] as String));
      },
    ));
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i6.BaseException, Map<String, Object?>>(
      serialize: ($value) => {r'fault': $value.fault},
      deserialize: ($serialized) {
        return _i6.BaseException(($serialized[r'fault'] as String));
      },
    ));
    _i4.Serializers.instance
      ...
      serialize: ($value) => {r'fault': $value.fault},
      deserialize: ($serialized) {
        return _i6.CustomError(($serialized[r'fault'] as String));
      },
    ));
    _i4.Serializers.instance
      ...
      serialize: ($value) => {r'fault': $value.fault},
      deserialize: ($serialized) {
        return _i6.CustomException(($serialized[r'fault'] as String));
      },
    ));
    _i4.Serializers.instance
      ...
      serialize: ($value) => {
        r'message': $value.message,
        r'details': _i4.Serializers.instance.serialize<_i9.JsonValue?>(
          $value.details,
          const _i4.TypeToken<_i9.JsonValue?>('JsonValue'),
        ),
      },
      deserialize: ($serialized) {
        return _i3.AbortedException(
          ($serialized[r'message'] as String?),
          details: _i4.Serializers.instance.deserialize<_i9.JsonValue?>(
    ...
    _i4.Serializers.instance.put(
        _i4.Serializer.define<_i8.SerializationException, Map<String, Object?>>(
      serialize: ($value) => {
        r'message': $value.message,
        r'offset': $value.offset,
        r'source': $value.source,
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.JsonValue, Object>(
