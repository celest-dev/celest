...
import 'package:celest_backend/src/functions/nonthrowing.dart' as _i3;
...
final class CallsThrowsBaseExceptionTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'callsThrowsBaseException';
...
Future<void> start() async {
  await _i1.serve(targets: {'/': CallsThrowsBaseExceptionTarget()});
}
