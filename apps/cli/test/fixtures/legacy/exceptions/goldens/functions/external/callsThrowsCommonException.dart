...
import 'package:celest_backend/src/functions/external.dart' as _i3;
...
final class CallsThrowsCommonExceptionTarget
  ...
  Future<_i2.Response> handle(
    ...
    try {
      _i3.callsThrowsCommonException();
      return _i2.Response(
        200,
    ...
    } on _i8.OverriddenException catch (e, st) {
      const statusCode = 400;
      _i6.context.logger.severe(
        e.message,
        e,
      ...
      final error =
          _i4.Serializers.instance.serialize<_i8.OverriddenException>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i8.OverriddenException, String>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return _i8.OverriddenException.fromJson($serialized);
      },
    ));
    _i4.Serializers.instance
