...
import 'package:celest_backend/src/functions/throwing.dart' as _i3;
...
final class ThrowsBaseExceptionTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'throwsBaseException';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      ...
      final error = _i4.Serializers.instance.serialize<_i8.BaseError>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
    ...
    } on _i8.BaseException catch (e, st) {
      const statusCode = 400;
      _i6.context.logger.severe(
        e.toString(),
        e,
      ...
      final error = _i4.Serializers.instance.serialize<_i8.BaseException>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i8.BaseError, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{r'fault': $value.fault},
      deserialize: ($serialized) {
        return _i8.BaseError(($serialized[r'fault'] as String));
      },
    ));
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i8.BaseException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{r'fault': $value.fault},
      deserialize: ($serialized) {
        return _i8.BaseException(($serialized[r'fault'] as String));
      },
    ));
    _i4.Serializers.instance
      ...
      serialize: ($value) => <String, Object?>{r'fault': $value.fault},
      deserialize: ($serialized) {
        return _i8.CustomError(($serialized[r'fault'] as String));
      },
    ));
    _i4.Serializers.instance
      ...
      serialize: ($value) => <String, Object?>{r'fault': $value.fault},
      deserialize: ($serialized) {
        return _i8.CustomException(($serialized[r'fault'] as String));
      },
    ));
    _i4.Serializers.instance
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ThrowsBaseExceptionTarget()});
}
