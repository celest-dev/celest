...
import 'package:celest_backend/src/functions/external.dart' as _i2;
...
final class CallsThrowsCustomExceptionTarget
  ...
  Future<_i1.CelestResponse> handle(
    ...
    try {
      ...
      final error = {
        ...
        'details': _i4.Serializers.instance.serialize<_i6.CommonException>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
      ...
      return (statusCode: statusCode, body: {'error': error});
    } on _i6.OverriddenException catch (e) {
      const statusCode = 400;
      print('$statusCode $e');
      final error = {
        'code': '_common.OverriddenException',
        'details':
            _i4.Serializers.instance.serialize<_i6.OverriddenException>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i6.CommonException, Map<String, Object?>>(
      serialize: ($value) => {r'message': $value.message},
      deserialize: ($serialized) {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i6.OverriddenException, String>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return _i6.OverriddenException.fromJson($serialized);
      },
    ));
    _i4.Serializers.instance
