...
final class CallsThrowsUserExceptionTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      _i3.callsThrowsUserException(
          cause: _i4.Serializers.instance.deserialize<_i5.JsonValue?>(
        request[r'cause'],
  ...
  void init() {
    ...
    _i4.Serializers.instance
      ...
      serialize: ($value) => <String, Object?>{
        r'error': _i4.Serializers.instance.serialize<_i5.JsonValue?>(
          $value.error,
          const _i4.TypeToken<_i5.JsonValue?>('JsonValue'),
        ),
        r'msg': _i4.Serializers.instance.serialize<_i5.JsonValue?>(
          $value.msg,
          const _i4.TypeToken<_i5.JsonValue?>('JsonValue'),
        ),
      },
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
      ...
      serialize: ($value) => <String, Object?>{
        r'msg': $value.msg,
        r'message': _i4.Serializers.instance.serialize<_i5.JsonValue?>(
          $value.message,
          const _i4.TypeToken<_i5.JsonValue?>('JsonValue'),
        ),
      },
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
      ...
      serialize: ($value) => <String, Object?>{
        r'msg': $value.msg,
        r'code': $value.code,
        r'cause': _i4.Serializers.instance.serialize<_i5.JsonValue?>(
          $value.cause,
          const _i4.TypeToken<_i5.JsonValue?>('JsonValue'),
        ),
      },
    ...
    _i4.Serializers.instance
      ...
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
        r'details': _i4.Serializers.instance.serialize<_i5.JsonValue?>(
          $value.details,
          const _i4.TypeToken<_i5.JsonValue?>('JsonValue'),
        ),
      },
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.JsonValue, Object>(
        serialize: ($value) => $value.value,
        deserialize: ($serialized) {
          return _i5.JsonValue($serialized);
        },
      ),
      const _i4.TypeToken<_i5.JsonValue?>('JsonValue'),
    );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': CallsThrowsUserExceptionTarget()});
}
