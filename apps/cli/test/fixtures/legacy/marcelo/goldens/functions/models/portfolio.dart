...
import 'package:_common/src/models/cash_balance.dart' as _i15;
import 'package:_common/src/models/errors_and_exceptions.dart' as _i12;
import 'package:_common/src/models/portfolio.dart' as _i5;
import 'package:_common/src/models/stock.dart' as _i17;
...
import 'package:fast_immutable_collections/src/ilist/ilist.dart' as _i16;
...
final class PortfolioTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.portfolio(_i4.Serializers.instance
          .deserialize<_i5.Portfolio>(request[r'portfolio']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.Portfolio>(response)),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance
      ...
      serialize: ($value) => <String, Object?>{
        r'error': _i4.Serializers.instance.serialize<_i13.JsonValue?>(
          $value.error,
          const _i4.TypeToken<_i13.JsonValue?>('JsonValue'),
        ),
        r'msg': _i4.Serializers.instance.serialize<_i13.JsonValue?>(
          $value.msg,
          const _i4.TypeToken<_i13.JsonValue?>('JsonValue'),
        ),
      },
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
      ...
      serialize: ($value) => <String, Object?>{
        r'msg': $value.msg,
        r'message': _i4.Serializers.instance.serialize<_i13.JsonValue?>(
          $value.message,
          const _i4.TypeToken<_i13.JsonValue?>('JsonValue'),
        ),
      },
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
      ...
      serialize: ($value) => <String, Object?>{
        r'msg': $value.msg,
        r'code': $value.code,
        r'cause': _i4.Serializers.instance.serialize<_i13.JsonValue?>(
          $value.cause,
          const _i4.TypeToken<_i13.JsonValue?>('JsonValue'),
        ),
      },
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i14.CashBalance, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{r'amount': $value.amount},
      deserialize: ($serialized) {
        return (_i15.CashBalance(($serialized[r'amount'] as num).toDouble())
            as _i14.CashBalance);
      },
    ));
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i14.Portfolio, Map<String, Object?>?>(
      serialize: ($value) => <String, Object?>{
        r'stocks': _i4.Serializers.instance
            .serialize<_i16.IList<_i17.Stock>>($value.stocks),
        r'cashBalance': _i4.Serializers.instance
            .serialize<_i15.CashBalance>($value.cashBalance),
        r'isEmpty': $value.isEmpty,
        r'totalCostBasis': $value.totalCostBasis,
      },
      deserialize: ($serialized) {
        return (_i5.Portfolio(
          stocks: ($serialized?[r'stocks'] as Iterable<Object?>?)
              ?.map(
                  (el) => _i4.Serializers.instance.deserialize<_i17.Stock>(el))
              .toList(),
          cashBalance: (_i4.Serializers.instance.deserialize<_i15.CashBalance?>(
                  $serialized?[r'cashBalance'])) ??
              _i15.CashBalance.ZERO,
        ) as _i14.Portfolio);
      },
    ));
    _i4.Serializers.instance
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i16.IList<_i17.Stock>, dynamic>(
      serialize: ($value) => $value.toJson(
          (value) => _i4.Serializers.instance.serialize<_i17.Stock>(value)),
      deserialize: ($serialized) {
        return _i16.IList<_i17.Stock>.fromJson(
          $serialized,
          (value) => _i4.Serializers.instance.deserialize<_i17.Stock>(value),
        );
      },
    ));
  }
