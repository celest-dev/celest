...
import 'package:_common/src/models/available_stock.dart' as _i5;
...
final class AvailableStockTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'availableStock';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.availableStock(_i4.Serializers.instance
          .deserialize<_i5.AvailableStock>(request[r'availableStock']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.AvailableStock>(response)),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i14.AvailableStock, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
...
Future<void> start() async {
  await _i1.serve(targets: {'/': AvailableStockTarget()});
}
