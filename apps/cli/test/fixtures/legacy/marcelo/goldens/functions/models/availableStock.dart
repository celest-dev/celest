...
final class AvailableStockTarget extends _i1.CloudFunctionTarget {
  @override
  ...
  Future<_i1.CelestResponse> handle(Map<String, Object?> request) async {
    try {
      final response = _i2.availableStock(_i3.Serializers.instance
          .deserialize<_i4.AvailableStock>(request[r'availableStock']));
      return (
        statusCode: 200,
        body: {
          'response':
