...
import 'package:_common/src/models/cash_balance.dart' as _i4;
...
final class CashBalanceTarget extends _i1.CloudFunctionTarget {
  @override
  ...
  Future<_i1.CelestResponse> handle(
    ...
    try {
      final response = _i2.cashBalance(_i3.Serializers.instance
          .deserialize<_i4.CashBalance>(request[r'cashBalance']));
      return (
        statusCode: 200,
        body: {
          'response':
              _i3.Serializers.instance.serialize<_i4.CashBalance>(response)
        }
      );
  ...
  void init() {
    ...
    _i3.Serializers.instance
      ...
      deserialize: ($serialized) {
        return (_i4.CashBalance(($serialized[r'amount'] as num).toDouble())
            as _i10.CashBalance);
      },
    ));
