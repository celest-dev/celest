...
import 'package:_common/src/models/ui.dart' as _i5;
...
final class UiTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response =
          _i3.ui(_i4.Serializers.instance.deserialize<_i5.Ui>(request[r'ui']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.Ui>(response)),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.ScreenChoice, String>(
      serialize: ($value) => $value.name,
      deserialize: ($serialized) {
        return _i5.ScreenChoice.values.byName($serialized);
      },
    ));
    _i4.Serializers.instance
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i14.Ui, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'isDarkMode': $value.isDarkMode,
        r'screenChoice': _i4.Serializers.instance
            .serialize<_i5.ScreenChoice>($value.screenChoice),
      },
      deserialize: ($serialized) {
        return (_i5.Ui(
          isDarkMode: ($serialized[r'isDarkMode'] as bool),
          screenChoice: (_i4.Serializers.instance
                  .deserialize<_i5.ScreenChoice?>(
                      $serialized[r'screenChoice'])) ??
              _i5.ScreenChoice.portfolioAndCashBalance,
        ) as _i14.Ui);
      },
    ));
    _i4.Serializers.instance
