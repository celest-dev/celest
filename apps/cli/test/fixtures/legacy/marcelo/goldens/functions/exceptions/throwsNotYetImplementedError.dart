...
import 'package:_common/src/models/errors_and_exceptions.dart' as _i11;
...
final class ThrowsNotYetImplementedErrorTarget
    extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'throwsNotYetImplementedError';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      _i3.throwsNotYetImplementedError();
      return _i2.Response(
        200,
      ...
      final error = _i4.Serializers.instance.serialize<_i7.AppError>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
    ...
    } on _i7.AppException catch (e, st) {
      ...
      final error = _i4.Serializers.instance.serialize<_i7.AppException>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
    ...
    } on _i7.NotYetImplementedError catch (e, st) {
      const statusCode = 500;
      _i6.context.logger.severe(
        e.toString(),
        e,
      ...
      final error =
          _i4.Serializers.instance.serialize<_i7.NotYetImplementedError>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
    ...
    } on _i7.UserException_ShowInConsole catch (e, st) {
      const statusCode = 400;
      _i6.context.logger.severe(
        e.toString(),
        e,
    ...
    } on _i11.UserException catch (e, st) {
      const statusCode = 400;
      _i6.context.logger.severe(
        e.toString(),
        e,
      ...
      final error = _i4.Serializers.instance.serialize<_i11.UserException>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
    ...
    } on _i11.ValidateError catch (e, st) {
      const statusCode = 500;
      _i6.context.logger.severe(
        e.toString(),
        e,
      ...
      final error = _i4.Serializers.instance.serialize<_i11.ValidateError>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i11.UserException, Map<String, dynamic>>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return _i11.UserException.fromJson($serialized);
      },
    ));
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i11.ValidateError, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{r'msg': $value.msg},
      deserialize: ($serialized) {
        return _i11.ValidateError(($serialized[r'msg'] as String));
      },
    ));
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i7.AppError, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i7.AppException, Map<String, Object?>?>(
      serialize: ($value) => <String, Object?>{
        r'error': _i4.Serializers.instance.serialize<_i12.JsonValue?>(
          $value.error,
          const _i4.TypeToken<_i12.JsonValue?>('JsonValue'),
        ),
        r'msg': _i4.Serializers.instance.serialize<_i12.JsonValue?>(
          $value.msg,
          const _i4.TypeToken<_i12.JsonValue?>('JsonValue'),
        ),
      },
      deserialize: ($serialized) {
        return (_i11.AppException(
          $serialized?[r'msg'],
          $serialized?[r'error'],
        ) as _i7.AppException);
      },
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
      ...
      serialize: ($value) => <String, Object?>{
        r'msg': $value.msg,
        r'message': _i4.Serializers.instance.serialize<_i12.JsonValue?>(
          $value.message,
          const _i4.TypeToken<_i12.JsonValue?>('JsonValue'),
        ),
      },
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
      ...
      serialize: ($value) => <String, Object?>{
        r'msg': $value.msg,
        r'code': $value.code,
        r'cause': _i4.Serializers.instance.serialize<_i12.JsonValue?>(
          $value.cause,
          const _i4.TypeToken<_i12.JsonValue?>('JsonValue'),
        ),
      },
      deserialize: ($serialized) {
        return _i7.UserException_ShowInConsole(
          ...
          cause: _i4.Serializers.instance.deserialize<_i12.JsonValue?>(
            $serialized[r'cause'],
            const _i4.TypeToken<_i12.JsonValue?>('JsonValue'),
          ),
        );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ThrowsNotYetImplementedErrorTarget()});
}
