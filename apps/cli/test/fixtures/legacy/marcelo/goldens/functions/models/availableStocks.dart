...
import 'package:_common/src/models/available_stock.dart' as _i14;
...
final class AvailableStocksTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.availableStocks(_i4.Serializers.instance
          .deserialize<_i5.AvailableStocks>(request[r'availableStocks']));
      return _i2.Response(
        200,
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.AvailableStocks, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'list': _i4.Serializers.instance
            .serialize<_i13.IList<_i14.AvailableStock>>($value.list)
      },
      deserialize: ($serialized) {
        return _i5.AvailableStocks(($serialized[r'list'] as Iterable<Object?>)
            .map((el) =>
                _i4.Serializers.instance.deserialize<_i14.AvailableStock>(el))
            .toList());
      },
    ));
    _i4.Serializers.instance
    ...
    _i4.Serializers.instance
      ...
      serialize: ($value) => <String, Object?>{
        r'error': _i4.Serializers.instance.serialize<_i15.JsonValue?>(
          $value.error,
          const _i4.TypeToken<_i15.JsonValue?>('JsonValue'),
        ),
        r'msg': _i4.Serializers.instance.serialize<_i15.JsonValue?>(
          $value.msg,
          const _i4.TypeToken<_i15.JsonValue?>('JsonValue'),
        ),
      },
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
      ...
      serialize: ($value) => <String, Object?>{
        r'msg': $value.msg,
        r'message': _i4.Serializers.instance.serialize<_i15.JsonValue?>(
          $value.message,
          const _i4.TypeToken<_i15.JsonValue?>('JsonValue'),
        ),
      },
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
      ...
      serialize: ($value) => <String, Object?>{
        r'msg': $value.msg,
        r'code': $value.code,
        r'cause': _i4.Serializers.instance.serialize<_i15.JsonValue?>(
          $value.cause,
          const _i4.TypeToken<_i15.JsonValue?>('JsonValue'),
        ),
      },
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i16.AvailableStock, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
    ...
    _i4.Serializers.instance
      ...
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
        r'details': _i4.Serializers.instance.serialize<_i15.JsonValue?>(
          $value.details,
          const _i4.TypeToken<_i15.JsonValue?>('JsonValue'),
        ),
      },
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i13.IList<_i14.AvailableStock>, dynamic>(
      serialize: ($value) => $value.toJson((value) =>
          _i4.Serializers.instance.serialize<_i14.AvailableStock>(value)),
      deserialize: ($serialized) {
        return _i13.IList<_i14.AvailableStock>.fromJson(
          $serialized,
          (value) =>
              _i4.Serializers.instance.deserialize<_i14.AvailableStock>(value),
        );
      },
    ));
  }
