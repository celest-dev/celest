...
import 'package:_common/src/models/available_stock.dart' as _i12;
...
final class AvailableStocksTarget extends _i1.CloudFunctionHttpTarget {
  ...
  void init() {
    ...
    _i3.Serializers.instance
      ...
      serialize: ($value) => {
        r'list': _i3.Serializers.instance
            .serialize<_i11.IList<_i12.AvailableStock>>($value.list)
      },
      deserialize: ($serialized) {
        return _i4.AvailableStocks(($serialized[r'list'] as Iterable<Object?>)
            .map((el) =>
                _i3.Serializers.instance.deserialize<_i12.AvailableStock>(el))
            .toList());
      },
    ));
    _i3.Serializers.instance
    ...
    _i3.Serializers.instance
      ...
      serialize: ($value) => {
        r'error': _i3.Serializers.instance.serialize<_i13.JsonValue?>(
          $value.error,
          const _i3.TypeToken<_i13.JsonValue?>('JsonValue'),
        ),
        r'msg': _i3.Serializers.instance.serialize<_i13.JsonValue?>(
          $value.msg,
          const _i3.TypeToken<_i13.JsonValue?>('JsonValue'),
        ),
      },
    ...
    _i3.Serializers.instance.put(_i3.Serializer.define<
      ...
      serialize: ($value) => {
        r'msg': $value.msg,
        r'message': _i3.Serializers.instance.serialize<_i13.JsonValue?>(
          $value.message,
          const _i3.TypeToken<_i13.JsonValue?>('JsonValue'),
        ),
      },
      deserialize: ($serialized) {
        return _i6.NotYetImplementedError(
            _i3.Serializers.instance.deserialize<_i13.JsonValue?>(
          $serialized?[r'message'],
          const _i3.TypeToken<_i13.JsonValue?>('JsonValue'),
        ));
      },
    ...
    _i3.Serializers.instance.put(_i3.Serializer.define<
      ...
      serialize: ($value) => {
        r'msg': $value.msg,
        r'code': $value.code,
        r'cause': _i3.Serializers.instance.serialize<_i13.JsonValue?>(
          $value.cause,
          const _i3.TypeToken<_i13.JsonValue?>('JsonValue'),
        ),
      },
      deserialize: ($serialized) {
        return _i6.UserException_ShowInConsole(
          ...
          cause: _i3.Serializers.instance.deserialize<_i13.JsonValue?>(
            $serialized[r'cause'],
            const _i3.TypeToken<_i13.JsonValue?>('JsonValue'),
          ),
        );
    ...
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i14.AvailableStock, Map<String, Object?>>(
      serialize: ($value) => {
    ...
    _i3.Serializers.instance
      ...
      serialize: ($value) => {
        r'message': $value.message,
        r'details': _i3.Serializers.instance.serialize<_i13.JsonValue?>(
          $value.details,
          const _i3.TypeToken<_i13.JsonValue?>('JsonValue'),
        ),
      },
      deserialize: ($serialized) {
        return _i5.AbortedException(
          ($serialized[r'message'] as String?),
          details: _i3.Serializers.instance.deserialize<_i13.JsonValue?>(
    ...
    _i3.Serializers.instance.put(
      _i3.Serializer.define<_i13.JsonValue, Object>(
    ...
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i11.IList<_i12.AvailableStock>, dynamic>(
      serialize: ($value) => $value.toJson((value) =>
          _i3.Serializers.instance.serialize<_i12.AvailableStock>(value)),
      deserialize: ($serialized) {
        return _i11.IList<_i12.AvailableStock>.fromJson(
          $serialized,
          (value) =>
              _i3.Serializers.instance.deserialize<_i12.AvailableStock>(value),
        );
      },
    ));
  }
