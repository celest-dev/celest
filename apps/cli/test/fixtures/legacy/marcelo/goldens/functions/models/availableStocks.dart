...
import 'package:_common/src/models/available_stock.dart' as _i15;
...
import 'package:celest_backend/models/overrides.dart' as _i17;
...
final class AvailableStocksTarget extends _i1.CloudFunctionHttpTarget {
  ...
  void init() {
    ...
    _i4.Serializers.instance
      ...
      serialize: ($value) => <String, Object?>{
        r'list': _i4.Serializers.instance
            .serialize<_i14.IList<_i15.AvailableStock>>($value.list)
      },
      deserialize: ($serialized) {
        return _i5.AvailableStocks(($serialized[r'list'] as Iterable<Object?>)
            .map((el) =>
                _i4.Serializers.instance.deserialize<_i15.AvailableStock>(el))
            .toList());
      },
    ));
    _i4.Serializers.instance
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
      ...
      deserialize: ($serialized) {
        return _i9.UserException_ShowInConsole(
          ...
          cause: _i4.Serializers.instance.deserialize<_i16.JsonValue?>(
            $serialized[r'cause'],
            const _i4.TypeToken<_i16.JsonValue?>('JsonValue'),
          ),
        );
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i17.AvailableStock, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
    ...
    _i4.Serializers.instance
      ...
      deserialize: ($serialized) {
        return _i6.AbortedException(
          ...
          details: _i4.Serializers.instance.deserialize<_i16.JsonValue?>(
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i14.IList<_i15.AvailableStock>, dynamic>(
      serialize: ($value) => $value.toJson((value) =>
          _i4.Serializers.instance.serialize<_i15.AvailableStock>(value)),
      deserialize: ($serialized) {
        return _i14.IList<_i15.AvailableStock>.fromJson(
          $serialized,
          (value) =>
              _i4.Serializers.instance.deserialize<_i15.AvailableStock>(value),
        );
      },
    ));
  }
