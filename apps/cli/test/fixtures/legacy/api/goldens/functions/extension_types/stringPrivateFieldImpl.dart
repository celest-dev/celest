...
final class StringPrivateFieldImplTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.stringPrivateFieldImpl(
          _i4.Serializers.instance.deserialize<_i5.StringXPrivateFieldImpl>(
        request[r's'],
        const _i4.TypeToken<_i5.StringXPrivateFieldImpl>(
      ...
      return _i2.Response(
        ...
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.StringXPrivateFieldImpl>(
          response,
          const _i4.TypeToken<_i5.StringXPrivateFieldImpl>(
              'StringXPrivateFieldImpl'),
        )),
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.StringXPrivateFieldImpl, String>(
        serialize: ($value) => $value,
        deserialize: ($serialized) {
          return _i5.StringXPrivateFieldImpl(($serialized as String));
        },
      ),
      const _i4.TypeToken<_i5.StringXPrivateFieldImpl>(
          'StringXPrivateFieldImpl'),
...
Future<void> start() async {
  await _i1.serve(targets: {'/': StringPrivateFieldImplTarget()});
}
