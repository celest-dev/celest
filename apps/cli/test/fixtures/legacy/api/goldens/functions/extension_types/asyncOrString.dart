...
final class AsyncOrStringTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'asyncOrString';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3
          .asyncOrString(_i4.Serializers.instance.deserialize<_i5.StringX>(
        request[r's'],
        const _i4.TypeToken<_i5.StringX>('StringX'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body:
            _i4.JsonUtf8.encode(_i4.Serializers.instance.serialize<_i5.StringX>(
          response,
          const _i4.TypeToken<_i5.StringX>('StringX'),
        )),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.StringX, String>(
        serialize: ($value) => $value.s,
        deserialize: ($serialized) {
          return _i5.StringX(($serialized as String));
        },
      ),
      const _i4.TypeToken<_i5.StringX>('StringX'),
    );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': AsyncOrStringTarget()});
}
