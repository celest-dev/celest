...
final class ValueXToFromJsonTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.valueXToFromJson(
          _i4.Serializers.instance.deserialize<_i5.ValueXToFromJson>(
        request[r'v'],
        const _i4.TypeToken<_i5.ValueXToFromJson>('ValueXToFromJson'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.ValueXToFromJson>(
          response,
          const _i4.TypeToken<_i5.ValueXToFromJson>('ValueXToFromJson'),
        )),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ValueXToFromJsonTarget()});
}

final class ValueXToFromJsonSerializer
    extends _i4.Serializer<_i5.ValueXToFromJson> {
  ValueXToFromJsonSerializer() {
  ...
  @override
  _i5.ValueXToFromJson deserialize(Object? $value) {
    final $serialized = assertWireType<String>($value);
    return _i5.ValueXToFromJson.fromJson($serialized);
  }

  @override
  Object? serialize(_i5.ValueXToFromJson $value) => $value.toJson();
}
