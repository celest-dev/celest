...
final class ColorXImplTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response =
          _i3.colorXImpl(_i4.Serializers.instance.deserialize<_i5.ColorXImpl>(
        request[r'color'],
        const _i4.TypeToken<_i5.ColorXImpl>('ColorXImpl'),
      ));
      return _i2.Response(
        200,
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ColorXImplTarget()});
}

final class ColorXImplSerializer extends _i4.Serializer<_i5.ColorXImpl> {
  ColorXImplSerializer() {
  ...
  @override
  _i5.ColorXImpl deserialize(Object? $value) {
    final $serialized = assertWireType<String>($value);
    return _i5.ColorXImpl($serializers.deserialize<_i5.Color>($serialized));
  }

  @override
  Object? serialize(_i5.ColorXImpl $value) =>
      $serializers.serialize<_i5.Color>($value);
}
