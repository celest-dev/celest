...
final class JsonBoolTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response =
          _i3.jsonBool(_i4.Serializers.instance.deserialize<_i5.JsonBool>(
        request[r'value'],
        const _i4.TypeToken<_i5.JsonBool>('JsonBool'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.JsonBool>(
          response,
          const _i4.TypeToken<_i5.JsonBool>('JsonBool'),
        )),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.JsonBool, bool>(
        serialize: ($value) => $value,
        deserialize: ($serialized) {
          return _i5.JsonBool(($serialized as bool));
        },
      ),
      const _i4.TypeToken<_i5.JsonBool>('JsonBool'),
    );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': JsonBoolTarget()});
}
