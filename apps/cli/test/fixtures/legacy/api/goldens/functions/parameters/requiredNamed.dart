...
import 'package:celest_backend/src/functions/parameters.dart' as _i3;
...
final class RequiredNamedTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'requiredNamed';
...
Future<void> start() async {
  await _i1.serve(targets: {'/': RequiredNamedTarget()});
}
