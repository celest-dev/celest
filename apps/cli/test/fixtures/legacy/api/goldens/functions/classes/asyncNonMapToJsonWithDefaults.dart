...
final class AsyncNonMapToJsonWithDefaultsTarget
  ...
  @override
  String get name => 'asyncNonMapToJsonWithDefaults';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.asyncNonMapToJsonWithDefaults(_i4
...
Future<void> start() async {
  await _i1.serve(targets: {'/': AsyncNonMapToJsonWithDefaultsTarget()});
}
