...
final class StringPrivateCtorImplTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.stringPrivateCtorImpl(
          _i4.Serializers.instance.deserialize<_i5.StringXPrivateCtorImpl>(
        request[r's'],
        const _i4.TypeToken<_i5.StringXPrivateCtorImpl>(
      ...
      return _i2.Response(
        ...
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.StringXPrivateCtorImpl>(
          response,
          const _i4.TypeToken<_i5.StringXPrivateCtorImpl>(
              'StringXPrivateCtorImpl'),
        )),
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.StringXPrivateCtorImpl, String?>(
        serialize: ($value) => $value,
        deserialize: ($serialized) {
          return (($serialized as String) as _i5.StringXPrivateCtorImpl);
        },
      ),
      const _i4.TypeToken<_i5.StringXPrivateCtorImpl>('StringXPrivateCtorImpl'),
    );
    _i4.Serializers.instance
...
Future<void> start() async {
  await _i1.serve(targets: {'/': StringPrivateCtorImplTarget()});
}
