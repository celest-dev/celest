...
import 'package:celest_backend/src/functions/asserts.dart' as _i3;
...
final class AssertsEnabledTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.assertsEnabled();
      return _i2.Response(
        200,
...
Future<void> start() async {
  await _i1.serve(targets: {'/': AssertsEnabledTarget()});
}
