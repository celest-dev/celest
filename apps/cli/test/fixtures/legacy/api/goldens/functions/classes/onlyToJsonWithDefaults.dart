...
final class OnlyToJsonWithDefaultsTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.onlyToJsonWithDefaults(_i4.Serializers.instance
          .deserialize<_i5.OnlyToJsonWithDefaults>(request[r'value']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(_i4.Serializers.instance
            .serialize<_i5.OnlyToJsonWithDefaults>(response)),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i5.OnlyToJsonWithDefaults, Map<String, Object?>?>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return _i5.OnlyToJsonWithDefaults(
...
Future<void> start() async {
  await _i1.serve(targets: {'/': OnlyToJsonWithDefaultsTarget()});
}
