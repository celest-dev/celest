...
final class AsyncOrSimpleClassReturnNullableTarget
  ...
  @override
  String get name => 'asyncOrSimpleClassReturnNullable';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.asyncOrSimpleClassReturnNullable();
      return _i2.Response(
        200,
...
Future<void> start() async {
  await _i1.serve(targets: {'/': AsyncOrSimpleClassReturnNullableTarget()});
}
