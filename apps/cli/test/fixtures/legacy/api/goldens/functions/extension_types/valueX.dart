...
final class ValueXTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response =
          _i3.valueX(_i4.Serializers.instance.deserialize<_i5.ValueX>(
        request[r'v'],
        const _i4.TypeToken<_i5.ValueX>('ValueX'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body:
            _i4.JsonUtf8.encode(_i4.Serializers.instance.serialize<_i5.ValueX>(
          response,
          const _i4.TypeToken<_i5.ValueX>('ValueX'),
        )),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ValueXTarget()});
}

final class ValueXSerializer extends _i4.Serializer<_i5.ValueX> {
  ValueXSerializer() {
  ...
  @override
  _i5.ValueX deserialize(Object? $value) {
    final $serialized = assertWireType<Map<String, Object?>>($value);
    return _i5.ValueX($serializers.deserialize<_i5.Value>($serialized));
  }

  @override
  Object? serialize(_i5.ValueX $value) =>
