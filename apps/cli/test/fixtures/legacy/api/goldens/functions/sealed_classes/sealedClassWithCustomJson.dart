...
final class SealedClassWithCustomJsonTarget
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.sealedClassWithCustomJson(
          shapes: (request[r'shapes'] as Iterable<Object?>)
              .map((el) => _i4.Serializers.instance
                  .deserialize<_i5.ShapeWithCustomJson>(el))
              .toList());
      return _i2.Response(
        200,
        ...
        body: _i4.JsonUtf8.encode(response
            .map((el) =>
                _i4.Serializers.instance.serialize<_i5.ShapeWithCustomJson>(el))
            .toList()),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
        _i4.Serializer.define<_i5.CircleWithCustomJson, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return _i5.CircleWithCustomJson.fromJson($serialized);
      },
    ));
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i5.RectangleWithCustomJson, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return _i5.RectangleWithCustomJson.fromJson($serialized);
      },
    ));
    _i4.Serializers.instance.put(
        _i4.Serializer.define<_i5.ShapeWithCustomJson, Map<String, Object?>>(
      serialize: ($value) {
        if ($value is _i5.CircleWithCustomJson) {
          return {
            ...(_i4.Serializers.instance
                    .serialize<_i5.CircleWithCustomJson>($value)
                as Map<String, Object?>),
            r'$type': r'CircleWithCustomJson',
          };
        }
        if ($value is _i5.RectangleWithCustomJson) {
          return {
            ...(_i4.Serializers.instance
                    .serialize<_i5.RectangleWithCustomJson>($value)
                as Map<String, Object?>),
      ...
      deserialize: ($serialized) {
        if ($serialized[r'$type'] == r'CircleWithCustomJson') {
          return _i4.Serializers.instance
              .deserialize<_i5.CircleWithCustomJson>($serialized);
        }
        if ($serialized[r'$type'] == r'RectangleWithCustomJson') {
          return _i4.Serializers.instance
              .deserialize<_i5.RectangleWithCustomJson>($serialized);
        }
        throw _i4.SerializationException((StringBuffer('Unknown subtype of ')
              ..write(r'ShapeWithCustomJson')
              ..write(': ')
...
Future<void> start() async {
  await _i1.serve(targets: {'/': SealedClassWithCustomJsonTarget()});
}
