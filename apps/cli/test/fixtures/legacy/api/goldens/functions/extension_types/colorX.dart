...
final class ColorXTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response =
          _i3.colorX(_i4.Serializers.instance.deserialize<_i5.ColorX>(
        request[r'color'],
        const _i4.TypeToken<_i5.ColorX>('ColorX'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body:
            _i4.JsonUtf8.encode(_i4.Serializers.instance.serialize<_i5.ColorX>(
          response,
          const _i4.TypeToken<_i5.ColorX>('ColorX'),
        )),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ColorXTarget()});
}

final class ColorXSerializer extends _i4.Serializer<_i5.ColorX> {
  ColorXSerializer() {
  ...
  @override
  _i5.ColorX deserialize(Object? $value) {
    final $serialized = assertWireType<String>($value);
    return _i5.ColorX($serializers.deserialize<_i5.Color>($serialized));
  }

  @override
  Object? serialize(_i5.ColorX $value) =>
