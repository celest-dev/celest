...
final class NullableNamedDefaultValueVarsPrivateTarget
  ...
  @override
  String get name => 'nullableNamedDefaultValueVarsPrivate';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      _i3.nullableNamedDefaultValueVarsPrivate(
...
Future<void> start() async {
  await _i1.serve(targets: {'/': NullableNamedDefaultValueVarsPrivateTarget()});
}
