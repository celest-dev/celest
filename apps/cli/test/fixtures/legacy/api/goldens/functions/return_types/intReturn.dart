...
final class IntReturnTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'intReturn';
...
Future<void> start() async {
  await _i1.serve(targets: {'/': IntReturnTarget()});
}
