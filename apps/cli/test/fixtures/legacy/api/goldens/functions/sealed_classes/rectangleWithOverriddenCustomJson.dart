...
final class RectangleWithOverriddenCustomJsonTarget
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.rectangleWithOverriddenCustomJson(_i4
      ...
      return _i2.Response(
        ...
        body: _i4.JsonUtf8.encode(_i4.Serializers.instance
            .serialize<_i5.ShapeWithOverriddenCustomJson>(response)),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': RectangleWithOverriddenCustomJsonTarget()});
}
