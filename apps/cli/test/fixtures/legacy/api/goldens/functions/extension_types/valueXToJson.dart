...
final class ValueXToJsonTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'valueXToJson';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3
          .valueXToJson(_i4.Serializers.instance.deserialize<_i5.ValueXToJson>(
        request[r'v'],
        const _i4.TypeToken<_i5.ValueXToJson>('ValueXToJson'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.ValueXToJson>(
          response,
          const _i4.TypeToken<_i5.ValueXToJson>('ValueXToJson'),
        )),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ValueXToJsonTarget()});
}

final class ValueXToJsonSerializer extends _i4.Serializer<_i5.ValueXToJson> {
  ValueXToJsonSerializer() {
    $serializers.put(_i4.Serializer.define<_i5.Value, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{r'value': $value.value},
      deserialize: ($serialized) {
        return _i5.Value(($serialized[r'value'] as String));
      },
    ));
  }
  ...
  @override
  _i5.ValueXToJson deserialize(Object? $value) {
    final $serialized = assertWireType<Map<String, Object?>>($value);
    return _i5.ValueXToJson($serializers.deserialize<_i5.Value>($serialized));
  }

  @override
  Object? serialize(_i5.ValueXToJson $value) => $value.toJson();
}
