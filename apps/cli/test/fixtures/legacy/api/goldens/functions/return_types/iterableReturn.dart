...
final class IterableReturnTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'iterableReturn';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.iterableReturn();
      return _i2.Response(
        200,
...
Future<void> start() async {
  await _i1.serve(targets: {'/': IterableReturnTarget()});
}
