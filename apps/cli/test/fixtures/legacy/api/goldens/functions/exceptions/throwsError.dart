...
final class ThrowsErrorTarget extends _i1.CloudFunctionHttpTarget {
    ...
    try {
      _i3.throwsError(
          type: _i4.Serializers.instance
              .deserialize<_i5.SupportedErrorType>(request[r'type']));
      return _i2.Response(
        200,
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.SupportedErrorType, String>(
      serialize: ($value) => $value.name,
      deserialize: ($serialized) {
        return _i5.SupportedErrorType.values.byName($serialized);
      },
    ));
    _i4.Serializers.instance
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ThrowsErrorTarget()});
}
