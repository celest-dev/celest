...
final class StringToFromJsonTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.stringToFromJson(
          _i4.Serializers.instance.deserialize<_i5.StringXToFromJson>(
        request[r's'],
        const _i4.TypeToken<_i5.StringXToFromJson>('StringXToFromJson'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.StringXToFromJson>(
          response,
          const _i4.TypeToken<_i5.StringXToFromJson>('StringXToFromJson'),
        )),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.StringXToFromJson, String>(
        serialize: ($value) => $value.toJson(),
        deserialize: ($serialized) {
          return _i5.StringXToFromJson.fromJson($serialized);
        },
      ),
      const _i4.TypeToken<_i5.StringXToFromJson>('StringXToFromJson'),
    );
