...
final class ColorXFromJsonImplTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.colorXFromJsonImpl(
          _i4.Serializers.instance.deserialize<_i5.ColorXFromJsonImpl>(
        request[r'color'],
        const _i4.TypeToken<_i5.ColorXFromJsonImpl>('ColorXFromJsonImpl'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.ColorXFromJsonImpl>(
          response,
          const _i4.TypeToken<_i5.ColorXFromJsonImpl>('ColorXFromJsonImpl'),
        )),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ColorXFromJsonImplTarget()});
}

final class ColorXFromJsonImplSerializer
    extends _i4.Serializer<_i5.ColorXFromJsonImpl> {
  ColorXFromJsonImplSerializer() {
  ...
  @override
  _i5.ColorXFromJsonImpl deserialize(Object? $value) {
    final $serialized = assertWireType<String>($value);
    return _i5.ColorXFromJsonImpl.fromJson($serialized);
  }

  @override
  Object? serialize(_i5.ColorXFromJsonImpl $value) => $value.toJson();
}
