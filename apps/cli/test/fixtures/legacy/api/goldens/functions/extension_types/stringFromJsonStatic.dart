...
final class StringFromJsonStaticTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.stringFromJsonStatic(
          _i4.Serializers.instance.deserialize<_i5.StringXFromJsonStatic>(
        request[r's'],
        const _i4.TypeToken<_i5.StringXFromJsonStatic>('StringXFromJsonStatic'),
      ));
      return _i2.Response(
        200,
        ...
        body: _i4.JsonUtf8.encode(
          ...
          response,
          const _i4.TypeToken<_i5.StringXFromJsonStatic>(
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.StringXFromJsonStatic, String>(
        serialize: ($value) => $value.s,
        deserialize: ($serialized) {
          return _i5.StringXFromJsonStatic.fromJson($serialized);
        },
      ),
      const _i4.TypeToken<_i5.StringXFromJsonStatic>('StringXFromJsonStatic'),
    );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': StringFromJsonStaticTarget()});
}
