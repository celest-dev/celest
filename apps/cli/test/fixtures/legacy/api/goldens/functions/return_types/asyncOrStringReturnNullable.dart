...
final class AsyncOrStringReturnNullableTarget extends _i1.CloudFunctionTarget {
  @override
  String get name => 'asyncOrStringReturnNullable';
  ...
  Future<_i1.CelestResponse> handle(
    ...
    try {
      final response = await _i2.asyncOrStringReturnNullable();
...
Future<void> start() async {
  await _i1.serve(targets: {'/': AsyncOrStringReturnNullableTarget()});
}
