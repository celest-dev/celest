...
final class GenericResultTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    final $types = ($T,);
    return switch ($types) {
      (r'Shape' || null,) => innerHandle<_i3.Shape>(
          request,
          headers: headers,
          queryParameters: queryParameters,
        ),
      (r'Circle',) => innerHandle<_i3.Circle>(
          request,
          headers: headers,
          queryParameters: queryParameters,
        ),
      (r'Rectangle',) => innerHandle<_i3.Rectangle>(
          request,
          headers: headers,
          queryParameters: queryParameters,
        ),
  ...
  Future<_i2.Response> innerHandle<T extends _i3.Shape>(
    Map<String, Object?> request, {
    required Map<String, List<String>> headers,
    required Map<String, List<String>> queryParameters,
  }) async {
    try {
      final response = _i5.genericResult<T>(
          _i4.Serializers.instance.deserialize<T>(request[r'data']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i3.OkResult<T>>(response)),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i10.CustomError, Map<String, Object?>?>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
        r'additionalInfo': _i4.Serializers.instance.serialize<_i13.JsonMap>(
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i10.CustomErrorWithStackTrace, Map<String, Object?>?>(
      serialize: ($value) => <String, Object?>{
        r'stackTrace':
            _i4.Serializers.instance.serialize<StackTrace>($value.stackTrace),
        r'message': $value.message,
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i10.CustomExceptionToFromJson, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i3.Circle, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
    ...
    _i4.Serializers.instance.put(const OkResult_T_ShapeSerializer<_i3.Shape>());
    _i4.Serializers.instance
        .put(const OkResult_T_ShapeSerializer<_i3.Circle>());
    _i4.Serializers.instance
        .put(const OkResult_T_ShapeSerializer<_i3.Rectangle>());
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i3.Rectangle, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'width': $value.width,
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i3.Shape, Map<String, Object?>>(
      serialize: ($value) {
        if ($value is _i3.Circle) {
          return {
            ...(_i4.Serializers.instance.serialize<_i3.Circle>($value)
        ...
        if ($value is _i3.Rectangle) {
          return {
            ...(_i4.Serializers.instance.serialize<_i3.Rectangle>($value)
                as Map<String, Object?>),
            r'$type': r'Rectangle',
          };
        }
      ...
      deserialize: ($serialized) {
        if ($serialized[r'$type'] == r'Circle') {
          return _i4.Serializers.instance.deserialize<_i3.Circle>($serialized);
        }
...
Future<void> start() async {
  await _i1.serve(targets: {'/': GenericResultTarget()});
}

final class OkResult_T_ShapeSerializer<T extends _i3.Shape>
    extends _i4.Serializer<_i3.OkResult<T>> {
