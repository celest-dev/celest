...
final class ValueXImplTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response =
          _i3.valueXImpl(_i4.Serializers.instance.deserialize<_i5.ValueXImpl>(
        request[r'v'],
        const _i4.TypeToken<_i5.ValueXImpl>('ValueXImpl'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.ValueXImpl>(
          response,
          const _i4.TypeToken<_i5.ValueXImpl>('ValueXImpl'),
        )),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ValueXImplTarget()});
}

final class ValueXImplSerializer extends _i4.Serializer<_i5.ValueXImpl> {
  ValueXImplSerializer() {
  ...
  @override
  _i5.ValueXImpl deserialize(Object? $value) {
    final $serialized = assertWireType<Map<String, Object?>>($value);
    return _i5.ValueXImpl($serializers.deserialize<_i5.Value>($serialized));
  }

  @override
  Object? serialize(_i5.ValueXImpl $value) =>
      $serializers.serialize<_i5.Value>($value);
}
