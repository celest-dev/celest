...
final class ColorXToFromJsonTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.colorXToFromJson(
          _i4.Serializers.instance.deserialize<_i5.ColorXToFromJson>(
        request[r'color'],
        const _i4.TypeToken<_i5.ColorXToFromJson>('ColorXToFromJson'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.ColorXToFromJson>(
          response,
          const _i4.TypeToken<_i5.ColorXToFromJson>('ColorXToFromJson'),
        )),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ColorXToFromJsonTarget()});
}

final class ColorXToFromJsonSerializer
    extends _i4.Serializer<_i5.ColorXToFromJson> {
  ColorXToFromJsonSerializer() {
  ...
  @override
  _i5.ColorXToFromJson deserialize(Object? $value) {
    final $serialized = assertWireType<String>($value);
    return _i5.ColorXToFromJson.fromJson($serialized);
  }

  @override
  Object? serialize(_i5.ColorXToFromJson $value) => $value.toJson();
}
