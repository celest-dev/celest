...
final class OkShapeResultsTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.okShapeResults(
      ...
      return _i2.Response(
        ...
        body: _i4.JsonUtf8.encode(response
            .map((el) =>
                _i4.Serializers.instance.serialize<_i5.OkResult<_i5.Shape>>(el))
            .toList()),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': OkShapeResultsTarget()});
}
