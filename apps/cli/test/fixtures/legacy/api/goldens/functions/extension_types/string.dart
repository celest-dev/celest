...
final class StringTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response =
          _i3.string(_i4.Serializers.instance.deserialize<_i5.StringX>(
        request[r's'],
...
Future<void> start() async {
  await _i1.serve(targets: {'/': StringTarget()});
}
