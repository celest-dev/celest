...
final class AsyncNullableFieldsTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.asyncNullableFields(
...
Future<void> start() async {
  await _i1.serve(targets: {'/': AsyncNullableFieldsTarget()});
}
