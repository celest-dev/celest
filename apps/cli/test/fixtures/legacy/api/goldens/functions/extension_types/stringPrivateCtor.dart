...
final class StringPrivateCtorTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.stringPrivateCtor(
          _i4.Serializers.instance.deserialize<_i5.StringXPrivateCtor>(
        request[r's'],
        const _i4.TypeToken<_i5.StringXPrivateCtor>('StringXPrivateCtor'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.StringXPrivateCtor>(
          response,
          const _i4.TypeToken<_i5.StringXPrivateCtor>('StringXPrivateCtor'),
        )),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.StringXPrivateCtor, String?>(
        serialize: ($value) => $value.s,
        deserialize: ($serialized) {
          return (($serialized as String) as _i5.StringXPrivateCtor);
        },
      ),
      const _i4.TypeToken<_i5.StringXPrivateCtor>('StringXPrivateCtor'),
    );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': StringPrivateCtorTarget()});
}
