...
final class AsyncNestedTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.asyncNested(
          _i4.Serializers.instance.deserialize<_i5.Nested>(request[r'value']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.Nested>(response)),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.Nested, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
...
Future<void> start() async {
  await _i1.serve(targets: {'/': AsyncNestedTarget()});
}
