...
final class JsonNumTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response =
          _i3.jsonNum(_i4.Serializers.instance.deserialize<_i5.JsonNum>(
        request[r'value'],
        const _i4.TypeToken<_i5.JsonNum>('JsonNum'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body:
            _i4.JsonUtf8.encode(_i4.Serializers.instance.serialize<_i5.JsonNum>(
          response,
          const _i4.TypeToken<_i5.JsonNum>('JsonNum'),
        )),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.JsonNum, num>(
        serialize: ($value) => $value,
        deserialize: ($serialized) {
          return _i5.JsonNum(($serialized as num));
        },
      ),
      const _i4.TypeToken<_i5.JsonNum>('JsonNum'),
    );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': JsonNumTarget()});
}
