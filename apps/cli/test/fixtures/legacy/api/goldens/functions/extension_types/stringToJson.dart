...
final class StringToJsonTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3
          .stringToJson(_i4.Serializers.instance.deserialize<_i5.StringXToJson>(
        request[r's'],
        const _i4.TypeToken<_i5.StringXToJson>('StringXToJson'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.StringXToJson>(
          response,
          const _i4.TypeToken<_i5.StringXToJson>('StringXToJson'),
        )),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.StringXToJson, String>(
        serialize: ($value) => $value.toJson(),
        deserialize: ($serialized) {
          return _i5.StringXToJson(($serialized as String));
        },
      ),
      const _i4.TypeToken<_i5.StringXToJson>('StringXToJson'),
    );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': StringToJsonTarget()});
}
