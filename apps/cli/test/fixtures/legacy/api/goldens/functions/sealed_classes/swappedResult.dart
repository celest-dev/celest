...
final class SwappedResultTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.swappedResult(_i4.Serializers.instance
          .deserialize<_i5.Result<_i5.Shape, String>>(request[r'result']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(_i4.Serializers.instance
            .serialize<_i5.SwappedResult<_i5.Shape, String>>(response)),
      );
