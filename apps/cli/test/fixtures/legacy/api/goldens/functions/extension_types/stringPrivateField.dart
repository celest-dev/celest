...
final class StringPrivateFieldTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.stringPrivateField(
          _i4.Serializers.instance.deserialize<_i5.StringXPrivateField>(
        request[r's'],
        const _i4.TypeToken<_i5.StringXPrivateField>('StringXPrivateField'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.StringXPrivateField>(
          response,
          const _i4.TypeToken<_i5.StringXPrivateField>('StringXPrivateField'),
        )),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.StringXPrivateField, String>(
        serialize: ($value) => ($value as String),
        deserialize: ($serialized) {
          return _i5.StringXPrivateField(($serialized as String));
        },
      ),
      const _i4.TypeToken<_i5.StringXPrivateField>('StringXPrivateField'),
    );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': StringPrivateFieldTarget()});
}
