...
final class SelfReferencingTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.selfReferencing(_i4.Serializers.instance
          .deserialize<_i5.SelfReferencing>(request[r'selfReferencing']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.SelfReferencing>(response)),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.SelfReferencing, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'value': _i4.Serializers.instance
            .serialize<_i5.SelfReferencing?>($value.value),
        r'wrapper': _i4.Serializers.instance
            .serialize<_i5.SelfReferencingWrapper?>($value.wrapper),
        r'list': $value.list
            .map((el) =>
                _i4.Serializers.instance.serialize<_i5.SelfReferencing>(el))
            .toList(),
      },
      deserialize: ($serialized) {
        return _i5.SelfReferencing(
          value: _i4.Serializers.instance
              .deserialize<_i5.SelfReferencing?>($serialized[r'value']),
          wrapper: _i4.Serializers.instance
              .deserialize<_i5.SelfReferencingWrapper?>(
                  $serialized[r'wrapper']),
          list: ($serialized[r'list'] as Iterable<Object?>)
              .map((el) =>
                  _i4.Serializers.instance.deserialize<_i5.SelfReferencing>(el))
              .toList(),
        );
      },
    ));
    _i4.Serializers.instance.put(
        _i4.Serializer.define<_i5.SelfReferencingWrapper, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'value': _i4.Serializers.instance
            .serialize<_i5.SelfReferencing>($value.value)
      },
      deserialize: ($serialized) {
        return _i5.SelfReferencingWrapper(
            value: _i4.Serializers.instance
                .deserialize<_i5.SelfReferencing>($serialized[r'value']));
      },
    ));
...
Future<void> start() async {
  await _i1.serve(targets: {'/': SelfReferencingTarget()});
}
