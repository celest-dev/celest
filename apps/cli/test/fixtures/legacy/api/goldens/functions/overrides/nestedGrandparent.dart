...
import 'package:_common/_common.dart' as _i7;
...
final class NestedGrandparentTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i1.CelestResponse> handle(
    ...
    try {
      ...
      return (statusCode: statusCode, body: {'error': error});
    } on _i7.CommonException catch (e) {
      const statusCode = 400;
      print('$statusCode $e');
      final error = {
        'code': '_common.CommonException',
        'details': _i3.Serializers.instance.serialize<_i7.CommonException>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
      ...
      final error = {
        ...
        'details': _i3.Serializers.instance.serialize<_i7.CustomException>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
      ...
      return (statusCode: statusCode, body: {'error': error});
    } on _i9.OverriddenException catch (e) {
      const statusCode = 400;
      print('$statusCode $e');
      final error = {
        'code': 'api.v1.OverriddenException',
        'details':
            _i3.Serializers.instance.serialize<_i9.OverriddenException>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
  ...
  void init() {
    ...
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i7.CommonException, Map<String, Object?>>(
      serialize: ($value) => {r'message': $value.message},
      deserialize: ($serialized) {
        return _i7.CommonException(($serialized[r'message'] as String));
      },
    ));
    _i3.Serializers.instance
      ...
      serialize: ($value) => {r'message': $value.message},
      deserialize: ($serialized) {
        return _i7.CustomException(($serialized[r'message'] as String));
      },
    ));
    _i3.Serializers.instance.put(
        _i3.Serializer.define<_i9.OverriddenException, Map<String, Object?>>(
      serialize: ($value) => {r'message': $value.message},
      deserialize: ($serialized) {
        return (_i7.OverriddenException(($serialized[r'message'] as String))
            as _i9.OverriddenException);
      },
    ));
    _i3.Serializers.instance
    ...
    _i3.Serializers.instance
      ...
      serialize: ($value) => {
        r'parent':
            _i3.Serializers.instance.serialize<_i7.NestedParent>($value.parent)
      },
      deserialize: ($serialized) {
        return _i4.NestedGrandparent(_i3.Serializers.instance
            .deserialize<_i7.NestedParent>($serialized[r'parent']));
      },
    ));
    _i3.Serializers.instance
      ...
      serialize: ($value) => {
        r'child':
            _i3.Serializers.instance.serialize<_i7.NestedChild>($value.child)
      },
      deserialize: ($serialized) {
        return (_i7.NestedParent(_i3.Serializers.instance
                .deserialize<_i7.NestedChild>($serialized[r'child']))
            as _i4.NestedParent);
      },
    ));
    _i3.Serializers.instance
