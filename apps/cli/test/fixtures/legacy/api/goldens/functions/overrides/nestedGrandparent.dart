...
import 'package:_common/_common.dart' as _i9;
...
final class NestedGrandparentTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
    ...
    } on _i9.CommonException catch (e, st) {
      ...
      final error = _i4.Serializers.instance.serialize<_i9.CommonException>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
      ...
      final error =
          _i4.Serializers.instance.serialize<_i11.OverriddenException>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i9.CommonException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{r'message': $value.message},
      deserialize: ($serialized) {
        return _i9.CommonException(($serialized[r'message'] as String));
      },
    ));
    _i4.Serializers.instance
      ...
      serialize: ($value) => <String, Object?>{r'message': $value.message},
      deserialize: ($serialized) {
        return _i9.CustomException(($serialized[r'message'] as String));
      },
    ));
    _i4.Serializers.instance.put(
      ...
      serialize: ($value) => <String, Object?>{r'message': $value.message},
      deserialize: ($serialized) {
        return (_i9.OverriddenException(($serialized[r'message'] as String))
    ...
    _i4.Serializers.instance
      ...
      serialize: ($value) => <String, Object?>{
        r'parent':
            _i4.Serializers.instance.serialize<_i9.NestedParent>($value.parent)
      },
      deserialize: ($serialized) {
        return _i5.NestedGrandparent(_i4.Serializers.instance
            .deserialize<_i9.NestedParent>($serialized[r'parent']));
      },
    ));
    _i4.Serializers.instance
      ...
      serialize: ($value) => <String, Object?>{
        r'child':
            _i4.Serializers.instance.serialize<_i9.NestedChild>($value.child)
      },
      deserialize: ($serialized) {
        return (_i9.NestedParent(_i4.Serializers.instance
                .deserialize<_i9.NestedChild>($serialized[r'child']))
            as _i5.NestedParent);
      },
    ));
    _i4.Serializers.instance
