...
final class NestedGrandparentTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.nestedGrandparent(_i4.Serializers.instance
          .deserialize<_i5.NestedGrandparent>(request[r'grandparent']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(_i4.Serializers.instance
            .serialize<_i5.NestedGrandparent>(response)),
      );
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i10.CommonException>(e),
            },
            if (_i7.context.environment != _i8.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i10.CustomException>(e),
            },
            if (_i7.context.environment != _i8.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i10.CommonException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{r'message': $value.message},
      deserialize: ($serialized) {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i10.CustomException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{r'message': $value.message},
      deserialize: ($serialized) {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.NestedChild, Map<String, Object?>>(
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.NestedGrandparent, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'parent':
            _i4.Serializers.instance.serialize<_i10.NestedParent>($value.parent)
      },
      deserialize: ($serialized) {
        return _i5.NestedGrandparent(_i4.Serializers.instance
            .deserialize<_i10.NestedParent>($serialized[r'parent']));
      },
    ));
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.NestedParent, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'child':
            _i4.Serializers.instance.serialize<_i10.NestedChild>($value.child)
      },
      deserialize: ($serialized) {
        return (_i10.NestedParent(_i4.Serializers.instance
                .deserialize<_i10.NestedChild>($serialized[r'child']))
            as _i5.NestedParent);
      },
    ));
    _i4.Serializers.instance
