...
import 'package:celest_backend/models/cycles.dart' as _i5;
import 'package:celest_backend/src/functions/cycles.dart' as _i3;
...
final class CombineTreesTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.combineTrees(
        _i4.Serializers.instance.deserialize<_i5.Node>(request[r'tree1']),
        _i4.Serializers.instance.deserialize<_i5.Parent?>(request[r'tree2']),
        _i4.Serializers.instance.deserialize<_i5.Node?>(request[r'tree3']),
        ((request[r'additionalChildren'] as Iterable<Object?>?)
                ?.map(
                    (el) => _i4.Serializers.instance.deserialize<_i5.Node?>(el))
                .toList()) ??
            const [],
      );
      return _i2.Response(
        ...
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.Node>(response)),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.Child, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'name': $value.name,
        r'children': $value.children
            .map((el) => _i4.Serializers.instance.serialize<_i5.Node>(el))
            .toList(),
      },
      deserialize: ($serialized) {
        return _i5.Child(($serialized[r'name'] as String));
      },
    ));
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.Node, Map<String, Object?>>(
      serialize: ($value) {
        if ($value is _i5.Parent) {
          return {
            ...(_i4.Serializers.instance.serialize<_i5.Parent>($value)
                as Map<String, Object?>),
            r'$type': r'Parent',
          };
        }
        if ($value is _i5.Child) {
          return {
            ...(_i4.Serializers.instance.serialize<_i5.Child>($value)
                as Map<String, Object?>),
            r'$type': r'Child',
          };
        }
      ...
      deserialize: ($serialized) {
        if ($serialized[r'$type'] == r'Parent') {
          return _i4.Serializers.instance.deserialize<_i5.Parent>($serialized);
        }
        if ($serialized[r'$type'] == r'Child') {
          return _i4.Serializers.instance.deserialize<_i5.Child>($serialized);
        }
        throw _i4.SerializationException((StringBuffer('Unknown subtype of ')
              ..write(r'Node')
              ..write(': ')
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.Parent, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'name': $value.name,
        r'children': $value.children
            .map((el) => _i4.Serializers.instance.serialize<_i5.Node>(el))
      ...
      deserialize: ($serialized) {
        return _i5.Parent(
          ...
          ($serialized[r'children'] as Iterable<Object?>)
              .map((el) => _i4.Serializers.instance.deserialize<_i5.Node>(el))
              .toList(),
        );
      },
    ));
...
Future<void> start() async {
  await _i1.serve(targets: {'/': CombineTreesTarget()});
}
