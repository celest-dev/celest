...
final class PositionalDefaultValuesTarget extends _i1.CloudFunctionHttpTarget {
  @override
...
Future<void> start() async {
  await _i1.serve(targets: {'/': PositionalDefaultValuesTarget()});
}
