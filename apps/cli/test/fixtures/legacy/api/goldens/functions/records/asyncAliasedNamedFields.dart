...
final class AsyncAliasedNamedFieldsTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'asyncAliasedNamedFields';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.asyncAliasedNamedFields(
          value: _i4.Serializers.instance
              .deserialize<_i5.NamedFieldsRecord>(request[r'value']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(_i4.Serializers.instance
            .serialize<_i5.NamedFieldsRecord>(response)),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': AsyncAliasedNamedFieldsTarget()});
}
