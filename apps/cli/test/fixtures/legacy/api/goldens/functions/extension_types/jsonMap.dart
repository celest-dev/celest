...
final class JsonMapTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response =
          _i3.jsonMap(_i4.Serializers.instance.deserialize<_i5.JsonMap>(
        request[r'value'],
      ...
      return _i2.Response(
        ...
        body:
            _i4.JsonUtf8.encode(_i4.Serializers.instance.serialize<_i5.JsonMap>(
          response,
          const _i4.TypeToken<_i5.JsonMap>('JsonMap'),
        )),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.JsonMap, Map<String, Object?>>(
...
Future<void> start() async {
  await _i1.serve(targets: {'/': JsonMapTarget()});
}
