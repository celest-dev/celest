...
final class MapReturnTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'mapReturn';
...
Future<void> start() async {
  await _i1.serve(targets: {'/': MapReturnTarget()});
}
