...
final class ValueXToJsonImplTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.valueXToJsonImpl(
          _i4.Serializers.instance.deserialize<_i5.ValueXToJsonImpl>(
        request[r'v'],
        const _i4.TypeToken<_i5.ValueXToJsonImpl>('ValueXToJsonImpl'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.ValueXToJsonImpl>(
          response,
          const _i4.TypeToken<_i5.ValueXToJsonImpl>('ValueXToJsonImpl'),
        )),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ValueXToJsonImplTarget()});
}

final class ValueXToJsonImplSerializer
    extends _i4.Serializer<_i5.ValueXToJsonImpl> {
  ValueXToJsonImplSerializer() {
  ...
  @override
  _i5.ValueXToJsonImpl deserialize(Object? $value) {
    final $serialized = assertWireType<String>($value);
    return _i5.ValueXToJsonImpl(
        $serializers.deserialize<_i5.Value>($serialized));
  }

  @override
  Object? serialize(_i5.ValueXToJsonImpl $value) => $value.toJson();
}
