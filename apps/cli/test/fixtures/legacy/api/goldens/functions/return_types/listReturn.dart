...
final class ListReturnTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'listReturn';
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ListReturnTarget()});
}
