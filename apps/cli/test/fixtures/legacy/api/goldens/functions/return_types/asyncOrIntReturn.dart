...
final class AsyncOrIntReturnTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'asyncOrIntReturn';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.asyncOrIntReturn();
      return _i2.Response(
        200,
...
Future<void> start() async {
  await _i1.serve(targets: {'/': AsyncOrIntReturnTarget()});
}
