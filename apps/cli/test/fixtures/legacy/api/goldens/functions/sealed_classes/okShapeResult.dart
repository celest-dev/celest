...
final class OkShapeResultTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.okShapeResult(
          _i4.Serializers.instance.deserialize<_i5.Shape>(request[r'shape']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.OkShapeResult>(response)),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.OkShapeResult, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'data': _i4.Serializers.instance.serialize<_i5.Shape>($value.data)
      },
      deserialize: ($serialized) {
        return _i5.OkShapeResult(_i4.Serializers.instance
...
Future<void> start() async {
  await _i1.serve(targets: {'/': OkShapeResultTarget()});
}
