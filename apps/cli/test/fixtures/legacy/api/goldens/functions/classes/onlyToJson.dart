...
final class OnlyToJsonTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.onlyToJson(_i4.Serializers.instance
...
Future<void> start() async {
  await _i1.serve(targets: {'/': OnlyToJsonTarget()});
}
