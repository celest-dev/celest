...
final class JsonListTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response =
          _i3.jsonList(_i4.Serializers.instance.deserialize<_i5.JsonList>(
        request[r'value'],
        const _i4.TypeToken<_i5.JsonList>('JsonList'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.JsonList>(
          response,
          const _i4.TypeToken<_i5.JsonList>('JsonList'),
        )),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.JsonList, List<Object?>>(
        serialize: ($value) => $value,
        deserialize: ($serialized) {
          return _i5.JsonList(($serialized as Iterable<Object?>).toList());
        },
      ),
      const _i4.TypeToken<_i5.JsonList>('JsonList'),
    );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': JsonListTarget()});
}
