...
final class AsyncIterableReturnTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'asyncIterableReturn';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.asyncIterableReturn();
      return _i2.Response(
        200,
...
Future<void> start() async {
  await _i1.serve(targets: {'/': AsyncIterableReturnTarget()});
}
