...
final class GenericWrappersAsyncTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.genericWrappersAsync(_i4.Serializers.instance
  ...
  void init() {
    ...
    _i4.Serializers.instance
      ...
      serialize: ($value) => <String, Object?>{
        ...
        r'listOfUri': _i4.Serializers.instance
            .serialize<_i12.IList<Uri>>($value.listOfUri),
        r'listOfSimpleClass': _i4.Serializers.instance
            .serialize<_i12.IList<_i13.SimpleClass>>($value.listOfSimpleClass),
        ...
        r'listOfListOfUri': _i4.Serializers.instance
            .serialize<_i12.IList<_i12.IList<Uri>>>($value.listOfListOfUri),
        ...
        r'mapOfMapOfSimpleClass': _i4.Serializers.instance
            .serialize<_i14.IMap<String, _i14.IMap<String, _i13.SimpleClass>>>(
      ...
      deserialize: ($serialized) {
        return _i5.GenericWrappers(
          ...
          listOfUri: _i4.Serializers.instance
              .deserialize<_i12.IList<Uri>>($serialized[r'listOfUri']),
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i13.SimpleClass, Map<String, dynamic>>(
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i12.IList<_i13.SimpleClass>, dynamic>(
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i12.IList<_i12.IList<String>>, dynamic>(
      serialize: ($value) => $value.toJson((value) =>
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i12.IList<_i12.IList<Uri>>, dynamic>(
      serialize: ($value) => $value.toJson((value) =>
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i12.IList<_i12.IList<_i13.SimpleClass>>, dynamic>(
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i14.IMap<String, _i13.SimpleClass>, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(
        (value) => value,
        (value) => _i4.Serializers.instance.serialize<_i13.SimpleClass>(value),
      ),
      deserialize: ($serialized) {
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i14.IMap<String, _i12.IList<String>>, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(
        (value) => value,
        (value) =>
            _i4.Serializers.instance.serialize<_i12.IList<String>>(value),
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i14.IMap<String, _i12.IList<Uri>>, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(
        (value) => value,
        (value) => _i4.Serializers.instance.serialize<_i12.IList<Uri>>(value),
      ),
      deserialize: ($serialized) {
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i14.IMap<String, _i12.IList<_i13.SimpleClass>>, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(
        (value) => value,
        (value) => _i4.Serializers.instance
            .serialize<_i12.IList<_i13.SimpleClass>>(value),
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i14.IMap<String, _i14.IMap<String, String>>, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(
        (value) => value,
        (value) => _i4.Serializers.instance
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i14.IMap<String, _i14.IMap<String, Uri>>, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(
        (value) => value,
        (value) =>
            _i4.Serializers.instance.serialize<_i14.IMap<String, Uri>>(value),
      ),
      deserialize: ($serialized) {
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
      ...
      deserialize: ($serialized) {
        return _i14.IMap<String, _i14.IMap<String, _i13.SimpleClass>>.fromJson(
          $serialized,
          (value) => (value as String),
          (value) => _i4.Serializers.instance
