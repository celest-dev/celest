...
final class ValueXFromJsonImplTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'valueXFromJsonImpl';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.valueXFromJsonImpl(
          _i4.Serializers.instance.deserialize<_i5.ValueXFromJsonImpl>(
        request[r'v'],
        const _i4.TypeToken<_i5.ValueXFromJsonImpl>('ValueXFromJsonImpl'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.ValueXFromJsonImpl>(
          response,
          const _i4.TypeToken<_i5.ValueXFromJsonImpl>('ValueXFromJsonImpl'),
        )),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ValueXFromJsonImplTarget()});
}

final class ValueXFromJsonImplSerializer
    extends _i4.Serializer<_i5.ValueXFromJsonImpl> {
  ValueXFromJsonImplSerializer() {
    $serializers.put(_i4.Serializer.define<_i5.Value, String>(
      serialize: ($value) => <String, Object?>{r'value': $value.value},
      deserialize: ($serialized) {
        return _i5.Value(($serialized as String));
      },
    ));
  }
  ...
  @override
  _i5.ValueXFromJsonImpl deserialize(Object? $value) {
    final $serialized = assertWireType<String>($value);
    return _i5.ValueXFromJsonImpl.fromJson($serialized);
  }

  @override
  Object? serialize(_i5.ValueXFromJsonImpl $value) => $value.toJson();
}
