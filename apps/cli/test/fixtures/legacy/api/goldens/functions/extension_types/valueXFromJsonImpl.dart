...
final class ValueXFromJsonImplTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i1.CelestResponse> handle(
    ...
    try {
      final response = _i2.valueXFromJsonImpl(
          _i3.Serializers.instance.deserialize<_i4.ValueXFromJsonImpl>(
        request[r'v'],
        const _i3.TypeToken<_i4.ValueXFromJsonImpl>('ValueXFromJsonImpl'),
      ));
      return (
        statusCode: 200,
        body: {
          'response':
              _i3.Serializers.instance.serialize<_i4.ValueXFromJsonImpl>(
            response,
            const _i3.TypeToken<_i4.ValueXFromJsonImpl>('ValueXFromJsonImpl'),
          )
        }
...
final class ValueXFromJsonImplSerializer
    extends _i3.Serializer<_i4.ValueXFromJsonImpl> {
  ValueXFromJsonImplSerializer() {
  ...
  @override
  _i4.ValueXFromJsonImpl deserialize(Object? $value) {
    final $serialized = assertWireType<String>($value);
    return _i4.ValueXFromJsonImpl.fromJson($serialized);
  }

  @override
  Object? serialize(_i4.ValueXFromJsonImpl $value) => $value.toJson();
}
