...
final class ErrShapeResultsTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.errShapeResults(
      ...
      return _i2.Response(
        ...
        body: _i4.JsonUtf8.encode(response
            .map((el) =>
                _i4.Serializers.instance.serialize<_i5.ErrResult<String>>(el))
            .toList()),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ErrShapeResultsTarget()});
}
