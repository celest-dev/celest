...
final class CommonNestedParentTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.commonNestedParent(_i4.Serializers.instance
    ...
    } on _i5.CommonException catch (e, st) {
    ...
    } on _i5.CustomException catch (e, st) {
      const statusCode = 400;
      _i7.context.logger.severe(
        e.message,
        e,
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i12.NestedChild, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return _i12.NestedChild.fromJson($serialized);
      },
    ));
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i12.NestedParent, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'child':
            _i4.Serializers.instance.serialize<_i5.NestedChild>($value.child)
      },
      deserialize: ($serialized) {
        return (_i5.NestedParent(_i4.Serializers.instance
                .deserialize<_i5.NestedChild>($serialized[r'child']))
            as _i12.NestedParent);
      },
    ));
    _i4.Serializers.instance
