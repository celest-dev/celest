...
final class CommonNestedParentTarget extends _i1.CloudFunctionHttpTarget {
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i5.CommonException>(e),
            },
            if (_i7.context.environment != _i8.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i5.CustomException>(e),
            },
            if (_i7.context.environment != _i8.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i13.NestedChild, Map<String, Object?>>(
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i13.NestedParent, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'child':
