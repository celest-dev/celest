...
final class NonMapToJsonWithDefaultsTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.nonMapToJsonWithDefaults(_i4.Serializers.instance
          .deserialize<_i5.NonMapToJsonWithDefaults>(request[r'value']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(_i4.Serializers.instance
            .serialize<_i5.NonMapToJsonWithDefaults>(response)),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.NonMapToJsonWithDefaults, String?>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return _i5.NonMapToJsonWithDefaults(
...
Future<void> start() async {
  await _i1.serve(targets: {'/': NonMapToJsonWithDefaultsTarget()});
}
