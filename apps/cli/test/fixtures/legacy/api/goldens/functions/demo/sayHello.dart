...
import 'package:celest_backend/exceptions/demo.dart' as _i9;
import 'package:celest_backend/models/demo.dart' as _i5;
import 'package:celest_backend/src/functions/demo.dart' as _i3;
...
final class SayHelloTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.sayHello(
          person: _i4.Serializers.instance
              .deserialize<_i5.Person>(request[r'person']));
      return _i2.Response(
        200,
    ...
    } on _i9.BadNameException catch (e, st) {
      ...
      final meta = {
        'code': 'api.v1.BadNameException',
        'message': e.message,
        'status': statusCode,
      };
      final error = _i4.Serializers.instance.serialize<_i9.BadNameException>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i9.BadNameException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{r'message': $value.message},
      deserialize: ($serialized) {
        return _i9.BadNameException(($serialized[r'message'] as String));
      },
    ));
    _i4.Serializers.instance
      ...
      deserialize: ($serialized) {
        return _i5.Person(name: ($serialized[r'name'] as String));
      },
    ));
    _i4.Serializers.instance
