...
import 'package:celest_backend/exceptions/demo.dart' as _i7;
import 'package:celest_backend/models/demo.dart' as _i4;
import 'package:celest_backend/src/functions/demo.dart' as _i2;
...
final class SayHelloTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i1.CelestResponse> handle(
    ...
    try {
      ...
      return (statusCode: statusCode, body: {'error': error});
    } on _i7.BadNameException catch (e) {
      const statusCode = 400;
      print('$statusCode $e');
      final error = {
        'code': 'api.v1.BadNameException',
        'details': _i3.Serializers.instance.serialize<_i7.BadNameException>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
  ...
  void init() {
    ...
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i7.BadNameException, Map<String, Object?>>(
      serialize: ($value) => {r'message': $value.message},
      deserialize: ($serialized) {
        return _i7.BadNameException(($serialized[r'message'] as String));
      },
    ));
    _i3.Serializers.instance
