...
final class StringFromJsonTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.stringFromJson(
          _i4.Serializers.instance.deserialize<_i5.StringXFromJson>(
        request[r's'],
        const _i4.TypeToken<_i5.StringXFromJson>('StringXFromJson'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.StringXFromJson>(
          response,
          const _i4.TypeToken<_i5.StringXFromJson>('StringXFromJson'),
        )),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.StringXFromJson, String>(
        serialize: ($value) => $value.s,
        deserialize: ($serialized) {
          return _i5.StringXFromJson.fromJson($serialized);
        },
      ),
      const _i4.TypeToken<_i5.StringXFromJson>('StringXFromJson'),
    );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': StringFromJsonTarget()});
}
