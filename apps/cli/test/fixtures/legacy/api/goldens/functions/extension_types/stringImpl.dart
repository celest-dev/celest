...
final class StringImplTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response =
          _i3.stringImpl(_i4.Serializers.instance.deserialize<_i5.StringXImpl>(
        request[r's'],
        const _i4.TypeToken<_i5.StringXImpl>('StringXImpl'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.StringXImpl>(
          response,
          const _i4.TypeToken<_i5.StringXImpl>('StringXImpl'),
        )),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.StringXImpl, String>(
        serialize: ($value) => $value,
        deserialize: ($serialized) {
          return _i5.StringXImpl(($serialized as String));
        },
      ),
      const _i4.TypeToken<_i5.StringXImpl>('StringXImpl'),
    );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': StringImplTarget()});
}
