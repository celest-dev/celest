...
final class MixedFieldsTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.mixedFields(_i4.Serializers.instance
          .deserialize<_i5.MixedFields>(request[r'value']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.MixedFields>(response)),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.MixedFields, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'superField': $value.superField,
        r'field': $value.field,
      },
      deserialize: ($serialized) {
        return _i5.MixedFields(
...
Future<void> start() async {
  await _i1.serve(targets: {'/': MixedFieldsTarget()});
}
