...
final class MapReturnNullableTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'mapReturnNullable';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.mapReturnNullable();
      return _i2.Response(
        200,
...
Future<void> start() async {
  await _i1.serve(targets: {'/': MapReturnNullableTarget()});
}
