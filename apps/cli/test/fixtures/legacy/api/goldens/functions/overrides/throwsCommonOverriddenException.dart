...
import 'package:_common/_common.dart' as _i8;
import 'package:celest/src/core/context.dart' as _i6;
import 'package:celest/src/runtime/serve.dart' as _i1;
import 'package:celest_backend/exceptions/overrides.dart' as _i10;
...
final class ThrowsCommonOverriddenExceptionTarget
    extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'throwsCommonOverriddenException';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      _i3.throwsCommonOverriddenException();
      return _i2.Response(
        200,
    ...
    } on _i8.CommonException catch (e, st) {
      ...
      final error = _i4.Serializers.instance.serialize<_i8.CommonException>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
    ...
    } on _i10.OverriddenException catch (e, st) {
      const statusCode = 400;
      _i6.context.logger.severe(
        e.toString(),
        e,
      ...
      final error =
          _i4.Serializers.instance.serialize<_i10.OverriddenException>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i8.CommonException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{r'message': $value.message},
      deserialize: ($serialized) {
        return _i8.CommonException(($serialized[r'message'] as String));
      },
    ));
    _i4.Serializers.instance
      ...
      serialize: ($value) => <String, Object?>{r'message': $value.message},
      deserialize: ($serialized) {
        return _i8.CustomException(($serialized[r'message'] as String));
      },
    ));
    _i4.Serializers.instance.put(
        _i4.Serializer.define<_i10.OverriddenException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{r'message': $value.message},
      deserialize: ($serialized) {
        return (_i8.OverriddenException(($serialized[r'message'] as String))
            as _i10.OverriddenException);
      },
    ));
    _i4.Serializers.instance
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ThrowsCommonOverriddenExceptionTarget()});
}
