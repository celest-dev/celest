...
final class AsyncVoidReturnTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'asyncVoidReturn';
...
Future<void> start() async {
  await _i1.serve(targets: {'/': AsyncVoidReturnTarget()});
}
