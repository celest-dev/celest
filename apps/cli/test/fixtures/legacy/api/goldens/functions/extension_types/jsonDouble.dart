...
final class JsonDoubleTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response =
          _i3.jsonDouble(_i4.Serializers.instance.deserialize<_i5.JsonDouble>(
        request[r'value'],
        const _i4.TypeToken<_i5.JsonDouble>('JsonDouble'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.JsonDouble>(
          response,
          const _i4.TypeToken<_i5.JsonDouble>('JsonDouble'),
        )),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.JsonDouble, double>(
        serialize: ($value) => $value,
        deserialize: ($serialized) {
          return _i5.JsonDouble(($serialized as num).toDouble());
        },
      ),
      const _i4.TypeToken<_i5.JsonDouble>('JsonDouble'),
    );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': JsonDoubleTarget()});
}
