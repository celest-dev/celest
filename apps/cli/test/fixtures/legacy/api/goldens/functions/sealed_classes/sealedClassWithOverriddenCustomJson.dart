...
final class SealedClassWithOverriddenCustomJsonTarget
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.sealedClassWithOverriddenCustomJson(
        circle: _i4.Serializers.instance
            .deserialize<_i5.CircleWithOverriddenCustomJson>(
                request[r'circle']),
        rectangle: _i4.Serializers.instance
            .deserialize<_i5.RectangleWithOverriddenCustomJson>(
                request[r'rectangle']),
        other: (request[r'other'] as Iterable<Object?>)
            .map((el) => _i4.Serializers.instance
                .deserialize<_i5.ShapeWithOverriddenCustomJson>(el))
            .toList(),
      );
      return _i2.Response(
        200,
        ...
        body: _i4.JsonUtf8.encode(response
            .map((el) => _i4.Serializers.instance
                .serialize<_i5.ShapeWithOverriddenCustomJson>(el))
            .toList()),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i5.CircleWithOverriddenCustomJson, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return _i5.CircleWithOverriddenCustomJson.fromJson($serialized);
      },
    ));
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i5.RectangleWithOverriddenCustomJson, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return (_i5.ShapeWithOverriddenCustomJson.fromJson({
          r'$type': r'RectangleWithOverriddenCustomJson',
          ...$serialized,
        }) as _i5.RectangleWithOverriddenCustomJson);
      },
    ));
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i5.ShapeWithOverriddenCustomJson, Map<String, Object?>>(
      serialize: ($value) => {
        ...$value.toJson(),
        r'$type': switch ($value) {
          _i5.CircleWithOverriddenCustomJson() =>
            r'CircleWithOverriddenCustomJson',
          _i5.RectangleWithOverriddenCustomJson() =>
            r'RectangleWithOverriddenCustomJson',
        },
      },
      deserialize: ($serialized) {
        return _i5.ShapeWithOverriddenCustomJson.fromJson($serialized);
      },
    ));
    _i4.Serializers.instance
