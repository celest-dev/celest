...
final class ColorXToJsonTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3
          .colorXToJson(_i4.Serializers.instance.deserialize<_i5.ColorXToJson>(
        request[r'color'],
        const _i4.TypeToken<_i5.ColorXToJson>('ColorXToJson'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.ColorXToJson>(
          response,
          const _i4.TypeToken<_i5.ColorXToJson>('ColorXToJson'),
        )),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ColorXToJsonTarget()});
}

final class ColorXToJsonSerializer extends _i4.Serializer<_i5.ColorXToJson> {
  ColorXToJsonSerializer() {
  ...
  @override
  _i5.ColorXToJson deserialize(Object? $value) {
    final $serialized = assertWireType<String>($value);
    return _i5.ColorXToJson($serializers.deserialize<_i5.Color>($serialized));
  }

  @override
  Object? serialize(_i5.ColorXToJson $value) => $value.toJson();
}
