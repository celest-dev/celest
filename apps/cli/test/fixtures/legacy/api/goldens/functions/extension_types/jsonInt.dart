...
final class JsonIntTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response =
          _i3.jsonInt(_i4.Serializers.instance.deserialize<_i5.JsonInt>(
        request[r'value'],
        const _i4.TypeToken<_i5.JsonInt>('JsonInt'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body:
            _i4.JsonUtf8.encode(_i4.Serializers.instance.serialize<_i5.JsonInt>(
          response,
          const _i4.TypeToken<_i5.JsonInt>('JsonInt'),
        )),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.JsonInt, int>(
        serialize: ($value) => $value,
        deserialize: ($serialized) {
          return _i5.JsonInt(($serialized as num).toInt());
        },
      ),
      const _i4.TypeToken<_i5.JsonInt>('JsonInt'),
    );
