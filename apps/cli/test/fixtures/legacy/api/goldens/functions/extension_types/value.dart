...
final class ValueTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.value(
          _i4.Serializers.instance.deserialize<_i5.Value>(request[r'v']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.Value>(response)),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<_i5.Value, String>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return _i5.Value.fromJson($serialized);
      },
    ));
    _i4.Serializers.instance
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ValueTarget()});
}
