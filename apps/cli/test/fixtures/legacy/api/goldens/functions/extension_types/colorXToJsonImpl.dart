...
final class ColorXToJsonImplTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.colorXToJsonImpl(
          _i4.Serializers.instance.deserialize<_i5.ColorXToJsonImpl>(
        request[r'color'],
        const _i4.TypeToken<_i5.ColorXToJsonImpl>('ColorXToJsonImpl'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.ColorXToJsonImpl>(
          response,
          const _i4.TypeToken<_i5.ColorXToJsonImpl>('ColorXToJsonImpl'),
        )),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ColorXToJsonImplTarget()});
}

final class ColorXToJsonImplSerializer
    extends _i4.Serializer<_i5.ColorXToJsonImpl> {
  ColorXToJsonImplSerializer() {
  ...
  @override
  _i5.ColorXToJsonImpl deserialize(Object? $value) {
    final $serialized = assertWireType<String>($value);
    return _i5.ColorXToJsonImpl(
        $serializers.deserialize<_i5.Color>($serialized));
  }

  @override
  Object? serialize(_i5.ColorXToJsonImpl $value) => $value.toJson();
}
