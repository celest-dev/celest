...
final class ColorXFromJsonTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.colorXFromJson(
          _i4.Serializers.instance.deserialize<_i5.ColorXFromJson>(
        request[r'color'],
        const _i4.TypeToken<_i5.ColorXFromJson>('ColorXFromJson'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.ColorXFromJson>(
          response,
          const _i4.TypeToken<_i5.ColorXFromJson>('ColorXFromJson'),
        )),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ColorXFromJsonTarget()});
}

final class ColorXFromJsonSerializer
    extends _i4.Serializer<_i5.ColorXFromJson> {
  ColorXFromJsonSerializer() {
  ...
  @override
  _i5.ColorXFromJson deserialize(Object? $value) {
    final $serialized = assertWireType<String>($value);
    return _i5.ColorXFromJson.fromJson($serialized);
  }

  @override
  Object? serialize(_i5.ColorXFromJson $value) =>
