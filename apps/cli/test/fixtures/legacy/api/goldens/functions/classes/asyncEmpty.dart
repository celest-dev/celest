...
final class AsyncEmptyTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.asyncEmpty(
          _i4.Serializers.instance.deserialize<_i5.Empty>(request[r'value']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.Empty>(response)),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.Empty, Map<String, Object?>?>(
      serialize: ($value) => const <String, Object?>{},
      deserialize: ($serialized) {
        return _i5.Empty();
      },
...
Future<void> start() async {
  await _i1.serve(targets: {'/': AsyncEmptyTarget()});
}
