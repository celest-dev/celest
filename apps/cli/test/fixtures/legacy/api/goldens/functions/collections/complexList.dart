...
import 'package:celest_backend/src/functions/collections.dart' as _i2;
...
final class ComplexListTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'complexList';
  ...
  Future<_i1.CelestResponse> handle(
    ...
    try {
      final response = await _i2.complexList((request[r'list']
              as Iterable<Object?>)
          .map(
      ...
      return (
        ...
        body: {
          'response': response
              .map((el) =>
                  _i3.Serializers.instance.serialize<_i4.SimpleClass>(el))
              .toList()
        }
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ComplexListTarget()});
}
