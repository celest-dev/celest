...
import 'package:celest_backend/models/typedefs.dart' as _i5;
import 'package:celest_backend/src/functions/typedefs.dart' as _i3;
...
final class PortfolioTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.portfolio(_i4.Serializers.instance
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.Portfolio, Map<String, dynamic>>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return _i5.Portfolio.fromJson($serialized);
      },
    ));
    _i4.Serializers.instance
