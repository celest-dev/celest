...
final class SealedClassWithInheritedCustomJsonTarget
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.sealedClassWithInheritedCustomJson(
          shapes: (request[r'shapes'] as Iterable<Object?>)
              .map((el) => _i4.Serializers.instance
                  .deserialize<_i5.ShapeWithInheritedCustomJson>(el))
              .toList());
      return _i2.Response(
        200,
        ...
        body: _i4.JsonUtf8.encode(response
            .map((el) => _i4.Serializers.instance
                .serialize<_i5.ShapeWithInheritedCustomJson>(el))
            .toList()),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i5.CircleWithInheritedCustomJson, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return (_i5.ShapeWithInheritedCustomJson.fromJson({
          r'$type': r'CircleWithInheritedCustomJson',
          ...$serialized,
        }) as _i5.CircleWithInheritedCustomJson);
      },
    ));
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i5.RectangleWithInheritedCustomJson, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return (_i5.ShapeWithInheritedCustomJson.fromJson({
          r'$type': r'RectangleWithInheritedCustomJson',
          ...$serialized,
        }) as _i5.RectangleWithInheritedCustomJson);
      },
    ));
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i5.ShapeWithInheritedCustomJson, Map<String, Object?>>(
      serialize: ($value) => {
        ...$value.toJson(),
        r'$type': switch ($value) {
      ...
      deserialize: ($serialized) {
        return _i5.ShapeWithInheritedCustomJson.fromJson($serialized);
      },
    ));
    _i4.Serializers.instance
...
Future<void> start() async {
  await _i1.serve(targets: {'/': SealedClassWithInheritedCustomJsonTarget()});
}
