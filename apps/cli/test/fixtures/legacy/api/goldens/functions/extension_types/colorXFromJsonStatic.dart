...
import 'package:celest_backend/models/extension_types.dart' as _i5;
...
final class ColorXFromJsonStaticTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.colorXFromJsonStatic(
          _i4.Serializers.instance.deserialize<_i5.ColorXFromJsonStatic>(
        request[r'color'],
        const _i4.TypeToken<_i5.ColorXFromJsonStatic>('ColorXFromJsonStatic'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.ColorXFromJsonStatic>(
          response,
          const _i4.TypeToken<_i5.ColorXFromJsonStatic>('ColorXFromJsonStatic'),
        )),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ColorXFromJsonStaticTarget()});
}

final class ColorXFromJsonStaticSerializer
    extends _i4.Serializer<_i5.ColorXFromJsonStatic> {
  ColorXFromJsonStaticSerializer() {
    $serializers.put(_i4.Serializer.define<_i5.Color, String>(
      serialize: ($value) => $value.name,
      deserialize: ($serialized) {
        return _i5.Color.values.byName($serialized);
      },
    ));
  }

  final _i4.Serializers $serializers = _i4.Serializers();

  @override
  _i5.ColorXFromJsonStatic deserialize(Object? $value) {
    final $serialized = assertWireType<String>($value);
    return _i5.ColorXFromJsonStatic.fromJson($serialized);
  }

  @override
  Object? serialize(_i5.ColorXFromJsonStatic $value) =>
      $serializers.serialize<_i5.Color>($value.c);
}
