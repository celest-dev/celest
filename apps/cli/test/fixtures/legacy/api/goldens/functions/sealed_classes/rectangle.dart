...
final class RectangleTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.rectangle(_i4.Serializers.instance
          .deserialize<_i5.Rectangle>(request[r'rectangle']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.Rectangle>(response)),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': RectangleTarget()});
}
