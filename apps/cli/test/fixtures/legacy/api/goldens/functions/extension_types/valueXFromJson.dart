...
final class ValueXFromJsonTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.valueXFromJson(
          _i4.Serializers.instance.deserialize<_i5.ValueXFromJson>(
        request[r'v'],
        const _i4.TypeToken<_i5.ValueXFromJson>('ValueXFromJson'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.ValueXFromJson>(
          response,
          const _i4.TypeToken<_i5.ValueXFromJson>('ValueXFromJson'),
        )),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ValueXFromJsonTarget()});
}

final class ValueXFromJsonSerializer
    extends _i4.Serializer<_i5.ValueXFromJson> {
  ValueXFromJsonSerializer() {
  ...
  @override
  _i5.ValueXFromJson deserialize(Object? $value) {
    final $serialized = assertWireType<Map<String, Object?>>($value);
    return _i5.ValueXFromJson.fromJson($serialized);
  }

  @override
  Object? serialize(_i5.ValueXFromJson $value) =>
      $serializers.serialize<_i5.Value>($value.v);
}
