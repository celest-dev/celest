...
final class JsonValueTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response =
          _i3.jsonValue(_i4.Serializers.instance.deserialize<_i5.JsonValue>(
        request[r'value'],
      ...
      return _i2.Response(
        ...
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.JsonValue>(
          response,
          const _i4.TypeToken<_i5.JsonValue>('JsonValue'),
        )),
      );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': JsonValueTarget()});
}
