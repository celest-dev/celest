...
final class ColorTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.color(
          _i4.Serializers.instance.deserialize<_i5.Color>(request[r'color']));
      return _i2.Response(
        200,
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<_i5.Color, String>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return _i5.Color.fromJson($serialized);
      },
    ));
    _i4.Serializers.instance
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ColorTarget()});
}
