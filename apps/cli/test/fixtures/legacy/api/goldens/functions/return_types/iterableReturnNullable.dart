...
final class IterableReturnNullableTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'iterableReturnNullable';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.iterableReturnNullable();
      return _i2.Response(
        200,
...
Future<void> start() async {
  await _i1.serve(targets: {'/': IterableReturnNullableTarget()});
}
