...
final class StringToJsonImplTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.stringToJsonImpl(
          _i4.Serializers.instance.deserialize<_i5.StringXToJsonImpl>(
        request[r's'],
        const _i4.TypeToken<_i5.StringXToJsonImpl>('StringXToJsonImpl'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.StringXToJsonImpl>(
          response,
          const _i4.TypeToken<_i5.StringXToJsonImpl>('StringXToJsonImpl'),
        )),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.StringXToJsonImpl, String>(
        serialize: ($value) => $value.toJson(),
        deserialize: ($serialized) {
          return _i5.StringXToJsonImpl(($serialized as String));
        },
      ),
      const _i4.TypeToken<_i5.StringXToJsonImpl>('StringXToJsonImpl'),
    );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': StringToJsonImplTarget()});
}
