...
import 'package:celest_backend/models/classes.dart' as _i5;
import 'package:celest_backend/src/functions/classes.dart' as _i3;
...
final class NestedClassTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.nestedClass(_i4.Serializers.instance
          .deserialize<_i5.NestedClass>(request[r'value']));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.NestedClass>(response)),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.Fields, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.NestedClass, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'fields':
            _i4.Serializers.instance.serialize<_i5.Fields>($value.fields),
        r'nullableFields': _i4.Serializers.instance
            .serialize<_i5.Fields?>($value.nullableFields),
      },
      deserialize: ($serialized) {
        return _i5.NestedClass(
          _i4.Serializers.instance
              .deserialize<_i5.Fields>($serialized[r'fields']),
          _i4.Serializers.instance
              .deserialize<_i5.Fields?>($serialized[r'nullableFields']),
        );
      },
    ));
    _i4.Serializers.instance
...
Future<void> start() async {
  await _i1.serve(targets: {'/': NestedClassTarget()});
}
