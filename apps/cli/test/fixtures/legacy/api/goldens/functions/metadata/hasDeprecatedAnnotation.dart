...
final class HasDeprecatedAnnotationTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'hasDeprecatedAnnotation';
...
Future<void> start() async {
  await _i1.serve(targets: {'/': HasDeprecatedAnnotationTarget()});
}
