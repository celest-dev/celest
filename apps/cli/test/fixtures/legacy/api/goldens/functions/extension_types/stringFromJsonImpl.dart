...
final class StringFromJsonImplTarget extends _i1.CloudFunctionHttpTarget {
  @override
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.stringFromJsonImpl(
          _i4.Serializers.instance.deserialize<_i5.StringXFromJsonImpl>(
        request[r's'],
        const _i4.TypeToken<_i5.StringXFromJsonImpl>('StringXFromJsonImpl'),
      ));
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
            _i4.Serializers.instance.serialize<_i5.StringXFromJsonImpl>(
          response,
          const _i4.TypeToken<_i5.StringXFromJsonImpl>('StringXFromJsonImpl'),
        )),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.StringXFromJsonImpl, String>(
        serialize: ($value) => $value,
        deserialize: ($serialized) {
          return _i5.StringXFromJsonImpl.fromJson($serialized);
        },
      ),
      const _i4.TypeToken<_i5.StringXFromJsonImpl>('StringXFromJsonImpl'),
    );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': StringFromJsonImplTarget()});
}
