...
final class NamedDefaultValueVarsTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      _i3.namedDefaultValueVars(
        value: ((request[r'value'] as num?)?.toInt()) ?? _i3.defaultInt,
        doubleValue: ((request[r'doubleValue'] as num?)?.toDouble()) ??
            _i3.defaultDouble,
        boolValue: ((request[r'boolValue'] as bool?)) ?? _i3.defaultBool,
        stringValue:
        ...
        mapValue: ((request[r'mapValue'] as Map<String, Object?>?)?.map((
            ...
            _i3.defaultMap,
        enumValue: (_i4.Serializers.instance
                .deserialize<_i5.LiteralEnum?>(request[r'enumValue'])) ??
            _i3.defaultEnum,
        recordValue: (_i4.Serializers.instance
...
Future<void> start() async {
  await _i1.serve(targets: {'/': NamedDefaultValueVarsTarget()});
}
