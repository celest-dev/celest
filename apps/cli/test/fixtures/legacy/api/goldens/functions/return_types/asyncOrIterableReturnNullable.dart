...
final class AsyncOrIterableReturnNullableTarget
  ...
  @override
  String get name => 'asyncOrIterableReturnNullable';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.asyncOrIterableReturnNullable();
      return _i2.Response(
        200,
...
Future<void> start() async {
  await _i1.serve(targets: {'/': AsyncOrIterableReturnNullableTarget()});
}
