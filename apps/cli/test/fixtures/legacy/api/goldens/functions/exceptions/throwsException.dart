...
import 'package:celest_backend/models/exceptions.dart' as _i5;
...
final class ThrowsExceptionTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      _i3.throwsException(
          type: _i4.Serializers.instance
              .deserialize<_i5.SupportedExceptionType>(request[r'type']));
      return _i2.Response(
        200,
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.SupportedExceptionType, String>(
      serialize: ($value) => $value.name,
      deserialize: ($serialized) {
        return _i5.SupportedExceptionType.values.byName($serialized);
      },
    ));
    _i4.Serializers.instance
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ThrowsExceptionTarget()});
}
