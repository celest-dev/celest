...
final class ThrowsCustomExceptionToFromJsonTarget
    ...
    try {
      ...
      final error = {
        ...
        'details': _i4.Serializers.instance
            .serialize<_i6.CustomErrorWithStackTrace>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
      ...
      final error = {
        ...
        'details': _i4.Serializers.instance
            .serialize<_i6.CustomExceptionToFromJson>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
  ...
  void init() {
    ...
    _i4.Serializers.instance
      ...
      serialize: ($value) => {
        r'message': $value.message,
        r'additionalInfo': _i4.Serializers.instance.serialize<_i9.JsonMap>(
          $value.additionalInfo,
          const _i4.TypeToken<_i9.JsonMap>('JsonMap'),
        ),
      },
      deserialize: ($serialized) {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.JsonMap, Map<String, Object?>>(
        serialize: ($value) => $value,
        deserialize: ($serialized) {
          return _i9.JsonMap(($serialized as Map<String, Object?>));
        },
      ),
      const _i4.TypeToken<_i9.JsonMap>('JsonMap'),
    );
