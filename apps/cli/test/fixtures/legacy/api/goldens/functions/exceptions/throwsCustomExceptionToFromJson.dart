...
import 'package:celest_backend/exceptions/exceptions.dart' as _i8;
...
final class ThrowsCustomExceptionToFromJsonTarget
  ...
  Future<_i2.Response> handle(
    ...
    try {
      _i3.throwsCustomExceptionToFromJson();
      return _i2.Response(
        200,
    ...
    } on _i8.CustomErrorToFromJson catch (e, st) {
      const statusCode = 500;
      _i6.context.logger.severe(
        e.toString(),
        e,
      ...
      final error =
          _i4.Serializers.instance.serialize<_i8.CustomErrorToFromJson>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
      ...
      final error = _i4.Serializers.instance.serialize<_i8.CustomError>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
    ...
    } on _i8.CustomErrorWithStackTrace catch (e, st) {
      const statusCode = 500;
      _i6.context.logger.severe(
        e.message,
        e,
      ...
      final error =
          _i4.Serializers.instance.serialize<_i8.CustomErrorWithStackTrace>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
    ...
    } on _i8.CustomExceptionToFromJson catch (e, st) {
      ...
      final error =
          _i4.Serializers.instance.serialize<_i8.CustomExceptionToFromJson>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
    ...
    } on _i8.CustomException catch (e, st) {
      const statusCode = 400;
      _i6.context.logger.severe(
        e.message,
        e,
      ...
      final error = _i4.Serializers.instance.serialize<_i8.CustomException>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
  ...
  void init() {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i8.CustomError, Map<String, Object?>?>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
        r'additionalInfo': _i4.Serializers.instance.serialize<_i11.JsonMap>(
          $value.additionalInfo,
          const _i4.TypeToken<_i11.JsonMap>('JsonMap'),
        ),
      },
      deserialize: ($serialized) {
        return _i8.CustomError();
      },
    ));
    _i4.Serializers.instance.put(
        _i4.Serializer.define<_i8.CustomErrorToFromJson, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return _i8.CustomErrorToFromJson.fromJson($serialized);
      },
    ));
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i8.CustomErrorWithStackTrace, Map<String, Object?>?>(
      serialize: ($value) => <String, Object?>{
        r'stackTrace':
            _i4.Serializers.instance.serialize<StackTrace>($value.stackTrace),
        r'message': $value.message,
      ...
      deserialize: ($serialized) {
        return _i8.CustomErrorWithStackTrace(
            stackTrace: _i4.Serializers.instance
                .deserialize<StackTrace?>($serialized?[r'stackTrace']));
      },
    ));
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i8.CustomException, Map<String, Object?>?>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
        r'additionalInfo': _i4.Serializers.instance.serialize<_i11.JsonMap>(
          $value.additionalInfo,
      ...
      deserialize: ($serialized) {
        return _i8.CustomException();
      },
    ));
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i8.CustomExceptionToFromJson, Map<String, Object?>>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
        return _i8.CustomExceptionToFromJson.fromJson($serialized);
      },
    ));
    _i4.Serializers.instance
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i11.JsonMap, Map<String, Object?>>(
        serialize: ($value) => $value,
        deserialize: ($serialized) {
          return _i11.JsonMap(($serialized as Map<String, Object?>));
        },
      ),
      const _i4.TypeToken<_i11.JsonMap>('JsonMap'),
    );
...
Future<void> start() async {
  await _i1.serve(targets: {'/': ThrowsCustomExceptionToFromJsonTarget()});
}
