...
import 'package:celest_backend/exceptions/http_errors.dart' as _i9;
...
final class HttpErrorsTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    } on _i9.AnotherNotFoundException catch (e, st) {
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance
                  .serialize<_i9.AnotherNotFoundException>(e),
            },
            if (_i7.context.environment != _i8.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i9.BadGatewayError catch (e, st) {
      const statusCode = 404;
      _i7.context.logger.severe(
        e.message,
        e,
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i9.BadGatewayError>(e),
            },
            if (_i7.context.environment != _i8.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i9.CustomBadRequestException catch (e, st) {
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance
                  .serialize<_i9.CustomBadRequestException>(e),
            },
            if (_i7.context.environment != _i8.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i9.ForbiddenException catch (e, st) {
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i9.ForbiddenException>(e),
            },
            if (_i7.context.environment != _i8.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i9.AnotherNotFoundException, Map<String, Object?>?>(
      serialize: ($value) => const <String, Object?>{},
      deserialize: ($serialized) {
        return _i9.AnotherNotFoundException();
      },
    ));
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i9.BadGatewayError, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'code': $value.code,
        r'message': $value.message,
      ...
      deserialize: ($serialized) {
        return _i9.BadGatewayError(($serialized[r'message'] as String?));
      },
    ));
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i9.CustomBadRequestException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'code': $value.code,
        r'message': $value.message,
        if (_i4.Serializers.instance.serialize<_i13.JsonValue?>(
      ...
      deserialize: ($serialized) {
        return _i9.CustomBadRequestException(
            ($serialized[r'message'] as String));
      },
    ));
    _i4.Serializers.instance.put(
        _i4.Serializer.define<_i9.ForbiddenException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'code': $value.code,
        r'message': $value.message,
        if (_i4.Serializers.instance.serialize<_i13.JsonValue?>(
      ...
      deserialize: ($serialized) {
        return _i9.ForbiddenException(($serialized[r'message'] as String));
      },
    ));
    _i4.Serializers.instance.put(
