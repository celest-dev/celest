...
import 'package:celest_backend/exceptions/http_errors.dart' as _i8;
import 'package:celest_backend/models/http_errors.dart' as _i5;
import 'package:celest_backend/src/functions/http_errors.dart' as _i3;
...
final class HttpErrorsTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      await _i3.httpErrors(_i4.Serializers.instance
          .deserialize<_i5.ExceptionType>(request[r'type']));
      return _i2.Response(
        200,
    ...
    } on _i8.AnotherNotFoundException catch (e, st) {
      ...
      final error =
          _i4.Serializers.instance.serialize<_i8.AnotherNotFoundException>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
    ...
    } on _i8.BadGatewayError catch (e, st) {
      const statusCode = 404;
      _i7.context.logger.severe(
        e.message,
        e,
      ...
      final error = _i4.Serializers.instance.serialize<_i8.BadGatewayError>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
    ...
    } on _i8.CustomBadRequestException catch (e, st) {
      ...
      final error =
          _i4.Serializers.instance.serialize<_i8.CustomBadRequestException>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
    ...
    } on _i8.ForbiddenException catch (e, st) {
      ...
      final error =
          _i4.Serializers.instance.serialize<_i8.ForbiddenException>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
      ...
      final error =
          _i4.Serializers.instance.serialize<_i8.NotFoundException>(e);
      return _i2.Response(
        statusCode,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode({
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i8.AnotherNotFoundException, Map<String, Object?>?>(
      serialize: ($value) => const <String, Object?>{},
      deserialize: ($serialized) {
        return _i8.AnotherNotFoundException();
      },
    ));
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i8.BadGatewayError, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
      ...
      deserialize: ($serialized) {
        return _i8.BadGatewayError(($serialized[r'message'] as String?));
      },
    ));
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i8.CustomBadRequestException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
        r'details': _i4.Serializers.instance.serialize<_i12.JsonValue?>(
          $value.details,
      ...
      deserialize: ($serialized) {
        return _i8.CustomBadRequestException(
            ($serialized[r'message'] as String));
      },
    ));
    _i4.Serializers.instance.put(
        _i4.Serializer.define<_i8.ForbiddenException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
        r'details': _i4.Serializers.instance.serialize<_i12.JsonValue?>(
          $value.details,
      ...
      deserialize: ($serialized) {
        return _i8.ForbiddenException(($serialized[r'message'] as String));
      },
    ));
    _i4.Serializers.instance.put(
        _i4.Serializer.define<_i8.NotFoundException, Map<String, Object?>?>(
      serialize: ($value) => const <String, Object?>{},
      deserialize: ($serialized) {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i5.ExceptionType, String>(
      serialize: ($value) => $value.name,
      deserialize: ($serialized) {
        return _i5.ExceptionType.values.byName($serialized);
      },
    ));
    _i4.Serializers.instance
