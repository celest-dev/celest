...
import 'package:celest_backend/exceptions/http_errors.dart' as _i6;
import 'package:celest_backend/models/http_errors.dart' as _i4;
import 'package:celest_backend/src/functions/http_errors.dart' as _i2;
...
final class HttpErrorsTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i1.CelestResponse> handle(
    ...
    try {
      ...
      return (statusCode: statusCode, body: {'error': error});
    } on _i6.AnotherNotFoundException catch (e) {
      const statusCode = 404;
      print('$statusCode $e');
      final error = {
        'code': 'api.v1.AnotherNotFoundException',
        'details':
            _i3.Serializers.instance.serialize<_i6.AnotherNotFoundException>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
      ...
      return (statusCode: statusCode, body: {'error': error});
    } on _i6.BadGatewayError catch (e) {
      const statusCode = 404;
      print('$statusCode $e');
      final error = {
        'message': e.message,
      ...
      return (statusCode: statusCode, body: {'error': error});
    } on _i6.CustomBadRequestException catch (e) {
      ...
      return (statusCode: statusCode, body: {'error': error});
    } on _i6.ForbiddenException catch (e) {
      ...
      final error = {
        ...
        'details': _i3.Serializers.instance.serialize<_i6.NotFoundException>(e),
      };
      return (statusCode: statusCode, body: {'error': error});
  ...
  void init() {
    ...
    _i3.Serializers.instance.put(_i3.Serializer.define<
        _i6.AnotherNotFoundException, Map<String, Object?>?>(
      serialize: ($value) => {},
      deserialize: ($serialized) {
        return _i6.AnotherNotFoundException();
      },
    ));
    _i3.Serializers.instance
        .put(_i3.Serializer.define<_i6.BadGatewayError, Map<String, Object?>>(
      serialize: ($value) => {
        r'message': $value.message,
      ...
      deserialize: ($serialized) {
        return _i6.BadGatewayError(($serialized[r'message'] as String?));
      },
    ));
    _i3.Serializers.instance.put(_i3.Serializer.define<
        _i6.CustomBadRequestException, Map<String, Object?>>(
      serialize: ($value) => {
        r'details': _i3.Serializers.instance.serialize<_i10.JsonValue?>(
          $value.details,
          const _i3.TypeToken<_i10.JsonValue?>('JsonValue'),
      ...
      deserialize: ($serialized) {
        return _i6.CustomBadRequestException(
            ($serialized[r'message'] as String));
      },
    ));
    _i3.Serializers.instance.put(
        _i3.Serializer.define<_i6.ForbiddenException, Map<String, Object?>>(
      serialize: ($value) => {
        r'details': _i3.Serializers.instance.serialize<_i10.JsonValue?>(
          $value.details,
          const _i3.TypeToken<_i10.JsonValue?>('JsonValue'),
      ...
      deserialize: ($serialized) {
        return _i6.ForbiddenException(($serialized[r'message'] as String));
      },
    ));
    _i3.Serializers.instance.put(
        _i3.Serializer.define<_i6.NotFoundException, Map<String, Object?>?>(
      serialize: ($value) => {},
      deserialize: ($serialized) {
