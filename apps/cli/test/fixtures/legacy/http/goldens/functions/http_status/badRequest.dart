...
final class BadRequestTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'badRequest';
...
Future<void> start() async {
  await _i1.serve(targets: {'/': BadRequestTarget()});
}
