...
import 'package:celest_backend/src/functions/http_status.dart' as _i3;
...
final class InternalServerErrorTarget extends _i1.CloudFunctionHttpTarget {
  @override
...
Future<void> start() async {
  await _i1.serve(targets: {'/': InternalServerErrorTarget()});
}
