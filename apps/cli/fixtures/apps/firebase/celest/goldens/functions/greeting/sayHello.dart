...
import 'package:celest_backend/src/functions/greeting.dart' as _i3;
...
final class SayHelloTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.sayHello(
        person: _i4.Serializers.instance.deserialize<_i3.Person>(
          request[r'person'],
        ),
      );
      return _i2.Response(
    ...
    } on _i3.BadNameException catch (e, st) {
      ...
      final status = {
        '@status': {
          ...
          'details': [
            {
              '@type': 'firebase_test.v1.BadNameException',
              'value': _i4.Serializers.instance.serialize<_i3.BadNameException>(
                e,
              ),
            },
            if (_i6.context.environment != _i7.Environment.production)
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.JsonUnsupportedObjectError,
          Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<IntegerDivisionByZeroException,
          Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          if ($value.message case final message?) r'message': message,
        },
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i3.BadNameException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
          return _i3.BadNameException(($serialized[r'message'] as String));
        },
      ),
    );
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i3.Person, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'name': $value.name},
        deserialize: ($serialized) {
          return _i3.Person(name: ($serialized[r'name'] as String));
        },
      ),
    );
    _i4.Serializers.instance.put(
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.FailedPreconditionException,
          Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.PermissionDeniedException,
          Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.ResourceExhaustedException,
          Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i10.SerializationException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
          if (_i4.Serializers.instance.serialize<_i11.JsonValue?>(
