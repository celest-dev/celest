...
import 'package:celest_backend/src/generated/auth.celest.dart' as _i39;
...
import 'package:chunked_stream/src/read_chunked_stream.dart' as _i24;
import 'package:corks_cedar/src/exceptions.dart' as _i21;
import 'package:drift/src/remote/communication.dart' as _i18;
import 'package:drift/src/runtime/cancellation_zone.dart' as _i14;
import 'package:drift/src/runtime/exceptions.dart' as _i19;
import 'package:hrana/src/exception.dart' as _i17;
import 'package:http/src/exception.dart' as _i16;
import 'package:mustache_template/src/template_exception.dart' as _i31;
import 'package:path/src/path_exception.dart' as _i26;
import 'package:petitparser/src/core/exception.dart' as _i25;
import 'package:petitparser/src/core/result.dart' as _i35;
import 'package:shelf/shelf.dart' as _i2;
import 'package:shelf/src/hijack_exception.dart' as _i20;
...
final class CreateTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i7.AbortedException>(e),
            },
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i10.ArityException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i16.ClientException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i17.ConnectionClosed catch (e, st) {
      const statusCode = 400;
      _i8.context.logger.severe(
        e.toString(),
        e,
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i17.ConnectionClosed>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i18.ConnectionClosedException catch (e, st) {
      const statusCode = 400;
      _i8.context.logger.severe(
        e.toString(),
        e,
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance
                  .serialize<_i18.ConnectionClosedException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i19.CouldNotRollBackException catch (e, st) {
      const statusCode = 400;
      _i8.context.logger.severe(
        e.toString(),
        e,
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance
                  .serialize<_i19.CouldNotRollBackException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i19.DriftWrappedException catch (e, st) {
      const statusCode = 400;
      _i8.context.logger.severe(
        e.message,
        e,
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance
                  .serialize<_i19.DriftWrappedException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i20.HijackException catch (e, st) {
      const statusCode = 400;
      _i8.context.logger.severe(
        e.toString(),
        e,
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i20.HijackException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i15.HttpException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i21.InvalidCorkException catch (e, st) {
      const statusCode = 400;
      _i8.context.logger.severe(
        e.toString(),
        e,
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance
                  .serialize<_i21.InvalidCorkException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i22.IsolateSpawnException catch (e, st) {
      const statusCode = 400;
      _i8.context.logger.severe(
        e.message,
        e,
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance
                  .serialize<_i22.IsolateSpawnException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i23.JsonUnsupportedObjectError catch (e, st) {
      const statusCode = 500;
      _i8.context.logger.severe(
        e.toString(),
        e,
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance
                  .serialize<_i23.JsonUnsupportedObjectError>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i24.MaximumSizeExceeded catch (e, st) {
      const statusCode = 400;
      _i8.context.logger.severe(
        e.toString(),
        e,
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance
                  .serialize<_i24.MaximumSizeExceeded>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i21.MissingSignatureError catch (e, st) {
      const statusCode = 500;
      _i8.context.logger.severe(
        e.toString(),
        e,
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance
                  .serialize<_i21.MissingSignatureError>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i10.OverflowException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i25.ParserException catch (e, st) {
      const statusCode = 400;
      _i8.context.logger.severe(
        e.message,
        e,
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i25.ParserException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i26.PathException catch (e, st) {
      const statusCode = 400;
      _i8.context.logger.severe(
        e.message,
        e,
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i26.PathException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i15.ProcessException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i15.SignalException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i28.SqliteException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i15.StdinException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i15.StdoutException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i31.TemplateException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i10.TypeException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i7.UnavailableError>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i7.CloudException>(e),
            },
            if (_i8.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i23.JsonUnsupportedObjectError, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
      ...
      deserialize: ($serialized) {
        return _i23.JsonUnsupportedObjectError(
    ...
    _i4.Serializers.instance.put(
      ...
      deserialize: ($serialized) {
        return _i15.CertificateException(
          (($serialized?[r'message'] as String?)) ?? '',
          _i4.Serializers.instance
              .deserialize<_i15.OSError?>($serialized?[r'osError']),
        );
      },
    ));
    _i4.Serializers.instance.put(
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i15.HttpException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i15.OSError, Map<String, Object?>?>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i15.ProcessException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i15.SignalException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i15.StdinException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
        if (_i4.Serializers.instance.serialize<_i15.OSError?>($value.osError)
            case final osError?)
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i15.StdoutException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
        if (_i4.Serializers.instance.serialize<_i15.OSError?>($value.osError)
            case final osError?)
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i15.TlsException, Map<String, Object?>?>(
      serialize: ($value) => <String, Object?>{
        r'type': $value.type,
        r'message': $value.message,
        if (_i4.Serializers.instance.serialize<_i15.OSError?>($value.osError)
    ...
    _i4.Serializers.instance.put(
        _i4.Serializer.define<_i22.IsolateSpawnException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{r'message': $value.message},
      deserialize: ($serialized) {
        return _i22.IsolateSpawnException(($serialized[r'message'] as String));
      },
    ));
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i13.BuiltValueMissingGenericsError, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'type': $value.type,
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i13.BuiltValueNestedFieldError, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'type': $value.type,
        r'field': $value.field,
        r'error': $value.error,
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i13.BuiltValueNullFieldError, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'type': $value.type,
        r'field': $value.field,
      },
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i12.AuthorizationException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i10.ArityException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'name': $value.name,
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i10.AttributeAccessException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'type': $value.type,
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i10.EntityNotFoundException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'entityId':
            _i4.Serializers.instance.serialize<_i33.EntityUid>($value.entityId)
      },
      deserialize: ($serialized) {
        return _i10.EntityNotFoundException(_i4.Serializers.instance
            .deserialize<_i33.EntityUid>($serialized[r'entityId']));
      },
    ));
    _i4.Serializers.instance.put(
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i10.TypeException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{r'message': $value.message},
      deserialize: ($serialized) {
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i10.UnknownExtensionException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{r'name': $value.name},
      deserialize: ($serialized) {
        return _i10.UnknownExtensionException(($serialized[r'name'] as String));
      },
    ));
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i10.UnspecifiedEntityException, Map<String, Object?>?>(
      serialize: ($value) => const <String, Object?>{},
      deserialize: ($serialized) {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i33.EntityUid, Map<String, Object?>>(
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i6.Task, Map<String, dynamic>>(
      serialize: ($value) => $value.toJson(),
      deserialize: ($serialized) {
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i27.SerializationException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'code': $value.code,
        r'message': $value.message,
        if (_i4.Serializers.instance.serialize<_i34.JsonValue?>(
    ...
    _i4.Serializers.instance.put(
        _i4.Serializer.define<_i24.MaximumSizeExceeded, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{r'maxSize': $value.maxSize},
      deserialize: ($serialized) {
        return _i24.MaximumSizeExceeded(
            ($serialized[r'maxSize'] as num).toInt());
      },
    ));
    _i4.Serializers.instance.put(
        _i4.Serializer.define<_i21.InvalidCorkException, Map<String, Object?>?>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
        r'source': $value.source,
        if ($value.offset case final offset?) r'offset': offset,
      ...
      deserialize: ($serialized) {
        return _i21.InvalidCorkException(
            (($serialized?[r'message'] as String?)) ?? '');
      },
    ));
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i21.MissingSignatureError, Map<String, Object?>?>(
      serialize: ($value) => <String, Object?>{r'message': $value.message},
      deserialize: ($serialized) {
        return _i21.MissingSignatureError();
      },
    ));
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i18.ConnectionClosedException, Map<String, Object?>?>(
      serialize: ($value) => const <String, Object?>{},
      deserialize: ($serialized) {
        return _i18.ConnectionClosedException();
      },
    ));
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i14.CancellationException, Map<String, Object?>?>(
      serialize: ($value) => const <String, Object?>{},
      deserialize: ($serialized) {
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i19.CouldNotRollBackException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'cause': $value.cause,
      ...
      deserialize: ($serialized) {
        return _i19.CouldNotRollBackException(
          $serialized[r'cause']!,
          _i4.Serializers.instance
    ...
    _i4.Serializers.instance.put(
        _i4.Serializer.define<_i19.DriftWrappedException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
        if ($value.cause case final cause?) r'cause': cause,
      ...
      deserialize: ($serialized) {
        return _i19.DriftWrappedException(
    ...
    _i4.Serializers.instance.put(
        _i4.Serializer.define<_i17.ConnectionClosed, Map<String, Object?>?>(
      serialize: ($value) => const <String, Object?>{},
      deserialize: ($serialized) {
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i16.ClientException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
        if (_i4.Serializers.instance.serialize<Uri?>($value.uri)
            case final uri?)
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i26.PathException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{r'message': $value.message},
      deserialize: ($serialized) {
        return _i26.PathException(($serialized[r'message'] as String));
      },
    ));
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i25.ParserException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'failure':
            _i4.Serializers.instance.serialize<_i35.Failure>($value.failure),
        r'message': $value.message,
        r'offset': $value.offset,
        r'source': $value.source,
      },
      deserialize: ($serialized) {
        return _i25.ParserException(_i4.Serializers.instance
            .deserialize<_i35.Failure>($serialized[r'failure']));
      },
    ));
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i35.Failure, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i20.HijackException, Map<String, Object?>?>(
      serialize: ($value) => const <String, Object?>{},
      deserialize: ($serialized) {
        return _i20.HijackException();
      },
    ));
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i36.SourceLocation, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i37.SourceSpan, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'start': _i4.Serializers.instance
            .serialize<_i36.SourceLocation>($value.start),
        r'end':
            _i4.Serializers.instance.serialize<_i36.SourceLocation>($value.end),
        r'text': $value.text,
        if (_i4.Serializers.instance.serialize<Uri?>($value.sourceUrl)
            case final sourceUrl?)
          r'sourceUrl': sourceUrl,
      ...
      deserialize: ($serialized) {
        return _i37.SourceSpan(
          _i4.Serializers.instance
              .deserialize<_i36.SourceLocation>($serialized[r'start']),
          _i4.Serializers.instance
              .deserialize<_i36.SourceLocation>($serialized[r'end']),
    ...
    _i4.Serializers.instance.put(
      ...
      deserialize: ($serialized) {
        return _i30.SourceSpanException(
          ($serialized[r'message'] as String),
          _i4.Serializers.instance
              .deserialize<_i37.SourceSpan?>($serialized[r'span']),
        );
      },
    ));
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i30.SourceSpanFormatException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
        if (_i4.Serializers.instance.serialize<_i37.SourceSpan?>($value.span)
            case final span?)
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i28.SqliteException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i32.VfsException, Map<String, Object?>>(
      serialize: ($value) =>
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i29.StringScannerException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
        r'message': $value.message,
        if (_i4.Serializers.instance.serialize<_i37.SourceSpan?>($value.span)
            case final span?)
...
Future<void> start() async {
  await _i1.serve(
    ...
    setup: (_i8.Context context) async {
      await _i38.CelestData.init(context);
      await _i39.CelestAuth.init(context);
    },
  );
}
