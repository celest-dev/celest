...
@cloud
List<Shape> sealedClass({required List<Shape> shapes}) {
  return shapes;
}
...
@cloud
List<Result<T, E>> multipleGenericResult<
  T extends Shape,
  E extends ShapeException
>(T data, E error) => [OkResult(data), ErrResult(error)];
