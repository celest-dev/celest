...
import 'package:celest_backend/models/metadata.dart' as _i5;
...
final class NullablePositionalDefaultValueVarsTarget
  ...
  @override
  String get name => 'nullablePositionalDefaultValueVars';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      _i3.nullablePositionalDefaultValueVars(
        ((request[r'value'] as num?)?.toInt()) ?? _i3.defaultInt,
        ((request[r'doubleValue'] as num?)?.toDouble()) ?? _i3.defaultDouble,
        ((request[r'boolValue'] as bool?)) ?? _i3.defaultBool,
        ((request[r'stringValue'] as String?)) ?? _i3.defaultString,
        ...
        ((request[r'mapValue'] as Map<String, Object?>?)?.map(
            ...
            _i3.defaultMap,
        (_i4.Serializers.instance.deserialize<_i5.LiteralEnum?>(
              request[r'enumValue'],
            )) ??
            _i3.defaultEnum,
        (_i4.Serializers.instance
            ...
            _i3.defaultRecord,
        (_i4.Serializers.instance.deserialize<_i5.Exportable?>(
              request[r'exportable'],
            )) ??
            _i3.defaultExportable,
        (_i4.Serializers.instance.deserialize<_i5.Serializable?>(
              request[r'serializable'],
            )) ??
            _i3.defaultSerializable,
      );
      return _i2.Response(
        200,
  ...
  void init() {
    _i4.Serializers.instance.put(
      _i4.Serializer.define<Record$k7x4l9, Map<String, Object?>>(
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.Exportable, Map<String, Object?>?>(
        serialize: ($value) => const <String, Object?>{},
        deserialize: ($serialized) {
          return _i5.Exportable();
        },
      ),
    );
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.LiteralEnum, String>(
        serialize: ($value) => $value.name,
        deserialize: ($serialized) {
          return _i5.LiteralEnum.values.byName($serialized);
        },
      ),
    );
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.Serializable, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          if ($value.type case final type?) r'type': type,
        },
        deserialize: ($serialized) {
          return _i5.Serializable(($serialized?[r'type'] as String?));
        },
      ),
    );
    _i4.Serializers.instance.put(
...
Future<void> start() async {
  await _i1.serve(
    targets: {'/': NullablePositionalDefaultValueVarsTarget()},
