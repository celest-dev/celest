...
final class NullableJsonTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'nullableJson';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.nullableJson(
        (request[r'json'] as Map<String, Object?>?),
      );
      return _i2.Response(
        200,
