...
final class AsyncOnlyFromJsonTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.asyncOnlyFromJson(
        _i4.Serializers.instance.deserialize<_i5.OnlyFromJson>(
          request[r'value'],
        ),
      );
      return _i2.Response(
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.OnlyFromJson, Map<String, Object?>>(
