...
final class FromAndToJsonTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.fromAndToJson(
        _i4.Serializers.instance.deserialize<_i5.FromJsonAndToJson>(
          request[r'value'],
        ),
      );
      return _i2.Response(
        ...
        body: _i4.JsonUtf8.encode(
          _i4.Serializers.instance.serialize<_i5.FromJsonAndToJson>(response),
        ),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.FromJsonAndToJson, Map<String, Object?>>(
