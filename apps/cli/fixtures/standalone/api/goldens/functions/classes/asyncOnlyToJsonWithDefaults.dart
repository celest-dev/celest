...
final class AsyncOnlyToJsonWithDefaultsTarget
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.asyncOnlyToJsonWithDefaults(
        _i4.Serializers.instance.deserialize<_i5.OnlyToJsonWithDefaults>(
          request[r'value'],
        ),
      );
      return _i2.Response(
        ...
        body: _i4.JsonUtf8.encode(
          _i4.Serializers.instance.serialize<_i5.OnlyToJsonWithDefaults>(
            response,
          ),
        ),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.OnlyToJsonWithDefaults, Map<String, Object?>?>(
