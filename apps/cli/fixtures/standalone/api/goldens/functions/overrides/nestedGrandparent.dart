...
import 'package:_common/_common.dart' as _i10;
import 'package:celest/celest.dart' as _i8;
import 'package:celest/src/core/context.dart' as _i7;
import 'package:celest/src/runtime/serve.dart' as _i1;
import 'package:celest_backend/exceptions/overrides.dart' as _i13;
import 'package:celest_backend/models/overrides.dart' as _i5;
...
final class NestedGrandparentTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.nestedGrandparent(
        _i4.Serializers.instance.deserialize<_i5.NestedGrandparent>(
          request[r'grandparent'],
        ),
      );
      return _i2.Response(
        200,
        ...
        body: _i4.JsonUtf8.encode(
          _i4.Serializers.instance.serialize<_i5.NestedGrandparent>(response),
        ),
      );
    ...
    } on _i10.CommonException catch (e, st) {
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance.serialize<_i10.CommonException>(
                e,
              ),
            },
            if (_i7.context.environment != _i8.Environment.production)
    ...
    } on _i13.OverriddenException catch (e, st) {
      const statusCode = 400;
      _i7.context.logger.severe(e.toString(), e, st);
      final status = {
        '@status': {
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance
                  .serialize<_i13.OverriddenException>(e),
            },
            if (_i7.context.environment != _i8.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i10.CommonException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
          return _i10.CommonException(($serialized[r'message'] as String));
        },
      ),
    );
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i10.CustomException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
          return _i10.CustomException(($serialized[r'message'] as String));
        },
      ),
    );
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i13.OverriddenException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
          return (_i10.OverriddenException(($serialized[r'message'] as String))
              as _i13.OverriddenException);
        },
      ),
    );
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.NestedChild, Map<String, Object?>>(
        serialize: ($value) => $value.toJson(),
        deserialize: ($serialized) {
          return _i5.NestedChild.fromJson($serialized);
        },
      ),
    );
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.NestedGrandparent, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'parent': _i4.Serializers.instance.serialize<_i10.NestedParent>(
                $value.parent,
              ),
            },
        deserialize: ($serialized) {
          return _i5.NestedGrandparent(
            _i4.Serializers.instance.deserialize<_i10.NestedParent>(
              $serialized[r'parent'],
            ),
          );
        },
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.NestedParent, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'child': _i4.Serializers.instance.serialize<_i10.NestedChild>(
                $value.child,
              ),
            },
        deserialize: ($serialized) {
          return (_i10.NestedParent(
                _i4.Serializers.instance.deserialize<_i10.NestedChild>(
                  $serialized[r'child'],
                ),
              )
              as _i5.NestedParent);
...
Future<void> start() async {
  await _i1.serve(
    targets: {'/': NestedGrandparentTarget()},
