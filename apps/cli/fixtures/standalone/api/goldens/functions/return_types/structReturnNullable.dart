...
final class StructReturnNullableTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'structReturnNullable';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.structReturnNullable();
      return _i2.Response(
        200,
        headers: const {'Content-Type': 'application/json'},
        body: _i4.JsonUtf8.encode(
          _i4.Serializers.instance.serialize<_i5.SimpleStruct?>(response),
        ),
      );
...
Future<void> start() async {
  await _i1.serve(
    targets: {'/': StructReturnNullableTarget()},
