...
import 'package:celest_backend/src/functions/collections.dart' as _i3;
...
final class DynamicMapTarget extends _i1.CloudFunctionHttpTarget {
  @override
  String get name => 'dynamicMap';
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.dynamicMap(
        (request[r'map'] as Map<String, Object?>),
      );
      return _i2.Response(
        200,
