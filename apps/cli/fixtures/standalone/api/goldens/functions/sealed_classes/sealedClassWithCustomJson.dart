...
final class SealedClassWithCustomJsonTarget
      ...
      return _i2.Response(
        ...
        body: _i4.JsonUtf8.encode(
          response
              .map(
                (el) => _i4.Serializers.instance
                    .serialize<_i5.ShapeWithCustomJson>(el),
              )
              .toList(),
        ),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.RectangleWithCustomJson, Map<String, Object?>>(
        serialize: ($value) => $value.toJson(),
        deserialize: ($serialized) {
      ...
      _i4.Serializer.define<_i5.ShapeWithCustomJson, Map<String, Object?>>(
        serialize: ($value) {
          if ($value is _i5.CircleWithCustomJson) {
            return {
              ...(_i4.Serializers.instance.serialize<_i5.CircleWithCustomJson>(
                    $value,
                  )
