...
final class GenericResultTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    return switch ($types) {
      ...
      _ => throw _i4.SerializationException(
        'Invalid type parameters: ${$types}',
      ),
    };
  }
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i3.Circle, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i3.Rectangle, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
          r'width': $value.width,
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i3.Shape, Map<String, Object?>>(
        serialize: ($value) {
        ...
        deserialize: ($serialized) {
          if ($serialized[r'$type'] == r'Circle') {
            return _i4.Serializers.instance.deserialize<_i3.Circle>(
              $serialized,
            );
          }
          if ($serialized[r'$type'] == r'Rectangle') {
            return _i4.Serializers.instance.deserialize<_i3.Rectangle>(
              $serialized,
            );
          }
          throw _i4.SerializationException(
