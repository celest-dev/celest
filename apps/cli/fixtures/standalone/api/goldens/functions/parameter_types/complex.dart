...
final class ComplexTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      await _i3.complex(
        _i4.Serializers.instance.deserialize<_i5.SimpleStruct>(
          request[r'aSimpleStruct'],
        ),
        _i4.Serializers.instance.deserialize<_i5.ComplexStruct>(
          request[r'aComplexStruct'],
        ),
        _i4.Serializers.instance.deserialize<_i5.SimpleClass>(
          request[r'aSimpleClass'],
        ),
        _i4.Serializers.instance.deserialize<_i5.ComplexClass>(
        ...
        (request[r'anIterableOfComplexStruct'] as Iterable<Object?>)
            .map(
              (el) =>
                  _i4.Serializers.instance.deserialize<_i5.ComplexStruct>(el),
            )
            .toList(),
        ...
        (request[r'anIterableOfComplexClass'] as Iterable<Object?>)
            .map(
              (el) =>
                  _i4.Serializers.instance.deserialize<_i5.ComplexClass>(el),
            )
            .toList(),
        ...
        (request[r'aMapOfComplexStruct'] as Map<String, Object?>).map(
          (key, value) => MapEntry(
            key,
            _i4.Serializers.instance.deserialize<_i5.ComplexStruct>(value),
          ),
        ),
        ...
        (request[r'aMapOfComplexClass'] as Map<String, Object?>).map(
          (key, value) => MapEntry(
            key,
            _i4.Serializers.instance.deserialize<_i5.ComplexClass>(value),
          ),
        ),
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.ComplexClass, Map<String, dynamic>>(
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.ComplexStruct, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'aBigInt': _i4.Serializers.instance.serialize<BigInt>(
                $value.aBigInt,
              ),
              r'aBool': $value.aBool,
              r'aDateTime': _i4.Serializers.instance.serialize<DateTime>(
                $value.aDateTime,
              ),
              r'aDouble': $value.aDouble,
              r'aDuration': _i4.Serializers.instance.serialize<Duration>(
                $value.aDuration,
              ),
              r'aListOfBigInt':
                  $value.aListOfBigInt
                      .map(
                        (el) => _i4.Serializers.instance.serialize<BigInt>(el),
                      )
                      .toList(),
              ...
              r'aListOfDateTime':
                  $value.aListOfDateTime
                      .map(
                        (el) =>
                            _i4.Serializers.instance.serialize<DateTime>(el),
                      )
                      .toList(),
              ...
              r'aListOfDuration':
                  $value.aListOfDuration
                      .map(
                        (el) =>
                            _i4.Serializers.instance.serialize<Duration>(el),
                      )
                      .toList(),
              r'aListOfEnum':
                  $value.aListOfEnum
                      .map(
                        (el) =>
                            _i4.Serializers.instance.serialize<_i5.MyEnum>(el),
                      )
                      .toList(),
              ...
              r'aListOfRegExp':
                  $value.aListOfRegExp
                      .map(
                        (el) => _i4.Serializers.instance.serialize<RegExp>(el),
                      )
                      .toList(),
              ...
              r'aListOfStackTrace':
                  $value.aListOfStackTrace
                      .map(
                        (el) =>
                            _i4.Serializers.instance.serialize<StackTrace>(el),
                      )
                      .toList(),
              ...
              r'aListOfUriData':
                  $value.aListOfUriData
                      .map(
                        (el) => _i4.Serializers.instance.serialize<UriData>(el),
                      )
                      .toList(),
              ...
              r'aNull': $value.aNull,
              r'aRegExp': _i4.Serializers.instance.serialize<RegExp>(
                $value.aRegExp,
              ),
              ...
              r'aStackTrace': _i4.Serializers.instance.serialize<StackTrace>(
                $value.aStackTrace,
              ),
              ...
              r'aUriData': _i4.Serializers.instance.serialize<UriData>(
                $value.aUriData,
              ),
              r'anEnum': _i4.Serializers.instance.serialize<_i5.MyEnum>(
                $value.anEnum,
              ),
              r'anInt': $value.anInt,
        ...
        deserialize: ($serialized) {
          return (
            aBigInt: _i4.Serializers.instance.deserialize<BigInt>(
              $serialized[r'aBigInt'],
            ),
            aBool: ($serialized[r'aBool'] as bool),
            aDateTime: _i4.Serializers.instance.deserialize<DateTime>(
              $serialized[r'aDateTime'],
            ),
            aDouble: ($serialized[r'aDouble'] as num).toDouble(),
            aDuration: _i4.Serializers.instance.deserialize<Duration>(
              $serialized[r'aDuration'],
            ),
            aListOfBigInt:
                ($serialized[r'aListOfBigInt'] as Iterable<Object?>)
                    .map(
                      (el) => _i4.Serializers.instance.deserialize<BigInt>(el),
                    )
                    .toList(),
            aListOfBool:
            ...
            aListOfDateTime:
                ($serialized[r'aListOfDateTime'] as Iterable<Object?>)
                    .map(
                      (el) =>
                          _i4.Serializers.instance.deserialize<DateTime>(el),
                    )
                    .toList(),
            aListOfDouble:
            ...
            aListOfDuration:
                ($serialized[r'aListOfDuration'] as Iterable<Object?>)
                    .map(
                      (el) =>
                          _i4.Serializers.instance.deserialize<Duration>(el),
                    )
                    .toList(),
            aListOfEnum:
                ($serialized[r'aListOfEnum'] as Iterable<Object?>)
                    .map(
                      (el) =>
                          _i4.Serializers.instance.deserialize<_i5.MyEnum>(el),
                    )
                    .toList(),
            aListOfInt:
            ...
            aListOfRegExp:
                ($serialized[r'aListOfRegExp'] as Iterable<Object?>)
                    .map(
                      (el) => _i4.Serializers.instance.deserialize<RegExp>(el),
                    )
                    .toList(),
            aListOfSimpleClass:
                ($serialized[r'aListOfSimpleClass'] as Iterable<Object?>)
                    .map(
                      (el) => _i4.Serializers.instance
                          .deserialize<_i5.SimpleClass>(el),
                    )
                    .toList(),
            aListOfSimpleStruct:
                ($serialized[r'aListOfSimpleStruct'] as Iterable<Object?>)
                    .map(
                      (el) => _i4.Serializers.instance
                          .deserialize<_i5.SimpleStruct>(el),
                    )
                    .toList(),
            aListOfStackTrace:
                ($serialized[r'aListOfStackTrace'] as Iterable<Object?>)
                    .map(
                      (el) =>
                          _i4.Serializers.instance.deserialize<StackTrace>(el),
                    )
                    .toList(),
            aListOfString:
            ...
            aListOfUriData:
                ($serialized[r'aListOfUriData'] as Iterable<Object?>)
                    .map(
                      (el) => _i4.Serializers.instance.deserialize<UriData>(el),
                    )
                    .toList(),
            ...
            aRegExp: _i4.Serializers.instance.deserialize<RegExp>(
              $serialized[r'aRegExp'],
            ),
            aSimpleClass: _i4.Serializers.instance.deserialize<_i5.SimpleClass>(
              $serialized[r'aSimpleClass'],
            ),
            aSimpleStruct: _i4.Serializers.instance
                .deserialize<_i5.SimpleStruct>($serialized[r'aSimpleStruct']),
            aStackTrace: _i4.Serializers.instance.deserialize<StackTrace>(
            ...
            aUriData: _i4.Serializers.instance.deserialize<UriData>(
              $serialized[r'aUriData'],
            ),
            anEnum: _i4.Serializers.instance.deserialize<_i5.MyEnum>(
              $serialized[r'anEnum'],
            ),
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.SimpleClass, Map<String, dynamic>>(
        serialize: ($value) => $value.toJson(),
        deserialize: ($serialized) {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.SimpleStruct, Map<String, Object?>?>(
        serialize: ($value) => const <String, Object?>{},
        deserialize: ($serialized) {
          return ();
        },
