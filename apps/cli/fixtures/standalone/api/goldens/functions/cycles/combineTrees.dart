...
final class CombineTreesTarget extends _i1.CloudFunctionHttpTarget {
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.Child, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
          r'name': $value.name,
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.Node, Map<String, Object?>>(
        serialize: ($value) {
        ...
        deserialize: ($serialized) {
          if ($serialized[r'$type'] == r'Parent') {
            return _i4.Serializers.instance.deserialize<_i5.Parent>(
              $serialized,
            );
          }
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.Parent, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
          r'name': $value.name,
          r'children': $value.children
              .map((el) => _i4.Serializers.instance.serialize<_i5.Node>(el))
