...
final class SelfReferencingTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.selfReferencing(
        _i4.Serializers.instance.deserialize<_i5.SelfReferencing>(
          request[r'selfReferencing'],
        ),
      );
      return _i2.Response(
        200,
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.SelfReferencing, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
          if (_i4.Serializers.instance.serialize<_i5.SelfReferencing?>(
                $value.value,
              )
              case final value?)
            r'value': value,
          if (_i4.Serializers.instance.serialize<_i5.SelfReferencingWrapper?>(
                $value.wrapper,
              )
              case final wrapper?)
            r'wrapper': wrapper,
            ...
            list: ($serialized[r'list'] as Iterable<Object?>)
                .map(
                  (el) => _i4.Serializers.instance
                      .deserialize<_i5.SelfReferencing>(el),
                )
                .toList(),
          );
        },
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.SelfReferencingWrapper, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
          r'value': _i4.Serializers.instance.serialize<_i5.SelfReferencing>(
            $value.value,
          ),
        },
        deserialize: ($serialized) {
