...
final class AsyncNullableNestedTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.asyncNullableNested(
        _i4.Serializers.instance.deserialize<_i5.NullableNested?>(
          request[r'value'],
        ),
      );
      return _i2.Response(
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.NullableNested, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
          if (_i4.Serializers.instance.serialize<_i5.NamedFieldsRecord?>(
                $value.namedFields,
              )
