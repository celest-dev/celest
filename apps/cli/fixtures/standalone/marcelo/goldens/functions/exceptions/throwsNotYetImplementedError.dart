...
final class ThrowsNotYetImplementedErrorTarget
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance.serialize<_i8.AppError>(e),
            },
            if (_i6.context.environment != _i7.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance.serialize<_i8.AppException>(e),
            },
            if (_i6.context.environment != _i7.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance
                  .serialize<_i8.NotYetImplementedError>(e),
            },
            if (_i6.context.environment != _i7.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance.serialize<_i12.UserException>(
                e,
              ),
            },
            if (_i6.context.environment != _i7.Environment.production)
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance.serialize<_i12.ValidateError>(
                e,
              ),
            },
            if (_i6.context.environment != _i7.Environment.production)
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i12.UserException, Map<String, dynamic>>(
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i12.ValidateError, Map<String, Object?>>(
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i8.AppError, Map<String, Object?>>(
        serialize: ($value) => $value.toJson(),
        deserialize: ($serialized) {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i8.AppException, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i8.NotYetImplementedError, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              r'msg': $value.msg,
              if (_i4.Serializers.instance.serialize<_i13.JsonValue?>(
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<
        _i8.UserException_ShowInConsole,
        Map<String, Object?>
      >(
        serialize:
            ($value) => <String, Object?>{
...
Future<void> start() async {
  await _i1.serve(
    targets: {'/': ThrowsNotYetImplementedErrorTarget()},
