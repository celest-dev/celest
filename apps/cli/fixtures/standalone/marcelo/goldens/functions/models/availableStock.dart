...
final class AvailableStockTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.availableStock(
        _i4.Serializers.instance.deserialize<_i5.AvailableStock>(
          request[r'availableStock'],
        ),
      );
      return _i2.Response(
        200,
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i15.AvailableStock, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
