...
void initSerializers({_$celest.Serializers? serializers}) {
  return runZoned(() {
    ...
    _$celest.Serializers.instance.put(
      _$celest.Serializer.define<
        _$_common_available_stocks.AvailableStocks,
        Map<String, Object?>
      >(
        serialize:
            ($value) => <String, Object?>{
              r'list': _$celest.Serializers.instance.serialize<
                _$fast_immutable_collections_ilist.IList<
                  _$_common_available_stock.AvailableStock
                >
              >($value.list),
            },
        deserialize: ($serialized) {
    ...
    _$celest.Serializers.instance.put(
      _$celest.Serializer.define<
        _$_common_errors_and_exceptions.UserException,
        Map<String, dynamic>
      >(
    ...
    _$celest.Serializers.instance.put(
      _$celest.Serializer.define<
        _$_common_errors_and_exceptions.ValidateError,
        Map<String, Object?>
      >(
    ...
    _$celest.Serializers.instance.put(
      _$celest.Serializer.define<_$_common_ui.ScreenChoice, String>(
    ...
    _$celest.Serializers.instance.put(
      _$celest.Serializer.define<AppError, Map<String, Object?>>(
        serialize: ($value) => $value.toJson(),
        deserialize: ($serialized) {
    ...
    _$celest.Serializers.instance.put(
      _$celest.Serializer.define<AppException, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
    ...
    _$celest.Serializers.instance.put(
      _$celest
          .Serializer.define<UserException_ShowInConsole, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
        ...
        deserialize: ($serialized) {
          return UserException_ShowInConsole(
            ...
            cause: _$celest.Serializers.instance
                .deserialize<_$celest.JsonValue?>(
                  $serialized[r'cause'],
                  const _$celest.TypeToken<_$celest.JsonValue?>('JsonValue'),
                ),
          );
    ...
    _$celest.Serializers.instance.put(
      _$celest.Serializer.define<AvailableStock, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
    ...
    _$celest.Serializers.instance.put(
      _$celest.Serializer.define<CashBalance, Map<String, Object?>>(
    ...
    _$celest.Serializers.instance.put(
      _$celest.Serializer.define<Portfolio, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
    ...
    _$celest.Serializers.instance.put(
      _$celest.Serializer.define<Stock, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'ticker': $value.ticker,
    ...
    _$celest.Serializers.instance.put(
      _$celest.Serializer.define<Ui, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
