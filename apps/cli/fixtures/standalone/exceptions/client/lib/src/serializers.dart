...
void initSerializers({_$celest.Serializers? serializers}) {
  return runZoned(() {
    ...
    _$celest.Serializers.instance.put(
      _$celest.Serializer.define<_$_common__common.OverriddenException, String>(
        serialize: ($value) => $value.toJson(),
        deserialize: ($serialized) {
          return _$_common__common.OverriddenException.fromJson($serialized);
        },
      ),
    );
    _$celest.Serializers.instance.put(
      _$celest.Serializer.define<BaseError, Map<String, Object?>>(
    ...
    _$celest.Serializers.instance.put(
      _$celest.Serializer.define<BaseException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'fault': $value.fault},
        deserialize: ($serialized) {
