...
final class ThrowsBaseExceptionTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance.serialize<_i9.CustomError>(e),
            },
            if (_i6.context.environment != _i7.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance.serialize<_i9.BaseError>(e),
            },
            if (_i6.context.environment != _i7.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance.serialize<_i9.CustomException>(
                e,
              ),
            },
            if (_i6.context.environment != _i7.Environment.production)
    ...
    } on _i9.BaseException catch (e, st) {
      const statusCode = 400;
      _i6.context.logger.severe(e.toString(), e, st);
      final status = {
        '@status': {
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance.serialize<_i9.BaseException>(e),
            },
            if (_i6.context.environment != _i7.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.BaseError, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'fault': $value.fault},
        deserialize: ($serialized) {
          return _i9.BaseError(($serialized[r'fault'] as String));
        },
      ),
    );
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.BaseException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'fault': $value.fault},
        deserialize: ($serialized) {
          return _i9.BaseException(($serialized[r'fault'] as String));
        },
      ),
    );
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.CustomError, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'fault': $value.fault},
        deserialize: ($serialized) {
          return _i9.CustomError(($serialized[r'fault'] as String));
        },
      ),
    );
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.CustomException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'fault': $value.fault},
        deserialize: ($serialized) {
          return _i9.CustomException(($serialized[r'fault'] as String));
        },
      ),
    );
    _i4.Serializers.instance.put(
...
Future<void> start() async {
  await _i1.serve(
    targets: {'/': ThrowsBaseExceptionTarget()},
