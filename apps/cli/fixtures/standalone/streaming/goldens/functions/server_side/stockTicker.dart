...
final class StockTickerTarget extends _i1.CloudEventSourceTarget {
  ...
  Stream<Object?> handle(
    ...
    try {
      await for (final response in _i2.stockTicker(
        queryParameters['symbol']!.first,
      )) {
  ...
  void init() {
    ...
    _i3.Serializers.instance.put(
      _i3.Serializer.define<Error, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              if (_i3.Serializers.instance.serialize<StackTrace?>(
                    $value.stackTrace,
                  )
    ...
    _i3.Serializers.instance.put(
      _i3.Serializer.define<_i4.AvailableStock, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
