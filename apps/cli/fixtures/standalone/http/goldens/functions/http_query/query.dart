...
import 'package:celest_backend/models/http_header_query.dart' as _i5;
import 'package:celest_backend/src/functions/http_query.dart' as _i3;
...
final class QueryTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.query(
      ...
      return _i2.Response(
        ...
        body: _i4.JsonUtf8.encode(
          _i4.Serializers.instance.serialize<_i5.HttpQueryParams>(response),
        ),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.HttpQueryParams, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              ...
              if (_i4.Serializers.instance.serialize<DateTime?>(
                    $value.aNullableDateTime,
                  )
              ...
              r'aListOfDateTime':
                  $value.aListOfDateTime
                      ...
                      .toList(),
              if ($value.aNullableListOfString
                  case final aNullableListOfString?)
              ...
              if ($value.aNullableListOfDouble
                  case final aNullableListOfDouble?)
        ...
        deserialize: ($serialized) {
          return _i5.HttpQueryParams(
            ...
            aNullableDateTime: _i4.Serializers.instance.deserialize<DateTime?>(
              $serialized[r'aNullableDateTime'],
            ),
            aListOfString:
            ...
            aListOfDouble:
                ($serialized[r'aListOfDouble'] as Iterable<Object?>)
                    ...
                    .toList(),
            aListOfNum:
                ($serialized[r'aListOfNum'] as Iterable<Object?>)
                    .map((el) => (el as num))
                    .toList(),
            aListOfBool:
