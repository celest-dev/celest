...
final class HttpErrorsTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      await _i3.httpErrors(
        _i4.Serializers.instance.deserialize<_i5.ExceptionType>(
          request[r'type'],
        ),
      );
      return _i2.Response(
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance.serialize<_i9.BadGatewayError>(
                e,
              ),
            },
            if (_i7.context.environment != _i8.Environment.production)
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance
                  .serialize<_i9.ForbiddenException>(e),
            },
            if (_i7.context.environment != _i8.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.BadGatewayError, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.ExceptionType, String>(
