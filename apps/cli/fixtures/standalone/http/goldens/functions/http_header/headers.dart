...
import 'package:celest_backend/src/functions/http_header.dart' as _i3;
...
final class HeadersTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.headers(
      ...
      return _i2.Response(
        ...
        body: _i4.JsonUtf8.encode(
          _i4.Serializers.instance.serialize<_i5.HttpHeaderParams>(response),
        ),
      );
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.HttpHeaderParams, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
