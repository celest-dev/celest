...
final class SayHelloTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.sayHello(
        user: _i4.context.get(_i4.ContextKey.principal),
      );
      return _i2.Response(
        200,
          ...
          'details': [
            {
              ...
              'value': _i5.Serializers.instance.serialize<_i6.AbortedException>(
                e,
              ),
            },
          ...
          'details': [
            {
              ...
              'value': _i5.Serializers.instance.serialize<_i8.TimeoutException>(
                e,
              ),
            },
            if (_i4.context.environment != _i7.Environment.production)
          ...
          'details': [
            {
              ...
              'value': _i5.Serializers.instance.serialize<_i6.CloudException>(
                e,
              ),
            },
            if (_i4.context.environment != _i7.Environment.production)
  ...
  void init() {
    _i5.Serializers.instance.put(
      _i5.Serializer.define<_i8.AsyncError, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'error': $value.error,
    ...
    _i5.Serializers.instance.put(
      _i5.Serializer.define<_i8.TimeoutException, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
    ...
    _i5.Serializers.instance.put(
      _i5.Serializer.define<_i9.IsolateSpawnException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
    ...
    _i5.Serializers.instance.put(
      _i5.Serializer.define<_i12.User, Map<String, Object?>>(
    ...
    _i5.Serializers.instance.put(
      _i5.Serializer.define<_i6.AbortedException, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
    ...
    _i5.Serializers.instance.put(
      _i5.Serializer.define<_i6.CloudException, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
    ...
    _i5.Serializers.instance.put(
      _i5.Serializer.define<_i6.DataLossError, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
    ...
    _i5.Serializers.instance.put(
      _i5.Serializer.define<_i6.NotFoundException, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
    ...
    _i5.Serializers.instance.put(
      _i5.Serializer.define<_i6.UnavailableError, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
    ...
    _i5.Serializers.instance.put(
      _i5.Serializer.define<_i6.UnknownError, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
    ...
    _i5.Serializers.instance.put(
      _i5.Serializer.define<_i11.SerializationException, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
