...
import 'package:celest_core/src/auth/user.dart' as _i5;
...
final class SayHelloTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.sayHello(
        user: _i4.Serializers.instance.deserialize<_i5.User?>(request[r'user']),
      );
      return _i2.Response(
        200,
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.User, Map<String, Object?>>(
        serialize: ($value) => $value.toJson(),
        deserialize: ($serialized) {
          return _i5.User.fromJson($serialized);
        },
      ),
    );
    _i4.Serializers.instance.put(
