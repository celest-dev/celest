...
final class StreamHelloTarget extends _i1.CloudEventSourceTarget {
  ...
  void init() {
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i9.IsolateSpawnException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i12.User, Map<String, Object?>>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i11.SerializationException, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
