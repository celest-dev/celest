...
import 'package:celest/src/runtime/data/database_registry.dart' as _i14;
...
import 'package:celest_core/src/auth/user.dart' as _i6;
...
final class StreamHelloTarget extends _i1.CloudEventSourceTarget {
  ...
  Stream<Object?> handle(
    ...
    try {
      await for (final response in _i4.streamHello(
        user: _i5.Serializers.instance.deserialize<_i6.User>(request[r'user']),
      )) {
        yield response;
      }
          ...
          'details': [
            {
              ...
              'value': _i5.Serializers.instance.serialize<_i9.AsyncError>(e),
            },
            if (_i3.context.environment != _i8.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value': _i5.Serializers.instance.serialize<_i9.TimeoutException>(
                e,
              ),
            },
            if (_i3.context.environment != _i8.Environment.production)
  ...
  void init() {
    _i5.Serializers.instance.put(
      _i5.Serializer.define<_i9.AsyncError, Map<String, Object?>>(
    ...
    _i5.Serializers.instance.put(
      _i5.Serializer.define<_i9.TimeoutException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
    ...
    _i5.Serializers.instance.put(
      _i5.Serializer.define<_i10.IsolateSpawnException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
    ...
    _i5.Serializers.instance.put(
      _i5.Serializer.define<_i6.User, Map<String, Object?>>(
        serialize: ($value) => $value.toJson(),
        deserialize: ($serialized) {
          return _i6.User.fromJson($serialized);
        },
      ),
    );
    _i5.Serializers.instance.put(
...
Future<void> start() async {
  await _i1.serve(
    ...
    setup: (_i3.Context context) async {
      final $databases = _i14.CelestDatabaseRegistry();
      context.put(_i14.CelestDatabaseRegistry.contextKey, $databases);
      final _cloudAuthCelestDatabase = await _i15.CelestDatabase.create(
        context,
