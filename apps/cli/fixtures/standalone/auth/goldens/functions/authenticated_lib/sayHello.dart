...
import 'package:celest/src/runtime/data/celest_database.dart' as _i15;
...
import 'package:celest_cloud_auth/src/database/auth_database.dart' as _i16;
import 'package:celest_core/celest_core.dart' as _i6;
import 'package:celest_core/src/auth/user.dart' as _i13;
...
final class SayHelloTarget extends _i1.CloudFunctionHttpTarget {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance.serialize<_i7.AbortedException>(
                e,
              ),
            },
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance.serialize<_i9.TimeoutException>(
                e,
              ),
            },
            if (_i3.context.environment != _i8.Environment.production)
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance.serialize<_i7.UnavailableError>(
                e,
              ),
            },
            if (_i3.context.environment != _i8.Environment.production)
  ...
  void init() {
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i9.AsyncError, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'error': $value.error,
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i9.TimeoutException, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<Error, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              if (_i6.Serializers.instance.serialize<StackTrace?>(
                    $value.stackTrace,
                  )
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i10.IsolateSpawnException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i13.User, Map<String, Object?>>(
        serialize: ($value) => $value.toJson(),
        deserialize: ($serialized) {
          return _i13.User.fromJson($serialized);
        },
      ),
    );
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i7.AbortedException, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i7.CloudException, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i7.DataLossError, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i7.UnavailableError, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i7.UnknownError, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i12.SerializationException, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
...
Future<void> start() async {
  await _i1.serve(
    ...
    setup: (_i3.Context context) async {
      final cloudAuth = await _i15.CelestDatabase.create(
        context,
        name: 'CloudAuthDatabase',
        factory: _i16.CloudAuthDatabase.new,
        hostnameVariable: const _i8.env('CLOUD_AUTH_DATABASE_HOST'),
        tokenSecret: const _i8.secret('CLOUD_AUTH_DATABASE_TOKEN'),
      );
      context.put(_i17.CelestData.cloudAuth$Key, await cloudAuth.connect());
