...
import 'package:celest/src/runtime/data/celest_database.dart' as _i16;
import 'package:celest/src/runtime/data/database_registry.dart' as _i15;
import 'package:celest/src/runtime/serve.dart' as _i1;
import 'package:celest_backend/src/functions/authenticated_lib.dart' as _i5;
import 'package:celest_backend/src/generated/data.celest.dart' as _i18;
import 'package:celest_cloud_auth/celest_cloud_auth.dart' as _i2;
import 'package:celest_cloud_auth/src/database/auth_database.dart' as _i17;
...
final class SayHelloTarget extends _i1.CloudFunctionHttpTarget {
  ...
  List<_i1.Middleware> get middlewares => [
    _i1.Middleware.shelf(_i2.CelestCloudAuth.of(_i3.context).middleware.call),
  ];
  ...
  Future<_i4.Response> handle(
    ...
    try {
      final response = await _i5.sayHello(
        user: _i6.Serializers.instance.deserialize<_i7.User>(request[r'user']),
      );
      return _i4.Response(
        200,
    ...
    } on _i8.AbortedException catch (e, st) {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance.serialize<_i8.AbortedException>(
                e,
              ),
            },
            if (_i3.context.environment != _i9.Environment.production)
              {
    ...
    } on _i8.AlreadyExistsException catch (e, st) {
      const statusCode = 409;
      _i3.context.logger.severe(e.message, e, st);
      final status = {
        '@status': {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance
                  .serialize<_i8.AlreadyExistsException>(e),
            },
            if (_i3.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance.serialize<_i10.AsyncError>(e),
            },
            if (_i3.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i8.CancelledException catch (e, st) {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance
                  .serialize<_i8.CancelledException>(e),
            },
            if (_i3.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i8.DataLossError catch (e, st) {
      const statusCode = 500;
      _i3.context.logger.severe(e.message, e, st);
      final status = {
        '@status': {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance.serialize<_i8.DataLossError>(e),
            },
            if (_i3.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i8.DeadlineExceededError catch (e, st) {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance
                  .serialize<_i8.DeadlineExceededError>(e),
            },
            if (_i3.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i8.FailedPreconditionException catch (e, st) {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance
                  .serialize<_i8.FailedPreconditionException>(e),
            },
            if (_i3.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i8.InternalServerError catch (e, st) {
      const statusCode = 500;
      _i3.context.logger.severe(e.message, e, st);
      final status = {
        '@status': {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance
                  .serialize<_i8.InternalServerError>(e),
            },
            if (_i3.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i8.NotFoundException catch (e, st) {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance
                  .serialize<_i8.NotFoundException>(e),
            },
            if (_i3.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i8.OutOfRangeException catch (e, st) {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance
                  .serialize<_i8.OutOfRangeException>(e),
            },
            if (_i3.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i8.PermissionDeniedException catch (e, st) {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance
                  .serialize<_i8.PermissionDeniedException>(e),
            },
            if (_i3.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i8.ResourceExhaustedException catch (e, st) {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance
                  .serialize<_i8.ResourceExhaustedException>(e),
            },
            if (_i3.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i8.BadRequestException catch (e, st) {
      const statusCode = 400;
      _i3.context.logger.severe(e.message, e, st);
      final status = {
        '@status': {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance
                  .serialize<_i8.BadRequestException>(e),
            },
            if (_i3.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance.serialize<StackOverflowError>(
                e,
              ),
            },
            if (_i3.context.environment != _i9.Environment.production)
    ...
    } on _i8.UnauthorizedException catch (e, st) {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance
                  .serialize<_i8.UnauthorizedException>(e),
            },
            if (_i3.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i8.UnavailableError catch (e, st) {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance.serialize<_i8.UnavailableError>(
                e,
              ),
            },
            if (_i3.context.environment != _i9.Environment.production)
    ...
    } on _i8.UnimplementedError catch (e, st) {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance
                  .serialize<_i8.UnimplementedError>(e),
            },
            if (_i3.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance.serialize<UnimplementedError>(
                e,
              ),
            },
            if (_i3.context.environment != _i9.Environment.production)
    ...
    } on _i8.UnknownError catch (e, st) {
      const statusCode = 500;
      _i3.context.logger.severe(e.message, e, st);
      final status = {
        '@status': {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance.serialize<_i8.UnknownError>(e),
            },
            if (_i3.context.environment != _i9.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
    ...
    } on _i8.CloudException catch (e, st) {
      const statusCode = 400;
      _i3.context.logger.severe(e.message, e, st);
      final status = {
        '@status': {
          ...
          'details': [
            {
              ...
              'value': _i6.Serializers.instance.serialize<_i8.CloudException>(
                e,
              ),
            },
            if (_i3.context.environment != _i9.Environment.production)
  ...
  void init() {
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i10.AsyncError, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
          r'error': $value.error,
          r'stackTrace': _i6.Serializers.instance.serialize<StackTrace>(
            $value.stackTrace,
          ),
        },
        deserialize: ($serialized) {
          return _i10.AsyncError(
            $serialized[r'error']!,
            _i6.Serializers.instance.deserialize<StackTrace?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i10.TimeoutException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
        ...
        deserialize: ($serialized) {
          return _i10.TimeoutException(
            ...
            _i6.Serializers.instance.deserialize<Duration?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<ArgumentError, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<AssertionError, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          if ($value.message case final message?) r'message': message,
        },
        deserialize: ($serialized) {
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<ConcurrentModificationError, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<Error, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<Exception, Map<String, Object?>?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<FormatException, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'message': $value.message,
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<IndexError, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
          if ($value.name case final name?) r'name': name,
          r'message': $value.message,
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<OutOfMemoryError, Map<String, Object?>?>(
        serialize: ($value) => const <String, Object?>{},
        deserialize: ($serialized) {
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<RangeError, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
          if ($value.name case final name?) r'name': name,
          r'message': $value.message,
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<StackOverflowError, Map<String, Object?>?>(
        serialize: ($value) => const <String, Object?>{},
        deserialize: ($serialized) {
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<StateError, Map<String, Object?>>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<TypeError, Map<String, Object?>?>(
        serialize: ($value) => const <String, Object?>{},
        deserialize: ($serialized) {
          return TypeError();
        },
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<UnimplementedError, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          if ($value.message case final message?) r'message': message,
        },
        deserialize: ($serialized) {
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<UnsupportedError, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
          if ($value.message case final message?) r'message': message,
        },
        deserialize: ($serialized) {
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i11.IsolateSpawnException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i7.User, Map<String, Object?>>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i8.AbortedException, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
          if (_i6.Serializers.instance.serialize<_i14.JsonValue?>(
                $value.details,
                const _i6.TypeToken<_i14.JsonValue?>('JsonValue'),
              )
              case final details?)
            r'details': details,
        },
        deserialize: ($serialized) {
          return _i8.AbortedException(
            ($serialized?[r'message'] as String?),
            _i6.Serializers.instance.deserialize<_i14.JsonValue?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i8.AlreadyExistsException, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
          if (_i6.Serializers.instance.serialize<_i14.JsonValue?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i8.BadRequestException, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
          if (_i6.Serializers.instance.serialize<_i14.JsonValue?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i8.CancelledException, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
          if (_i6.Serializers.instance.serialize<_i14.JsonValue?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i8.CloudException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
          if (_i6.Serializers.instance.serialize<_i14.JsonValue?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i8.DataLossError, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
          if (_i6.Serializers.instance.serialize<_i14.JsonValue?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i8.DeadlineExceededError, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
          if (_i6.Serializers.instance.serialize<_i14.JsonValue?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<
        _i8.FailedPreconditionException,
        Map<String, Object?>?
      >(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i8.InternalServerError, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
          if (_i6.Serializers.instance.serialize<_i14.JsonValue?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i8.NotFoundException, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
          if (_i6.Serializers.instance.serialize<_i14.JsonValue?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i8.OutOfRangeException, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
          if (_i6.Serializers.instance.serialize<_i14.JsonValue?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<
        _i8.ResourceExhaustedException,
        Map<String, Object?>?
      >(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i8.UnauthorizedException, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
          if (_i6.Serializers.instance.serialize<_i14.JsonValue?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i8.UnavailableError, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
          if (_i6.Serializers.instance.serialize<_i14.JsonValue?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i8.UnimplementedError, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
          if (_i6.Serializers.instance.serialize<_i14.JsonValue?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i8.UnknownError, Map<String, Object?>?>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
          if (_i6.Serializers.instance.serialize<_i14.JsonValue?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i13.SerializationException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{
          r'code': $value.code,
          r'message': $value.message,
          if (_i6.Serializers.instance.serialize<_i14.JsonValue?>(
    ...
    _i6.Serializers.instance.put(
      _i6.Serializer.define<_i14.JsonValue, Object>(
...
Future<void> start() async {
  await _i1.serve(
    ...
    setup: (_i3.Context context) async {
      final $databases = _i15.CelestDatabaseRegistry();
      context.put(_i15.CelestDatabaseRegistry.contextKey, $databases);
      final _cloudAuthCelestDatabase = await _i16.CelestDatabase.create(
        context,
        name: 'CloudAuthDatabase',
        factory: _i17.CloudAuthDatabase.new,
        hostnameVariable: const _i9.env('CLOUD_AUTH_DATABASE_HOST'),
        tokenSecret: const _i9.secret('CLOUD_AUTH_DATABASE_TOKEN'),
      );
      final cloudAuth = await _cloudAuthCelestDatabase.connect();
      context.put(_i18.CelestData.cloudAuth$Key, cloudAuth);
      $databases.register(
      ...
      final $cloudAuth = await _i2.CelestCloudAuth.create(database: cloudAuth);
      context.router.mount('/v1alpha1/auth/', $cloudAuth.handler);
      context.put(_i2.CelestCloudAuth.contextKey, $cloudAuth);
    },
  );
}
