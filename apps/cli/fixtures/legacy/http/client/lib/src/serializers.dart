...
void initSerializers({_$celest.Serializers? serializers}) {
  return runZoned(() {
    ...
    _$celest.Serializers.instance.put(
      _$celest
          .Serializer.define<AnotherNotFoundException, Map<String, Object?>?>(
        serialize: ($value) => const <String, Object?>{},
        deserialize: ($serialized) {
    ...
    _$celest.Serializers.instance.put(
      _$celest
          .Serializer.define<CustomBadRequestException, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
    ...
    _$celest.Serializers.instance.put(
      _$celest.Serializer.define<ExceptionType, String>(
      ...
      _$celest.Serializer.define<HttpHeaderParams, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              ...
              if (_$celest.Serializers.instance.serialize<DateTime?>(
