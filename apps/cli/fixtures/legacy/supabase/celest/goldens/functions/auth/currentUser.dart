...
final class CurrentUserTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i5.Response> handle(
    ...
    try {
      ...
      _i2.context.logger.severe(e.message, e, st);
      final status = {
        '@status': {
          'code': statusCode,
          'message': e.message,
      ...
      _i2.context.logger.severe(e.toString(), e, st);
      final status = {
        '@status': {
          'code': statusCode,
          'message': null,
  ...
  void init() {
    ...
    _i7.Serializers.instance.put(
      _i7.Serializer.define<
        _i4.JsonUnsupportedObjectError,
        Map<String, Object?>
      >(
        serialize:
            ($value) => <String, Object?>{
    ...
    _i7.Serializers.instance.put(
      _i7.Serializer.define<Error, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              if (_i7.Serializers.instance.serialize<StackTrace?>(
                    $value.stackTrace,
                  )
    ...
    _i7.Serializers.instance.put(
      _i7.Serializer.define<_i8.User, Map<String, Object?>>(
      ...
      _i7.Serializer.define<_i9.AbortedException, Map<String, Object?>?>(
        ...
        deserialize: ($serialized) {
          return _i9.AbortedException(
            ($serialized?[r'message'] as String?),
            _i7.Serializers.instance.deserialize<_i12.JsonValue?>(
    ...
    _i7.Serializers.instance.put(
      _i7.Serializer.define<_i11.SerializationException, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'code': $value.code,
              r'message': $value.message,
