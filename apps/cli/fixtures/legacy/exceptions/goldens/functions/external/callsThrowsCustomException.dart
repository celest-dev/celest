...
final class CallsThrowsCustomExceptionTarget
  ...
  Future<_i2.Response> handle(
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance.serialize<_i9.CommonException>(
                e,
              ),
            },
            if (_i6.context.environment != _i7.Environment.production)
    ...
    } on _i9.OverriddenException catch (e, st) {
      const statusCode = 400;
      _i6.context.logger.severe(e.message, e, st);
      final status = {
        '@status': {
          ...
          'details': [
            {
              '@type': '_common.OverriddenException',
              'value': _i4.Serializers.instance
                  .serialize<_i9.OverriddenException>(e),
            },
            if (_i6.context.environment != _i7.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.CommonException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.OverriddenException, String>(
        serialize: ($value) => $value.toJson(),
        deserialize: ($serialized) {
          return _i9.OverriddenException.fromJson($serialized);
        },
      ),
    );
    _i4.Serializers.instance.put(
