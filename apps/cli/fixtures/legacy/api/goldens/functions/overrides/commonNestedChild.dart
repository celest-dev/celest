...
final class CommonNestedChildTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = _i3.commonNestedChild(
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance.serialize<_i5.CommonException>(
                e,
              ),
            },
            if (_i7.context.environment != _i8.Environment.production)
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance.serialize<_i5.CustomException>(
                e,
              ),
            },
            if (_i7.context.environment != _i8.Environment.production)
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.CustomException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
