...
final class GenericWrapperParametersTarget extends _i1.CloudFunctionHttpTarget {
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i9.AbortedException>(e),
            },
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i12.TimeoutException>(e),
            },
            if (_i10.context.environment != _i11.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i9.UnavailableError>(e),
            },
            if (_i10.context.environment != _i11.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value':
                  _i4.Serializers.instance.serialize<_i9.CloudException>(e),
            },
            if (_i10.context.environment != _i11.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
  ...
  void init() {
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i12.AsyncError, Map<String, Object?>>(
    ...
    _i4.Serializers.instance
        .put(_i4.Serializer.define<_i12.TimeoutException, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i13.JsonUnsupportedObjectError, Map<String, Object?>>(
      serialize: ($value) => <String, Object?>{
    ...
    _i4.Serializers.instance.put(_i4.Serializer.define<
        _i9.AlreadyExistsException, Map<String, Object?>?>(
      serialize: ($value) => <String, Object?>{
        r'code': $value.code,
        r'message': $value.message,
        if (_i4.Serializers.instance.serialize<_i15.JsonValue?>(
