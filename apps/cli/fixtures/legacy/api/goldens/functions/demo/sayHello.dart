...
import 'package:celest_backend/exceptions/demo.dart' as _i10;
...
final class SayHelloTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.sayHello(
        person: _i4.Serializers.instance.deserialize<_i5.Person>(
          request[r'person'],
        ),
      );
      return _i2.Response(
    ...
    } on _i10.BadNameException catch (e, st) {
      ...
      final status = {
        '@status': {
          ...
          'details': [
            {
              '@type': 'api.v1.BadNameException',
              'value': _i4.Serializers.instance
                  .serialize<_i10.BadNameException>(e),
            },
            if (_i7.context.environment != _i8.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i10.BadNameException, Map<String, Object?>>(
        serialize: ($value) => <String, Object?>{r'message': $value.message},
        deserialize: ($serialized) {
          return _i10.BadNameException(($serialized[r'message'] as String));
        },
      ),
    );
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.Person, Map<String, Object?>>(
