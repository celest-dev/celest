...
final class AsyncOnlyToJsonTarget extends _i1.CloudFunctionHttpTarget {
  ...
  Future<_i2.Response> handle(
    ...
    try {
      final response = await _i3.asyncOnlyToJson(
        _i4.Serializers.instance.deserialize<_i5.OnlyToJson>(request[r'value']),
      );
      return _i2.Response(
        200,
  ...
  void init() {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i5.OnlyToJson, Map<String, Object?>>(
