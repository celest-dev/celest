...
final class HelloWorldTarget extends _i1.CloudFunctionHttpTarget {
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance
                  .serialize<_i9.HandshakeException>(e),
            },
            if (_i6.context.environment != _i7.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance.serialize<_i9.SignalException>(
                e,
              ),
            },
            if (_i6.context.environment != _i7.Environment.production)
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance.serialize<_i9.StdinException>(
                e,
              ),
            },
            if (_i6.context.environment != _i7.Environment.production)
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance.serialize<_i9.StdoutException>(
                e,
              ),
            },
            if (_i6.context.environment != _i7.Environment.production)
          ...
          'details': [
            {
              ...
              'value': _i4.Serializers.instance
                  .serialize<_i9.WebSocketException>(e),
            },
            if (_i6.context.environment != _i7.Environment.production)
              {
                '@type': 'dart.core.StackTrace',
  ...
  void init() {
      ...
      _i4.Serializer.define<_i9.CertificateException, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              r'type': $value.type,
              r'message': $value.message,
              if (_i4.Serializers.instance.serialize<_i9.OSError?>(
                    $value.osError,
                  )
                  case final osError?)
                r'osError': osError,
        ...
        deserialize: ($serialized) {
          return _i9.CertificateException(
            (($serialized?[r'message'] as String?)) ?? '',
            _i4.Serializers.instance.deserialize<_i9.OSError?>(
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.HttpException, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'message': $value.message,
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.OSError, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              r'message': $value.message,
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.ProcessException, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.SignalException, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'message': $value.message,
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.StdinException, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'message': $value.message,
              if (_i4.Serializers.instance.serialize<_i9.OSError?>(
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.StdoutException, Map<String, Object?>>(
        serialize:
            ($value) => <String, Object?>{
              r'message': $value.message,
              if (_i4.Serializers.instance.serialize<_i9.OSError?>(
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i9.TlsException, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
              r'type': $value.type,
              r'message': $value.message,
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i3.HelloWorld, Map<String, Object?>?>(
        serialize:
            ($value) => <String, Object?>{
        ...
        deserialize: ($serialized) {
          return _i3.HelloWorld(
            key: _i4.Serializers.instance.deserialize<_i14.Key?>(
              $serialized?[r'key'],
            ),
          );
        },
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<_i14.Key, Map<String, Object?>>(
        serialize: ($value) => const <String, Object?>{},
        deserialize: ($serialized) {
    ...
    _i4.Serializers.instance.put(
      _i4.Serializer.define<
        _i12.NetworkImageLoadException,
        Map<String, Object?>
      >(
        serialize:
            ($value) => <String, Object?>{
