...
final class AsyncOrMapReturnTarget extends _i1.CelestFunctionTarget {
  AsyncOrMapReturnTarget()
      : super(
          (
            request,
            context,
            ...
            final response = await _i3.asyncOrMapReturn(celestContext);
