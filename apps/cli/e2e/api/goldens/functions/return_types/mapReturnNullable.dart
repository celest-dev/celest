...
final class MapReturnNullableTarget extends _i1.CelestFunctionTarget {
  MapReturnNullableTarget()
      : super(
          (
            request,
            context,
            ...
            final response = _i3.mapReturnNullable(celestContext);
