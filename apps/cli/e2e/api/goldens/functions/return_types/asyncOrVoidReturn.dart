...
final class AsyncOrVoidReturnTarget extends _i1.CelestFunctionTarget {
  AsyncOrVoidReturnTarget()
      : super(
          (
            request,
            context,
            ...
            _i3.asyncOrVoidReturn(celestContext);
