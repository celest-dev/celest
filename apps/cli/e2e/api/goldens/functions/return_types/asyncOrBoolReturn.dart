...
final class AsyncOrBoolReturnTarget extends _i1.CelestFunctionTarget {
  AsyncOrBoolReturnTarget()
      : super(
          (
            request,
            context,
            ...
            final response = await _i3.asyncOrBoolReturn(celestContext);
