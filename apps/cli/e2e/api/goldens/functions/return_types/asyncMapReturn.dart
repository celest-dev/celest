...
final class AsyncMapReturnTarget extends _i1.CelestFunctionTarget {
  AsyncMapReturnTarget()
      : super(
          (
            request,
            context,
            ...
            final response = await _i3.asyncMapReturn(celestContext);
