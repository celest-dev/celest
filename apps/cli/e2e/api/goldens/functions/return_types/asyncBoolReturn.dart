...
final class AsyncBoolReturnTarget extends _i1.CelestFunctionTarget {
  AsyncBoolReturnTarget()
      : super(
          (
            request,
            context,
            ...
            final response = await _i3.asyncBoolReturn(celestContext);
