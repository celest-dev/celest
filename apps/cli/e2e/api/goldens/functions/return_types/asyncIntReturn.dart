...
final class AsyncIntReturnTarget extends _i1.CelestFunctionTarget {
  AsyncIntReturnTarget()
      : super(
          (
            request,
            context,
            ...
            final response = await _i3.asyncIntReturn(celestContext);
