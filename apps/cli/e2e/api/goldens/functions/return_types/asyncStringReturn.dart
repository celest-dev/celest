...
final class AsyncStringReturnTarget extends _i1.CelestFunctionTarget {
  AsyncStringReturnTarget()
      : super(
          (
            request,
            context,
            ...
            final response = await _i3.asyncStringReturn(celestContext);
