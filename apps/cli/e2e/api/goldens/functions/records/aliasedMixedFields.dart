...
final class AliasedMixedFieldsTarget extends _i1.CelestFunctionTarget {
  AliasedMixedFieldsTarget()
      : super(
          (
            request,
            context,
          ) async {
            final response = _i2.aliasedMixedFields(_i3.Serializers.scoped
