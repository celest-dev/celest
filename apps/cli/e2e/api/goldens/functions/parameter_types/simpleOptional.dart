...
final class SimpleOptionalTarget extends _i1.CelestFunctionTarget {
  SimpleOptionalTarget()
      : super(
          (
            request,
            context,
            ...
            _i2.simpleOptional(
              ...
              (request[r'anIterableOfUint8List'] as Iterable<Object?>?)
                  ?.map((el) =>
                      _i3.Serializers.instance.deserialize<_i4.Uint8List>(el))
                  .toList(),
              ...
              (request[r'aListOfEnum'] as Iterable<Object?>?)
                  ?.map((el) =>
                      _i3.Serializers.instance.deserialize<_i2.MyEnum>(el))
                  .toList(),
              ...
              (request[r'aListOfBigInt'] as Iterable<Object?>?)
                  ?.map(
                      (el) => _i3.Serializers.instance.deserialize<BigInt>(el))
                  .toList(),
              (request[r'aListOfDateTime'] as Iterable<Object?>?)
                  ?.map((el) =>
                      _i3.Serializers.instance.deserialize<DateTime>(el))
                  .toList(),
              (request[r'aListOfDuration'] as Iterable<Object?>?)
                  ?.map((el) =>
                      _i3.Serializers.instance.deserialize<Duration>(el))
                  .toList(),
              (request[r'aListOfRegExp'] as Iterable<Object?>?)
                  ?.map(
                      (el) => _i3.Serializers.instance.deserialize<RegExp>(el))
                  .toList(),
              (request[r'aListOfStackTrace'] as Iterable<Object?>?)
                  ?.map((el) =>
                      _i3.Serializers.instance.deserialize<StackTrace>(el))
                  .toList(),
              ...
              (request[r'aListOfUriData'] as Iterable<Object?>?)
                  ?.map(
                      (el) => _i3.Serializers.instance.deserialize<UriData>(el))
                  .toList(),
