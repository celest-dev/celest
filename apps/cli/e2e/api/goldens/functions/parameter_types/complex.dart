...
final class ComplexStructSerializer extends _i3.Serializer<_i2.ComplexStruct> {
  ...
  _i2.ComplexStruct deserialize(Object? value) {
    ...
    return (
      ...
      aListOfSimpleClass: (serialized[r'aListOfSimpleClass']
              as Iterable<Object?>)
          .map(
              (el) => _i3.Serializers.instance.deserialize<_i2.SimpleClass>(el))
          .toList(),
      aListOfSimpleStruct:
      ...
      aListOfUint8List: (serialized[r'aListOfUint8List'] as Iterable<Object?>)
          .map((el) => _i3.Serializers.instance.deserialize<_i6.Uint8List>(el))
          .toList(),
      ...
      aMapOfUint8List:
        ...
        value,
              ...
              MapEntry(
                key,
                _i3.Serializers.instance.deserialize<_i6.Uint8List>(value),
              )),
      ...
      anEnum: _i3.Serializers.instance
          .deserialize<_i2.MyEnum>(serialized[r'anEnum']),
  ...
  Map<String, Object?> serialize(_i2.ComplexStruct value) => {
        ...
        r'aListOfEnum': value.aListOfEnum
            .map((el) => _i3.Serializers.instance.serialize<_i2.MyEnum>(el))
            .toList(),
        ...
        r'aListOfSimpleClass': value.aListOfSimpleClass
            .map(
                (el) => _i3.Serializers.instance.serialize<_i2.SimpleClass>(el))
            .toList(),
        r'aListOfSimpleStruct': value.aListOfSimpleStruct
            .map((el) =>
                _i3.Serializers.instance.serialize<_i2.SimpleStruct>(el))
            .toList(),
        ...
        r'aListOfUint8List': value.aListOfUint8List
            .map((el) => _i3.Serializers.instance.serialize<_i6.Uint8List>(el))
            .toList(),
        ...
        r'aMapOfEnum': value.aMapOfEnum.map((
          ...
          value,
            ...
            MapEntry(
              key,
              _i3.Serializers.instance.serialize<_i2.MyEnum>(value),
            )),
        ...
        r'aMapOfSimpleClass': value.aMapOfSimpleClass.map((
          ...
          value,
            ...
            MapEntry(
              key,
              _i3.Serializers.instance.serialize<_i2.SimpleClass>(value),
            )),
        r'aMapOfSimpleStruct': value.aMapOfSimpleStruct.map((
          ...
          value,
            ...
            MapEntry(
              key,
              _i3.Serializers.instance.serialize<_i2.SimpleStruct>(value),
            )),
        ...
        r'aMapOfUint8List': value.aMapOfUint8List.map((
          ...
          value,
            ...
            MapEntry(
              key,
              _i3.Serializers.instance.serialize<_i6.Uint8List>(value),
            )),
        ...
        r'aUint8List':
            _i3.Serializers.instance.serialize<_i6.Uint8List>(value.aUint8List),
        r'aUri': _i3.Serializers.instance.serialize<Uri>(value.aUri),
        r'aUriData':
            _i3.Serializers.instance.serialize<UriData>(value.aUriData),
        r'anEnum': _i3.Serializers.instance.serialize<_i2.MyEnum>(value.anEnum),
        r'anInt': value.anInt,
