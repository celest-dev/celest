...
class NullableFieldsTarget extends _i1.FunctionTarget {
  final _inner = _i1.JsonWithContextFunctionTarget(
    (
      ...
      final response = _i2.nullableFields(request[r'value'] == null
          ? null
          : _i2.Fields(
              (request[r'value'][r'superField'] as String),
