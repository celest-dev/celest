...
class AsyncFromAndToJsonTarget extends _i1.FunctionTarget {
  final _inner = _i1.JsonWithContextFunctionTarget(
    (
      request,
      context,
    ) async {
      final response = await _i2.asyncFromAndToJson(
          _i3.Serializers.instance.deserializeWithType<_i2.FromJsonAndToJson>(
        r'project:apis/serialization.dart#FromJsonAndToJson',
        request[r'value'],
      ));
...
final class FromJsonAndToJsonSerializer
  ...
  @override
  String get dartType => r'project:apis/serialization.dart#FromJsonAndToJson';
