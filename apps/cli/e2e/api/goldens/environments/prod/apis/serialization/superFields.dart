...
class SuperFieldsTarget extends _i1.FunctionTarget {
  final _inner = _i1.JsonWithContextFunctionTarget(
    (
      ...
      final response = _i2.superFields(
          _i2.SuperFields((request[r'value'][r'superField'] as String)));
      return {'superField': response.superField};
    },
