...
class AsyncNonMapFromAndToJsonTarget extends _i1.FunctionTarget {
  final _inner = _i1.JsonWithContextFunctionTarget(
    (
      request,
      context,
    ) async {
      final response = await _i2.asyncNonMapFromAndToJson(
          _i3.Serializers.instance.deserializeWithType<_i2.NonMapFromAndToJson>(
        r'project:apis/serialization.dart#NonMapFromAndToJson',
        request[r'value'],
      ));
...
final class NonMapFromAndToJsonSerializer
  ...
  @override
  String get dartType => r'project:apis/serialization.dart#NonMapFromAndToJson';
