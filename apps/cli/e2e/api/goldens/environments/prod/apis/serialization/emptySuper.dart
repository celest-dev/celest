...
class EmptySuperTarget extends _i1.FunctionTarget {
  final _inner = _i1.JsonWithContextFunctionTarget(
    (
      ...
      final response = _i2.emptySuper(
        ...
        r'project:apis/serialization.dart#EmptySuper',
        request[r'value'],
      ));
...
final class EmptySuperSerializer extends _i3.Serializer<_i2.EmptySuper> {
  ...
  @override
  String get dartType => r'project:apis/serialization.dart#EmptySuper';
