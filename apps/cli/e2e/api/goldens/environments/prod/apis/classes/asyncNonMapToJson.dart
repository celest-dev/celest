...
class AsyncNonMapToJsonTarget extends _i1.FunctionTarget {
  final _inner = _i1.JsonWithContextFunctionTarget(
    (
      request,
      context,
    ) async {
      final response = await _i2.asyncNonMapToJson(
...
final class NonMapToJsonSerializer extends _i3.Serializer<_i2.NonMapToJson> {
  ...
  @override
  String get dartType => r'project:apis/classes.dart#NonMapToJson';
