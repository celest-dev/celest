            ...
            : (
                ...
                aListOfStackTrace: (request[r'aNullableComplexStruct']
                  ...
                  return _i3.Serializers.instance
                      .deserializeWithType<StackTrace>(
                    'dart:core#StackTrace',
                    el,
                  );
                }).toList(),
