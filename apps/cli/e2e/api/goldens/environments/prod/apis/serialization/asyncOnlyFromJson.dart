...
class AsyncOnlyFromJsonTarget extends _i1.FunctionTarget {
  final _inner = _i1.JsonWithContextFunctionTarget(
    (
      request,
      context,
    ) async {
      final response = await _i2.asyncOnlyFromJson(
          _i3.Serializers.instance.deserializeWithType<_i2.OnlyFromJson>(
        r'project:apis/serialization.dart#OnlyFromJson',
        request[r'value'],
      ));
...
final class OnlyFromJsonSerializer extends _i3.Serializer<_i2.OnlyFromJson> {
  ...
  @override
  String get dartType => r'project:apis/serialization.dart#OnlyFromJson';
