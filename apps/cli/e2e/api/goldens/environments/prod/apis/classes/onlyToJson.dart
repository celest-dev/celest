...
class OnlyToJsonTarget extends _i1.FunctionTarget {
  final _inner = _i1.JsonWithContextFunctionTarget(
    (
      request,
      context,
    ) async {
      final response = _i2.onlyToJson(
          _i3.Serializers.instance.deserializeWithType<_i2.OnlyToJson>(
        r'project:apis/classes.dart#OnlyToJson',
        request[r'value'],
      ));
...
final class OnlyToJsonSerializer extends _i3.Serializer<_i2.OnlyToJson> {
  ...
  @override
  String get dartType => r'project:apis/classes.dart#OnlyToJson';
