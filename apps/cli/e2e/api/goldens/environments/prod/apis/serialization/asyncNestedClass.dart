...
class AsyncNestedClassTarget extends _i1.FunctionTarget {
  final _inner = _i1.JsonWithContextFunctionTarget(
    (
      ...
      final response = await _i2.asyncNestedClass(_i2.NestedClass(_i2.Fields(
        (request[r'value'][r'fields'][r'superField'] as String),
        (request[r'value'][r'fields'][r'field'] as String),
      )));
      return {
        'fields': {
          'superField': response.fields.superField,
          'field': response.fields.field,
        }
      };
    },
