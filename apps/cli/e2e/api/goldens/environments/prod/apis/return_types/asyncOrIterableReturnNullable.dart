...
class AsyncOrIterableReturnNullableTarget extends _i1.FunctionTarget {
...
// ignore: unused_local_variable
      final response = await _i3.asyncOrIterableReturnNullable(celestContext);
      return response;
    },
...
_i4.Future<void> main(List<String> args) async {
  await _i1.serve(
    args,
    (_) => AsyncOrIterableReturnNullableTarget(),
  );
}
