...
typedef $EnvironmentsCreateCompanionBuilder = i1.EnvironmentsCompanion
    Function({
  required String id,
  i0.Value<int> rowid,
});
typedef $EnvironmentsUpdateCompanionBuilder = i1.EnvironmentsCompanion
    Function({
  i0.Value<String> id,
  i0.Value<int> rowid,
});
...
class $EnvironmentsTableManager extends i0.RootTableManager<
    ...
    (
      i1.Environment,
      i0.BaseReferences<i0.GeneratedDatabase, i1.Environments, i1.Environment>
    ),
    i1.Environment,
      ...
      : super(i0.TableManagerState(
          ...
          createCompanionCallback: ({
            ...
            i0.Value<int> rowid = const i0.Value.absent(),
              ...
              i1.EnvironmentsCompanion.insert(
            id: id,
            rowid: rowid,
          ),
...
typedef $EnvironmentsProcessedTableManager = i0.ProcessedTableManager<
    i0.GeneratedDatabase,
    i1.Environments,
    i1.Environment,
    i1.$EnvironmentsFilterComposer,
...
class $EnvironmentVariablesTableManager extends i0.RootTableManager<
    i0.GeneratedDatabase,
    ...
    (
      i1.EnvironmentVariable,
      i0.BaseReferences<i0.GeneratedDatabase, i1.EnvironmentVariables,
          i1.EnvironmentVariable>
    ),
    i1.EnvironmentVariable,
    i0.PrefetchHooks Function()> {
  $EnvironmentVariablesTableManager(
      i0.GeneratedDatabase db, i1.EnvironmentVariables table)
      : super(i0.TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
typedef $EnvironmentVariablesProcessedTableManager = i0.ProcessedTableManager<
    i0.GeneratedDatabase,
    i1.EnvironmentVariables,
    i1.EnvironmentVariable,
    i1.$EnvironmentVariablesFilterComposer,
    ...
    i1.EnvironmentVariable,
    i0.PrefetchHooks Function()>;
typedef $SecretsCreateCompanionBuilder = i1.SecretsCompanion Function({
  required String environmentId,
  required String name,
  required String valueRef,
  i0.Value<int> rowid,
});
typedef $SecretsUpdateCompanionBuilder = i1.SecretsCompanion Function({
  i0.Value<String> environmentId,
  i0.Value<String> name,
...
class $SecretsFilterComposer
  ...
  i0.ColumnFilters<String> get valueRef => $composableBuilder(
      column: $table.valueRef, builder: (column) => i0.ColumnFilters(column));
}
...
class $SecretsOrderingComposer
  ...
  i0.ColumnOrderings<String> get valueRef => $composableBuilder(
      column: $table.valueRef, builder: (column) => i0.ColumnOrderings(column));
}
...
class $SecretsTableManager extends i0.RootTableManager<
    i0.GeneratedDatabase,
    i1.Secrets,
    i1.Secret,
    ...
    (i1.Secret, i0.BaseReferences<i0.GeneratedDatabase, i1.Secrets, i1.Secret>),
    i1.Secret,
    i0.PrefetchHooks Function()> {
...
typedef $SecretsProcessedTableManager = i0.ProcessedTableManager<
    i0.GeneratedDatabase,
    i1.Secrets,
    i1.Secret,
    i1.$SecretsFilterComposer,
...
class Environment extends i0.DataClass
  ...
  i1.Environment copyWith({String? id}) => i1.Environment(
        id: id ?? this.id,
      );
...
class EnvironmentsCompanion extends i0.UpdateCompanion<i1.Environment> {
  ...
  i1.EnvironmentsCompanion copyWith(
      {i0.Value<String>? id, i0.Value<int>? rowid}) {
...
class EnvironmentVariables extends i0.Table
  ...
  late final i0.GeneratedColumn<String> environmentId =
      i0.GeneratedColumn<String>('environment_id', aliasedName, false,
          type: i0.DriftSqlType.string,
          requiredDuringInsert: true,
  ...
  i1.EnvironmentVariable map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return i1.EnvironmentVariable(
      environmentId: attachedDatabase.typeMapping.read(
          i0.DriftSqlType.string, data['${effectivePrefix}environment_id'])!,
  ...
  i1.Secret map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return i1.Secret(
      ...
      valueRef: attachedDatabase.typeMapping
          .read(i0.DriftSqlType.string, data['${effectivePrefix}value_ref'])!,
    );
  }
...
class ProjectDrift extends i2.ModularAccessor {
  ...
  i1.Environments get environments => i2.ReadDatabaseContainer(attachedDatabase)
      .resultSet<i1.Environments>('environments');
  i1.EnvironmentVariables get environmentVariables =>
      i2.ReadDatabaseContainer(attachedDatabase)
          .resultSet<i1.EnvironmentVariables>('environment_variables');
  i1.Secrets get secrets => i2.ReadDatabaseContainer(attachedDatabase)
