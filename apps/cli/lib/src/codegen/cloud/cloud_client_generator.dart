...
final class CloudClientGenerator {
  ...
  final _client = Field(
    (f) => f
      ...
      ..assignment = CloudClientTypes.clientClass.ref
  ...
  late final _celestEnvironment = ExtensionType(
    (e) => e
      ...
      ..implements.addAll([DartTypes.celest.environment, DartTypes.core.string])
      ..docs.addAll([
      ...
      ..fields.addAll([
        Field(
          (f) => f
            ...
            ..assignment = refer(
              'CelestEnvironment',
            ).constInstanceNamed('_', [literalString('local')]).code,
        ),
        Field(
          (f) => f
            ..static = true
            ...
            ..assignment = refer(
              'CelestEnvironment',
            ).constInstanceNamed('_', [literalString('production')]).code,
        ),
      ])
      ..methods.addAll([
        Method(
          ...
          Method((m) {
            ...
            m
              ...
              ..body = DartTypes.celest.context
                  .property('current')
                  .property('expect')
                  .call([refer('${database.dartName}\$Key')])
                  .code;
          }),
          Method((m) {
            final schemaType = switch (database.schema) {
            ...
            m
              ...
              ..body = DartTypes.celest.contextKey.constInstance([
                literalString(database.name, raw: database.name.contains(r'$')),
              ]).code;
          }),
        ],
