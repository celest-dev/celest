      ...
      final functionCall = Method(
        (m) => m
          ...
          ..returns = switch (function.streamType) {
            null => DartTypes.core.future(function.flattenedReturnType.noBound),
            _ => DartTypes.core.stream(function.flattenedReturnType.noBound),
          }
          ...
          ..body = Block((b) {
            ...
            if (bodyParameters.isNotEmpty ||
              ...
              payload = literalMap({
                for (final typeParameter in function.typeParameters)
                  literalString(typeMaps[typeParameter]!, raw: true): refer(
