...
class _$RemoteDeployedProjectSerializer
  ...
  Iterable<Object?> serialize(
    ...
    final result = <Object?>[
      'id',
      serializers.serialize(object.id, specifiedType: const FullType(NodeId)),
      'apis',
      serializers.serialize(object.apis,
          specifiedType: const FullType(BuiltMap,
              const [const FullType(String), const FullType(DeployedApi)])),
...
abstract mixin class DeployedProjectBuilder {
  void replace(DeployedProject other);
  void update(void Function(DeployedProjectBuilder) updates);
  MapBuilder<String, DeployedApi> get apis;
  set apis(MapBuilder<String, DeployedApi>? apis);
}
...
class LocalDeployedProjectBuilder
    implements
        Builder<LocalDeployedProject, LocalDeployedProjectBuilder>,
        DeployedProjectBuilder {
  ...
  set apis(covariant MapBuilder<String, DeployedApi>? apis) =>
      _$this._apis = apis;
  ...
  @override
  void replace(covariant LocalDeployedProject other) {
...
class _$RemoteDeployedProject extends RemoteDeployedProject {
  ...
  _$RemoteDeployedProject._({required this.id, required this.apis})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(id, r'RemoteDeployedProject', 'id');
    BuiltValueNullFieldError.checkNotNull(
...
class RemoteDeployedProjectBuilder
    implements
        Builder<RemoteDeployedProject, RemoteDeployedProjectBuilder>,
        DeployedProjectBuilder {
  _$RemoteDeployedProject? _$v;

  NodeIdBuilder? _id;
  NodeIdBuilder get id => _$this._id ??= new NodeIdBuilder();
  set id(covariant NodeIdBuilder? id) => _$this._id = id;
  ...
  @override
  void replace(covariant RemoteDeployedProject other) {
    ArgumentError.checkNotNull(other, 'other');
  ...
  _$RemoteDeployedProject _build() {
    ...
    try {
      _$result = _$v ??
          new _$RemoteDeployedProject._(id: id.build(), apis: apis.build());
    } catch (_) {
      late String _$failedField;
      try {
        _$failedField = 'id';
...
class _$DeployedApi extends DeployedApi {
  ...
  _$DeployedApi._(
      {required this.id, required this.name, required this.functions})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(id, r'DeployedApi', 'id');
...
class DeployedApiBuilder implements Builder<DeployedApi, DeployedApiBuilder> {
  ...
  NodeIdBuilder? _id;
  NodeIdBuilder get id => _$this._id ??= new NodeIdBuilder();
  set id(NodeIdBuilder? id) => _$this._id = id;
...
class _$DeployedFunction extends DeployedFunction {
  ...
  _$DeployedFunction._(
      {required this.id, required this.name, required this.uri})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(id, r'DeployedFunction', 'id');
  ...
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DeployedFunction &&
        id == other.id &&
        name == other.name &&
        uri == other.uri;
  }
  ...
  _$DeployedFunction _build() {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'DeployedFunction', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
