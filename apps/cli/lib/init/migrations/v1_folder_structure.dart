...
final class V1FolderStructure extends ProjectMigration {
  V1FolderStructure(super.projectRoot, this.projectName, this.parentProject);
  ...
  late final symlinkdEntities = [...symlinkdDirs, ...symlinkdFiles];
...
'''),
  ...
  Future<void> _stageChangesInGit(Directory projectDir) async {
    ...
    final result = await processManager.run(<String>[
      'git',
      'add',
      '.',
