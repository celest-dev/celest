...
final class _Pubspec extends ProjectFile {
  ...
  Future<void> _updateAppPubspec() async {
    ...
    if (parentProject.pubspec.dependencies.isEmpty) {
      ...
      final int replaceStart, replaceEnd;
      if (pubspecYaml.nodes['dependencies'] case final dependencies?) {
        // Empty dependencies section generated by `dart create`. Replace with
        // ours.
        final dependenciesBlock = dependencies.span;
        replaceStart = dependenciesBlock.start.offset;
        replaceEnd = dependenciesBlock.end.offset;
      } else {
        final environment = pubspecYaml.nodes['environment'];
        if (environment == null) {
          unreachable('environment should not be null.\n$pubspecYaml');
        }
        replaceStart = environment.span.end.offset;
      ...
      updatedPubspec =
          StringBuffer(parentProject.pubspecYaml.substring(0, replaceStart))
            ...
            ..writeln('    path: celest/')
            ..writeln(parentProject.pubspecYaml.substring(replaceEnd));
