...
/// from: dev.celest.celest_auth.CelestSecureStorage
class CelestSecureStorage extends jni.JObject {
  ...
  static final _class =
      jni.Jni.findJClass(r"dev/celest/celest_auth/CelestSecureStorage");
  ...
  static final _id_readAll = jni.Jni.accessors
      .getMethodIDOf(_class.reference, r"readAll", r"()Ljava/util/Map;");

  /// from: public final java.util.Map readAll()
  /// The returned object must be released after use, by calling the [release] method.
  jni.JMap<jni.JString, jni.JString> readAll() {
    return const jni.JMapType(jni.JStringType(), jni.JStringType()).fromRef(
        jni.Jni.accessors.callMethodWithArgs(
            reference, _id_readAll, jni.JniCallType.objectType, []).object);
  }
...
final class $CelestSecureStorageType extends jni.JObjType<CelestSecureStorage> {
  ...
  @override
  String get signature => r"Ldev/celest/celest_auth/CelestSecureStorage;";
