...
class Version extends $pb.GeneratedMessage {
  factory Version({
    ...
    $core.int? minor,
    $core.int? patch,
    $core.Iterable<$5.Value>? preRelease,
    $core.Iterable<$5.Value>? build,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$5.Value>(4, _omitFieldNames ? '' : 'preRelease', $pb.PbFieldType.PM,
        subBuilder: $5.Value.create)
    ..pc<$5.Value>(5, _omitFieldNames ? '' : 'build', $pb.PbFieldType.PM,
        subBuilder: $5.Value.create)
