...
class PrincipalEquals extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..e<$50.SlotId>(1, _omitFieldNames ? '' : 'slot', $pb.PbFieldType.OE,
        defaultOrMaker: $50.SlotId.SLOT_ID_UNSPECIFIED,
        valueOf: $50.SlotId.valueOf,
        enumValues: $50.SlotId.values)
    ..aOM<$48.EntityUid>(2, _omitFieldNames ? '' : 'entity',
  ...
  @$pb.TagNumber(1)
  $50.SlotId get slot => $_getN(0);
  @$pb.TagNumber(1)
  set slot($50.SlotId v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  $48.EntityUid get entity => $_getN(1);
  @$pb.TagNumber(2)
  set entity($48.EntityUid v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $48.EntityUid ensureEntity() => $_ensure(1);
}
...
class PrincipalIsIn extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<$50.SlotId>(2, _omitFieldNames ? '' : 'slot', $pb.PbFieldType.OE,
        defaultOrMaker: $50.SlotId.SLOT_ID_UNSPECIFIED,
        valueOf: $50.SlotId.valueOf,
        enumValues: $50.SlotId.values)
    ..aOM<$48.EntityUid>(3, _omitFieldNames ? '' : 'entity',
        subBuilder: $48.EntityUid.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $48.EntityUid get entity => $_getN(2);
  @$pb.TagNumber(3)
  set entity($48.EntityUid v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(3)
  $48.EntityUid ensureEntity() => $_ensure(2);
}
...
class ActionEquals extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'cedar.v3'),
      createEmptyInstance: create)
    ..aOM<$48.EntityUid>(1, _omitFieldNames ? '' : 'entity',
        subBuilder: $48.EntityUid.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $48.EntityUid get entity => $_getN(0);
  @$pb.TagNumber(1)
  set entity($48.EntityUid v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(1)
  $48.EntityUid ensureEntity() => $_ensure(0);
}
...
class ActionInSet extends $pb.GeneratedMessage {
  factory ActionInSet({
    $core.Iterable<$48.EntityUid>? entities,
  }) {
    final $result = create();
    if (entities != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<$48.EntityUid> get entities => $_getList(0);
}
...
class TemplateLink extends $pb.GeneratedMessage {
  factory TemplateLink({
    ...
    $core.String? newId,
    $core.Map<$core.String, $48.EntityUid>? values,
  }) {
    final $result = create();
    if (templateId != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, $48.EntityUid>(3, _omitFieldNames ? '' : 'values',
        entryClassName: 'TemplateLink.ValuesEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: $48.EntityUid.create,
        valueDefaultOrMaker: $48.EntityUid.getDefault,
        packageName: const $pb.PackageName('cedar.v3'))
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(3)
  $core.Map<$core.String, $48.EntityUid> get values => $_getMap(2);
}
