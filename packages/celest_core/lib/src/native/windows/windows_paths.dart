...
class PathProviderWindows {
  ...
  @visibleForTesting
  static VersionInfoQuerier versionInfoQuerier = VersionInfoQuerier();
  ...
  static String? _getStringValue(Pointer<Uint8>? infoBuffer, String key) =>
  ...
  ///   extension).
  static String _getApplicationSpecificSubdirectory() {
    String? companyName;
    String? productName;
  ...
  static String? _sanitizedDirectoryName(String? rawString) {
    if (rawString == null) {
      return null;
    }
  ...
  static String? _createApplicationSubdirectory(String folderId) {
