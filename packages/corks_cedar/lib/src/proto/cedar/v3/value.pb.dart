...
class Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Value', package: const $pb.PackageName(_omitMessageNames ? '' : 'cedar.v3'), createEmptyInstance: create)
    ...
    ..aOM<SetValue>(4, _omitFieldNames ? '' : 'set', subBuilder: SetValue.create)
    ..aOM<RecordValue>(5, _omitFieldNames ? '' : 'record', subBuilder: RecordValue.create)
    ..aOM<ExtensionValue>(6, _omitFieldNames ? '' : 'extension', subBuilder: ExtensionValue.create)
    ..aOM<EntityValue>(7, _omitFieldNames ? '' : 'entity', subBuilder: EntityValue.create)
...
class SetValue extends $pb.GeneratedMessage {
  ...
  @$core.pragma('dart2js:noInline')
  static SetValue getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SetValue>(create);
...
class RecordValue extends $pb.GeneratedMessage {
  ...
  @$core.pragma('dart2js:noInline')
  static RecordValue getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RecordValue>(create);
...
class ExtensionValue extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<ExtensionValue> createRepeated() => $pb.PbList<ExtensionValue>();
  @$core.pragma('dart2js:noInline')
  static ExtensionValue getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ExtensionValue>(create);
...
class EntityValue extends $pb.GeneratedMessage {
  ...
  @$core.pragma('dart2js:noInline')
  static EntityValue getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EntityValue>(create);
