...
class Policy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Policy', package: const $pb.PackageName(_omitMessageNames ? '' : 'cedar.v3'), createEmptyInstance: create)
    ...
    ..e<PolicyEffect>(2, _omitFieldNames ? '' : 'effect', $pb.PbFieldType.OE, defaultOrMaker: PolicyEffect.POLICY_EFFECT_UNSPECIFIED, valueOf: PolicyEffect.valueOf, enumValues: PolicyEffect.values)
    ..aOM<PolicyPrincipal>(3, _omitFieldNames ? '' : 'principal', subBuilder: PolicyPrincipal.create)
    ..aOM<PolicyAction>(4, _omitFieldNames ? '' : 'action', subBuilder: PolicyAction.create)
    ..aOM<PolicyResource>(5, _omitFieldNames ? '' : 'resource', subBuilder: PolicyResource.create)
    ..pc<PolicyCondition>(6, _omitFieldNames ? '' : 'conditions', $pb.PbFieldType.PM, subBuilder: PolicyCondition.create)
...
class PolicyPrincipal extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PolicyPrincipal', package: const $pb.PackageName(_omitMessageNames ? '' : 'cedar.v3'), createEmptyInstance: create)
    ..e<PolicyOp>(1, _omitFieldNames ? '' : 'op', $pb.PbFieldType.OE, defaultOrMaker: PolicyOp.POLICY_OP_UNSPECIFIED, valueOf: PolicyOp.valueOf, enumValues: PolicyOp.values)
  ...
  static $pb.PbList<PolicyPrincipal> createRepeated() => $pb.PbList<PolicyPrincipal>();
  @$core.pragma('dart2js:noInline')
  static PolicyPrincipal getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PolicyPrincipal>(create);
...
class PolicyAction extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<PolicyAction> createRepeated() => $pb.PbList<PolicyAction>();
  @$core.pragma('dart2js:noInline')
  static PolicyAction getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PolicyAction>(create);
...
class PolicyCondition extends $pb.GeneratedMessage {
  ...
  static $pb.PbList<PolicyCondition> createRepeated() => $pb.PbList<PolicyCondition>();
  @$core.pragma('dart2js:noInline')
  static PolicyCondition getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PolicyCondition>(create);
