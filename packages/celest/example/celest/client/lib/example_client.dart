...
import 'package:example_client/src/functions.dart';
import 'package:example_client/src/serializers.dart';
...
enum CelestEnvironment {
  ...
  Uri get baseUri => switch (this) {
        local => _$celest.kIsWeb || !_$io.Platform.isAndroid
            ? Uri.parse('http://localhost:52795')
            : Uri.parse('http://10.0.2.2:52795'),
      };
}
